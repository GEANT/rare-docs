...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp556/rout-bgp556.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp556](../clab/rout-bgp556/rout-bgp556.yml) file  
        3. Launch ContainerLab `rout-bgp556.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp556.yml  
        ```
        4. Destroy ContainerLab `rout-bgp556.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp556.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp556.tst` file [here](../tst/rout-bgp556.tst)  
        3. Launch `rout-bgp556.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp556 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp556.tst` test:  
