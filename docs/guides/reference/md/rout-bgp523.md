...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp523/rout-bgp523.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp523](../clab/rout-bgp523/rout-bgp523.yml) file  
        3. Launch ContainerLab `rout-bgp523.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp523.yml  
        ```
        4. Destroy ContainerLab `rout-bgp523.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp523.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp523.tst` file [here](../tst/rout-bgp523.tst)  
        3. Launch `rout-bgp523.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp523 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp523.tst` test:  
