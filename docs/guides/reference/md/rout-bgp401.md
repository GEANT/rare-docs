...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp401/rout-bgp401.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp401](../clab/rout-bgp401/rout-bgp401.yml) file  
        3. Launch ContainerLab `rout-bgp401.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp401.yml  
        ```
        4. Destroy ContainerLab `rout-bgp401.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp401.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp401.tst` file [here](../tst/rout-bgp401.tst)  
        3. Launch `rout-bgp401.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp401 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp401.tst` test:  
