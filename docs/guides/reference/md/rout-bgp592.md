# Example: othervpns with ingress rtfilter

=== "Topology"

    ![Alt text](../d2/rout-bgp592/rout-bgp592.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp592](../clab/rout-bgp592/rout-bgp592.yml) file  
        3. Launch ContainerLab `rout-bgp592.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp592.yml  
        ```
        4. Destroy ContainerLab `rout-bgp592.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp592.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp592.tst` file [here](../tst/rout-bgp592.tst)  
        3. Launch `rout-bgp592.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp592 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp592.tst` test:  
