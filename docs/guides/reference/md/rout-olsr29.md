# Example: olsr auto summarization

=== "Topology"

    ![Alt text](../d2/rout-olsr29/rout-olsr29.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-olsr29](../clab/rout-olsr29/rout-olsr29.yml) file  
        3. Launch ContainerLab `rout-olsr29.yml` topology:  

        ```
           containerlab deploy --topo rout-olsr29.yml  
        ```
        4. Destroy ContainerLab `rout-olsr29.yml` topology:  

        ```
           containerlab destroy --topo rout-olsr29.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-olsr29.tst` file [here](../tst/rout-olsr29.tst)  
        3. Launch `rout-olsr29.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-olsr29 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-olsr29.tst` test:  
