# Example: ocar ibgp rr prefix movement

=== "Topology"

    ![Alt text](../d2/rout-bgp751/rout-bgp751.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp751](../clab/rout-bgp751/rout-bgp751.yml) file  
        3. Launch ContainerLab `rout-bgp751.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp751.yml  
        ```
        4. Destroy ContainerLab `rout-bgp751.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp751.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp751.tst` file [here](../tst/rout-bgp751.tst)  
        3. Launch `rout-bgp751.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp751 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp751.tst` test:  
