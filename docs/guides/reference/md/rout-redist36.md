# Example: redistribution filtering with prefixlist in routepolicy

=== "Topology"

    ![Alt text](../d2/rout-redist36/rout-redist36.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist36](../clab/rout-redist36/rout-redist36.yml) file  
        3. Launch ContainerLab `rout-redist36.yml` topology:  

        ```
           containerlab deploy --topo rout-redist36.yml  
        ```
        4. Destroy ContainerLab `rout-redist36.yml` topology:  

        ```
           containerlab destroy --topo rout-redist36.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist36.tst` file [here](../tst/rout-redist36.tst)  
        3. Launch `rout-redist36.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist36 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist36.tst` test:  
