...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp468/rout-bgp468.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp468](../clab/rout-bgp468/rout-bgp468.yml) file  
        3. Launch ContainerLab `rout-bgp468.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp468.yml  
        ```
        4. Destroy ContainerLab `rout-bgp468.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp468.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp468.tst` file [here](../tst/rout-bgp468.tst)  
        3. Launch `rout-bgp468.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp468 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp468.tst` test:  
