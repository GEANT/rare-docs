...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp167/rout-bgp167.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp167](../clab/rout-bgp167/rout-bgp167.yml) file  
        3. Launch ContainerLab `rout-bgp167.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp167.yml  
        ```
        4. Destroy ContainerLab `rout-bgp167.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp167.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp167.tst` file [here](../tst/rout-bgp167.tst)  
        3. Launch `rout-bgp167.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp167 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp167.tst` test:  
