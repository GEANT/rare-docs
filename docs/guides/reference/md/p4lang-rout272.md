# Example: p4lang: l2tp3 mpls over bundle

=== "Topology"

    ![Alt text](../d2/p4lang-rout272/p4lang-rout272.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout272](../clab/p4lang-rout272/p4lang-rout272.yml) file  
        3. Launch ContainerLab `p4lang-rout272.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout272.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout272.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout272.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout272.tst` file [here](../tst/p4lang-rout272.tst)  
        3. Launch `p4lang-rout272.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout272 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout272.tst` test:  
