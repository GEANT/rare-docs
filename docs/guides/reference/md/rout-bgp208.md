...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp208/rout-bgp208.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp208](../clab/rout-bgp208/rout-bgp208.yml) file  
        3. Launch ContainerLab `rout-bgp208.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp208.yml  
        ```
        4. Destroy ContainerLab `rout-bgp208.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp208.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp208.tst` file [here](../tst/rout-bgp208.tst)  
        3. Launch `rout-bgp208.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp208 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp208.tst` test:  
