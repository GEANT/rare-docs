...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp572/rout-bgp572.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp572](../clab/rout-bgp572/rout-bgp572.yml) file  
        3. Launch ContainerLab `rout-bgp572.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp572.yml  
        ```
        4. Destroy ContainerLab `rout-bgp572.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp572.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp572.tst` file [here](../tst/rout-bgp572.tst)  
        3. Launch `rout-bgp572.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp572 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp572.tst` test:  
