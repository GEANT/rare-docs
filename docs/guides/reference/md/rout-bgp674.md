# Example: ctp colors over ibgp rr

=== "Topology"

    ![Alt text](../d2/rout-bgp674/rout-bgp674.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp674](../clab/rout-bgp674/rout-bgp674.yml) file  
        3. Launch ContainerLab `rout-bgp674.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp674.yml  
        ```
        4. Destroy ContainerLab `rout-bgp674.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp674.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp674.tst` file [here](../tst/rout-bgp674.tst)  
        3. Launch `rout-bgp674.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp674 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp674.tst` test:  
