...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf34/rout-ospf34.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf34](../clab/rout-ospf34/rout-ospf34.yml) file  
        3. Launch ContainerLab `rout-ospf34.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf34.yml  
        ```
        4. Destroy ContainerLab `rout-ospf34.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf34.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf34.tst` file [here](../tst/rout-ospf34.tst)  
        3. Launch `rout-ospf34.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf34 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf34.tst` test:  
