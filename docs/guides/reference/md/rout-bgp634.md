# Example: unicast+octp over bgp with additional path

=== "Topology"

    ![Alt text](../d2/rout-bgp634/rout-bgp634.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp634](../clab/rout-bgp634/rout-bgp634.yml) file  
        3. Launch ContainerLab `rout-bgp634.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp634.yml  
        ```
        4. Destroy ContainerLab `rout-bgp634.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp634.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp634.tst` file [here](../tst/rout-bgp634.tst)  
        3. Launch `rout-bgp634.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp634 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp634.tst` test:  
