...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp475/rout-bgp475.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp475](../clab/rout-bgp475/rout-bgp475.yml) file  
        3. Launch ContainerLab `rout-bgp475.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp475.yml  
        ```
        4. Destroy ContainerLab `rout-bgp475.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp475.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp475.tst` file [here](../tst/rout-bgp475.tst)  
        3. Launch `rout-bgp475.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp475 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp475.tst` test:  
