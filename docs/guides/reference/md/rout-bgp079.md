...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp079/rout-bgp079.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp079](../clab/rout-bgp079/rout-bgp079.yml) file  
        3. Launch ContainerLab `rout-bgp079.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp079.yml  
        ```
        4. Destroy ContainerLab `rout-bgp079.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp079.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp079.tst` file [here](../tst/rout-bgp079.tst)  
        3. Launch `rout-bgp079.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp079 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp079.tst` test:  
