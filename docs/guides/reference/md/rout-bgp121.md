...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp121/rout-bgp121.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp121](../clab/rout-bgp121/rout-bgp121.yml) file  
        3. Launch ContainerLab `rout-bgp121.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp121.yml  
        ```
        4. Destroy ContainerLab `rout-bgp121.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp121.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp121.tst` file [here](../tst/rout-bgp121.tst)  
        3. Launch `rout-bgp121.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp121 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp121.tst` test:  
