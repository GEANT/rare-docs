...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf29/rout-ospf29.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf29](../clab/rout-ospf29/rout-ospf29.yml) file  
        3. Launch ContainerLab `rout-ospf29.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf29.yml  
        ```
        4. Destroy ContainerLab `rout-ospf29.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf29.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf29.tst` file [here](../tst/rout-ospf29.tst)  
        3. Launch `rout-ospf29.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf29 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf29.tst` test:  
