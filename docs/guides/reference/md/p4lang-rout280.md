# Example: p4lang: sdwan over ipv6 with gre

=== "Topology"

    ![Alt text](../d2/p4lang-rout280/p4lang-rout280.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout280](../clab/p4lang-rout280/p4lang-rout280.yml) file  
        3. Launch ContainerLab `p4lang-rout280.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout280.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout280.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout280.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout280.tst` file [here](../tst/p4lang-rout280.tst)  
        3. Launch `p4lang-rout280.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout280 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout280.tst` test:  
