# Example: p4lang: multilink l2tp routing over ipv6

=== "Topology"

    ![Alt text](../d2/p4lang-rout230/p4lang-rout230.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout230](../clab/p4lang-rout230/p4lang-rout230.yml) file  
        3. Launch ContainerLab `p4lang-rout230.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout230.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout230.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout230.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout230.tst` file [here](../tst/p4lang-rout230.tst)  
        3. Launch `p4lang-rout230.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout230 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout230.tst` test:  
