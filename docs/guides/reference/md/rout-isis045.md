...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis045/rout-isis045.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis045](../clab/rout-isis045/rout-isis045.yml) file  
        3. Launch ContainerLab `rout-isis045.yml` topology:  

        ```
           containerlab deploy --topo rout-isis045.yml  
        ```
        4. Destroy ContainerLab `rout-isis045.yml` topology:  

        ```
           containerlab destroy --topo rout-isis045.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis045.tst` file [here](../tst/rout-isis045.tst)  
        3. Launch `rout-isis045.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis045 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis045.tst` test:  
