...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-bier04/mpls-bier04.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-bier04](../clab/mpls-bier04/mpls-bier04.yml) file  
        3. Launch ContainerLab `mpls-bier04.yml` topology:  

        ```
           containerlab deploy --topo mpls-bier04.yml  
        ```
        4. Destroy ContainerLab `mpls-bier04.yml` topology:  

        ```
           containerlab destroy --topo mpls-bier04.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-bier04.tst` file [here](../tst/mpls-bier04.tst)  
        3. Launch `mpls-bier04.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-bier04 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-bier04.tst` test:  
