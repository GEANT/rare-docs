...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis009/rout-isis009.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis009](../clab/rout-isis009/rout-isis009.yml) file  
        3. Launch ContainerLab `rout-isis009.yml` topology:  

        ```
           containerlab deploy --topo rout-isis009.yml  
        ```
        4. Destroy ContainerLab `rout-isis009.yml` topology:  

        ```
           containerlab destroy --topo rout-isis009.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis009.tst` file [here](../tst/rout-isis009.tst)  
        3. Launch `rout-isis009.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis009 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis009.tst` test:  
