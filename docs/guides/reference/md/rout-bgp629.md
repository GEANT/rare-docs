# Example: bgp change in metric with ctp

=== "Topology"

    ![Alt text](../d2/rout-bgp629/rout-bgp629.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp629](../clab/rout-bgp629/rout-bgp629.yml) file  
        3. Launch ContainerLab `rout-bgp629.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp629.yml  
        ```
        4. Destroy ContainerLab `rout-bgp629.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp629.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp629.tst` file [here](../tst/rout-bgp629.tst)  
        3. Launch `rout-bgp629.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp629 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp629.tst` test:  
