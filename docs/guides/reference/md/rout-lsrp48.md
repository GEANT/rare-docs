...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp48/rout-lsrp48.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp48](../clab/rout-lsrp48/rout-lsrp48.yml) file  
        3. Launch ContainerLab `rout-lsrp48.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp48.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp48.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp48.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp48.tst` file [here](../tst/rout-lsrp48.tst)  
        3. Launch `rout-lsrp48.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp48 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp48.tst` test:  
