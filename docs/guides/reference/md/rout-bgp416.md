...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp416/rout-bgp416.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp416](../clab/rout-bgp416/rout-bgp416.yml) file  
        3. Launch ContainerLab `rout-bgp416.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp416.yml  
        ```
        4. Destroy ContainerLab `rout-bgp416.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp416.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp416.tst` file [here](../tst/rout-bgp416.tst)  
        3. Launch `rout-bgp416.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp416 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp416.tst` test:  
