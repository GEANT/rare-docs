# Example: car colors over bgp with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp770/rout-bgp770.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp770](../clab/rout-bgp770/rout-bgp770.yml) file  
        3. Launch ContainerLab `rout-bgp770.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp770.yml  
        ```
        4. Destroy ContainerLab `rout-bgp770.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp770.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp770.tst` file [here](../tst/rout-bgp770.tst)  
        3. Launch `rout-bgp770.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp770 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp770.tst` test:  
