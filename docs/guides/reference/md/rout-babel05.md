...
=== "Topology"
    ...
    ![Alt text](../d2/rout-babel05/rout-babel05.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-babel05](../clab/rout-babel05/rout-babel05.yml) file  
        3. Launch ContainerLab `rout-babel05.yml` topology:  

        ```
           containerlab deploy --topo rout-babel05.yml  
        ```
        4. Destroy ContainerLab `rout-babel05.yml` topology:  

        ```
           containerlab destroy --topo rout-babel05.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-babel05.tst` file [here](../tst/rout-babel05.tst)  
        3. Launch `rout-babel05.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-babel05 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-babel05.tst` test:  
