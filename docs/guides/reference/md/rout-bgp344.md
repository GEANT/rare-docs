...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp344/rout-bgp344.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp344](../clab/rout-bgp344/rout-bgp344.yml) file  
        3. Launch ContainerLab `rout-bgp344.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp344.yml  
        ```
        4. Destroy ContainerLab `rout-bgp344.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp344.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp344.tst` file [here](../tst/rout-bgp344.tst)  
        3. Launch `rout-bgp344.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp344 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp344.tst` test:  
