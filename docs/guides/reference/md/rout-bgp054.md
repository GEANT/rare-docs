...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp054/rout-bgp054.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp054](../clab/rout-bgp054/rout-bgp054.yml) file  
        3. Launch ContainerLab `rout-bgp054.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp054.yml  
        ```
        4. Destroy ContainerLab `rout-bgp054.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp054.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp054.tst` file [here](../tst/rout-bgp054.tst)  
        3. Launch `rout-bgp054.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp054 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp054.tst` test:  
