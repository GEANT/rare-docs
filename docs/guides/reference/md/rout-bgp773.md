# Example: vpn colors over ibgp

=== "Topology"

    ![Alt text](../d2/rout-bgp773/rout-bgp773.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp773](../clab/rout-bgp773/rout-bgp773.yml) file  
        3. Launch ContainerLab `rout-bgp773.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp773.yml  
        ```
        4. Destroy ContainerLab `rout-bgp773.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp773.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp773.tst` file [here](../tst/rout-bgp773.tst)  
        3. Launch `rout-bgp773.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp773 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp773.tst` test:  
