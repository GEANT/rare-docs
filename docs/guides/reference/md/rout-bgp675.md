# Example: other ctp colors over ibgp rr

=== "Topology"

    ![Alt text](../d2/rout-bgp675/rout-bgp675.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp675](../clab/rout-bgp675/rout-bgp675.yml) file  
        3. Launch ContainerLab `rout-bgp675.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp675.yml  
        ```
        4. Destroy ContainerLab `rout-bgp675.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp675.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp675.tst` file [here](../tst/rout-bgp675.tst)  
        3. Launch `rout-bgp675.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp675 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp675.tst` test:  
