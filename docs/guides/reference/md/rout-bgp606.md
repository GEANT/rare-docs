# Example: ibgp with ctp

=== "Topology"

    ![Alt text](../d2/rout-bgp606/rout-bgp606.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp606](../clab/rout-bgp606/rout-bgp606.yml) file  
        3. Launch ContainerLab `rout-bgp606.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp606.yml  
        ```
        4. Destroy ContainerLab `rout-bgp606.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp606.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp606.tst` file [here](../tst/rout-bgp606.tst)  
        3. Launch `rout-bgp606.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp606 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp606.tst` test:  
