# Example: p4lang: l2vpn over l2tp3 mpls

=== "Topology"

    ![Alt text](../d2/p4lang-rout253/p4lang-rout253.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout253](../clab/p4lang-rout253/p4lang-rout253.yml) file  
        3. Launch ContainerLab `p4lang-rout253.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout253.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout253.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout253.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout253.tst` file [here](../tst/p4lang-rout253.tst)  
        3. Launch `p4lang-rout253.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout253 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout253.tst` test:  
