# Example: p4lang: l2tp3 interface inspection with egress drop

=== "Topology"

    ![Alt text](../d2/p4lang-acl088/p4lang-acl088.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl088](../clab/p4lang-acl088/p4lang-acl088.yml) file  
        3. Launch ContainerLab `p4lang-acl088.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl088.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl088.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl088.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl088.tst` file [here](../tst/p4lang-acl088.tst)  
        3. Launch `p4lang-acl088.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl088 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl088.tst` test:  
