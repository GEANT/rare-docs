...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp319/rout-bgp319.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp319](../clab/rout-bgp319/rout-bgp319.yml) file  
        3. Launch ContainerLab `rout-bgp319.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp319.yml  
        ```
        4. Destroy ContainerLab `rout-bgp319.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp319.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp319.tst` file [here](../tst/rout-bgp319.tst)  
        3. Launch `rout-bgp319.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp319 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp319.tst` test:  
