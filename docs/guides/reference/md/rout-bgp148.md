...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp148/rout-bgp148.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp148](../clab/rout-bgp148/rout-bgp148.yml) file  
        3. Launch ContainerLab `rout-bgp148.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp148.yml  
        ```
        4. Destroy ContainerLab `rout-bgp148.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp148.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp148.tst` file [here](../tst/rout-bgp148.tst)  
        3. Launch `rout-bgp148.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp148 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp148.tst` test:  
