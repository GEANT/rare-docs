# Example: bgp routemap filtering with leak-role with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp789/rout-bgp789.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp789](../clab/rout-bgp789/rout-bgp789.yml) file  
        3. Launch ContainerLab `rout-bgp789.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp789.yml  
        ```
        4. Destroy ContainerLab `rout-bgp789.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp789.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp789.tst` file [here](../tst/rout-bgp789.tst)  
        3. Launch `rout-bgp789.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp789 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp789.tst` test:  
