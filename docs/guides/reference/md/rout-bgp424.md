...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp424/rout-bgp424.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp424](../clab/rout-bgp424/rout-bgp424.yml) file  
        3. Launch ContainerLab `rout-bgp424.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp424.yml  
        ```
        4. Destroy ContainerLab `rout-bgp424.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp424.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp424.tst` file [here](../tst/rout-bgp424.tst)  
        3. Launch `rout-bgp424.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp424 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp424.tst` test:  
