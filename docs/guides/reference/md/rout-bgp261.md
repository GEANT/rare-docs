...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp261/rout-bgp261.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp261](../clab/rout-bgp261/rout-bgp261.yml) file  
        3. Launch ContainerLab `rout-bgp261.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp261.yml  
        ```
        4. Destroy ContainerLab `rout-bgp261.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp261.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp261.tst` file [here](../tst/rout-bgp261.tst)  
        3. Launch `rout-bgp261.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp261 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp261.tst` test:  
