...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-polka13/mpls-polka13.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-polka13](../clab/mpls-polka13/mpls-polka13.yml) file  
        3. Launch ContainerLab `mpls-polka13.yml` topology:  

        ```
           containerlab deploy --topo mpls-polka13.yml  
        ```
        4. Destroy ContainerLab `mpls-polka13.yml` topology:  

        ```
           containerlab destroy --topo mpls-polka13.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-polka13.tst` file [here](../tst/mpls-polka13.tst)  
        3. Launch `mpls-polka13.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-polka13 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-polka13.tst` test:  
