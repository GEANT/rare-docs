...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis010/rout-isis010.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis010](../clab/rout-isis010/rout-isis010.yml) file  
        3. Launch ContainerLab `rout-isis010.yml` topology:  

        ```
           containerlab deploy --topo rout-isis010.yml  
        ```
        4. Destroy ContainerLab `rout-isis010.yml` topology:  

        ```
           containerlab destroy --topo rout-isis010.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis010.tst` file [here](../tst/rout-isis010.tst)  
        3. Launch `rout-isis010.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis010 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis010.tst` test:  
