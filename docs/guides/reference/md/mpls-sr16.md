# Example: bgp with car over sr

=== "Topology"

    ![Alt text](../d2/mpls-sr16/mpls-sr16.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-sr16](../clab/mpls-sr16/mpls-sr16.yml) file  
        3. Launch ContainerLab `mpls-sr16.yml` topology:  

        ```
           containerlab deploy --topo mpls-sr16.yml  
        ```
        4. Destroy ContainerLab `mpls-sr16.yml` topology:  

        ```
           containerlab destroy --topo mpls-sr16.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-sr16.tst` file [here](../tst/mpls-sr16.tst)  
        3. Launch `mpls-sr16.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-sr16 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-sr16.tst` test:  
