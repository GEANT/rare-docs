...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp036/rout-bgp036.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp036](../clab/rout-bgp036/rout-bgp036.yml) file  
        3. Launch ContainerLab `rout-bgp036.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp036.yml  
        ```
        4. Destroy ContainerLab `rout-bgp036.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp036.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp036.tst` file [here](../tst/rout-bgp036.tst)  
        3. Launch `rout-bgp036.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp036 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp036.tst` test:  
