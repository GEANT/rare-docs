...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt064/p4lang-crypt064.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt064](../clab/p4lang-crypt064/p4lang-crypt064.yml) file  
        3. Launch ContainerLab `p4lang-crypt064.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt064.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt064.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt064.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt064.tst` file [here](../tst/p4lang-crypt064.tst)  
        3. Launch `p4lang-crypt064.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt064 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt064.tst` test:  
