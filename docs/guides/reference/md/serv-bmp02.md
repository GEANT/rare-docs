...
=== "Topology"
    ...
    ![Alt text](../d2/serv-bmp02/serv-bmp02.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [serv-bmp02](../clab/serv-bmp02/serv-bmp02.yml) file  
        3. Launch ContainerLab `serv-bmp02.yml` topology:  

        ```
           containerlab deploy --topo serv-bmp02.yml  
        ```
        4. Destroy ContainerLab `serv-bmp02.yml` topology:  

        ```
           containerlab destroy --topo serv-bmp02.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `serv-bmp02.tst` file [here](../tst/serv-bmp02.tst)  
        3. Launch `serv-bmp02.tst` test:  

        ```
           java -jar ../../rtr.jar test tester serv-bmp02 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `serv-bmp02.tst` test:  
