...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp210/rout-bgp210.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp210](../clab/rout-bgp210/rout-bgp210.yml) file  
        3. Launch ContainerLab `rout-bgp210.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp210.yml  
        ```
        4. Destroy ContainerLab `rout-bgp210.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp210.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp210.tst` file [here](../tst/rout-bgp210.tst)  
        3. Launch `rout-bgp210.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp210 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp210.tst` test:  
