# Example: unicast+vpns over ibgp rr with dynamic capability

=== "Topology"

    ![Alt text](../d2/rout-bgp779/rout-bgp779.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp779](../clab/rout-bgp779/rout-bgp779.yml) file  
        3. Launch ContainerLab `rout-bgp779.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp779.yml  
        ```
        4. Destroy ContainerLab `rout-bgp779.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp779.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp779.tst` file [here](../tst/rout-bgp779.tst)  
        3. Launch `rout-bgp779.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp779 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp779.tst` test:  
