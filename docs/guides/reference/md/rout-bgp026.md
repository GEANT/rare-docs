...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp026/rout-bgp026.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp026](../clab/rout-bgp026/rout-bgp026.yml) file  
        3. Launch ContainerLab `rout-bgp026.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp026.yml  
        ```
        4. Destroy ContainerLab `rout-bgp026.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp026.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp026.tst` file [here](../tst/rout-bgp026.tst)  
        3. Launch `rout-bgp026.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp026 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp026.tst` test:  
