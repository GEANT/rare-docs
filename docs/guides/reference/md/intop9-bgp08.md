...
=== "Topology"
    ...
    ![Alt text](../d2/intop9-bgp08/intop9-bgp08.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [intop9-bgp08](../clab/intop9-bgp08/intop9-bgp08.yml) file  
        3. Launch ContainerLab `intop9-bgp08.yml` topology:  

        ```
           containerlab deploy --topo intop9-bgp08.yml  
        ```
        4. Destroy ContainerLab `intop9-bgp08.yml` topology:  

        ```
           containerlab destroy --topo intop9-bgp08.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `intop9-bgp08.tst` file [here](../tst/intop9-bgp08.tst)  
        3. Launch `intop9-bgp08.tst` test:  

        ```
           java -jar ../../rtr.jar test tester intop9-bgp08 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `intop9-bgp08.tst` test:  
