...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis025/rout-isis025.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis025](../clab/rout-isis025/rout-isis025.yml) file  
        3. Launch ContainerLab `rout-isis025.yml` topology:  

        ```
           containerlab deploy --topo rout-isis025.yml  
        ```
        4. Destroy ContainerLab `rout-isis025.yml` topology:  

        ```
           containerlab destroy --topo rout-isis025.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis025.tst` file [here](../tst/rout-isis025.tst)  
        3. Launch `rout-isis025.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis025 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis025.tst` test:  
