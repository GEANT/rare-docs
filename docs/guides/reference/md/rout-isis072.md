...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis072/rout-isis072.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis072](../clab/rout-isis072/rout-isis072.yml) file  
        3. Launch ContainerLab `rout-isis072.yml` topology:  

        ```
           containerlab deploy --topo rout-isis072.yml  
        ```
        4. Destroy ContainerLab `rout-isis072.yml` topology:  

        ```
           containerlab destroy --topo rout-isis072.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis072.tst` file [here](../tst/rout-isis072.tst)  
        3. Launch `rout-isis072.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis072 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis072.tst` test:  
