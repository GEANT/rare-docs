...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp18/rout-lsrp18.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp18](../clab/rout-lsrp18/rout-lsrp18.yml) file  
        3. Launch ContainerLab `rout-lsrp18.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp18.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp18.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp18.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp18.tst` file [here](../tst/rout-lsrp18.tst)  
        3. Launch `rout-lsrp18.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp18 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp18.tst` test:  
