...
=== "Topology"
    ...
    ![Alt text](../d2/rout-redist22/rout-redist22.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist22](../clab/rout-redist22/rout-redist22.yml) file  
        3. Launch ContainerLab `rout-redist22.yml` topology:  

        ```
           containerlab deploy --topo rout-redist22.yml  
        ```
        4. Destroy ContainerLab `rout-redist22.yml` topology:  

        ```
           containerlab destroy --topo rout-redist22.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist22.tst` file [here](../tst/rout-redist22.tst)  
        3. Launch `rout-redist22.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist22 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist22.tst` test:  
