...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp332/rout-bgp332.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp332](../clab/rout-bgp332/rout-bgp332.yml) file  
        3. Launch ContainerLab `rout-bgp332.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp332.yml  
        ```
        4. Destroy ContainerLab `rout-bgp332.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp332.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp332.tst` file [here](../tst/rout-bgp332.tst)  
        3. Launch `rout-bgp332.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp332 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp332.tst` test:  
