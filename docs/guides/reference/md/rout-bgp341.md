...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp341/rout-bgp341.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp341](../clab/rout-bgp341/rout-bgp341.yml) file  
        3. Launch ContainerLab `rout-bgp341.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp341.yml  
        ```
        4. Destroy ContainerLab `rout-bgp341.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp341.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp341.tst` file [here](../tst/rout-bgp341.tst)  
        3. Launch `rout-bgp341.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp341 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp341.tst` test:  
