...
=== "Topology"
    ...
    ![Alt text](../d2/rout-babel04/rout-babel04.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-babel04](../clab/rout-babel04/rout-babel04.yml) file  
        3. Launch ContainerLab `rout-babel04.yml` topology:  

        ```
           containerlab deploy --topo rout-babel04.yml  
        ```
        4. Destroy ContainerLab `rout-babel04.yml` topology:  

        ```
           containerlab destroy --topo rout-babel04.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-babel04.tst` file [here](../tst/rout-babel04.tst)  
        3. Launch `rout-babel04.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-babel04 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-babel04.tst` test:  
