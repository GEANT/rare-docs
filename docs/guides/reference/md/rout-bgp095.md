...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp095/rout-bgp095.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp095](../clab/rout-bgp095/rout-bgp095.yml) file  
        3. Launch ContainerLab `rout-bgp095.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp095.yml  
        ```
        4. Destroy ContainerLab `rout-bgp095.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp095.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp095.tst` file [here](../tst/rout-bgp095.tst)  
        3. Launch `rout-bgp095.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp095 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp095.tst` test:  
