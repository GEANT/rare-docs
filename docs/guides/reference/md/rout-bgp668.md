# Example: ctp colors over ebgp

=== "Topology"

    ![Alt text](../d2/rout-bgp668/rout-bgp668.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp668](../clab/rout-bgp668/rout-bgp668.yml) file  
        3. Launch ContainerLab `rout-bgp668.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp668.yml  
        ```
        4. Destroy ContainerLab `rout-bgp668.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp668.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp668.tst` file [here](../tst/rout-bgp668.tst)  
        3. Launch `rout-bgp668.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp668 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp668.tst` test:  
