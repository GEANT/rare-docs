# Example: l3evpns over ibgp

=== "Topology"

    ![Alt text](../d2/rout-bgp801/rout-bgp801.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp801](../clab/rout-bgp801/rout-bgp801.yml) file  
        3. Launch ContainerLab `rout-bgp801.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp801.yml  
        ```
        4. Destroy ContainerLab `rout-bgp801.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp801.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp801.tst` file [here](../tst/rout-bgp801.tst)  
        3. Launch `rout-bgp801.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp801 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp801.tst` test:  
