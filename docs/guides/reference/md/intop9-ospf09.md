...
=== "Topology"
    ...
    ![Alt text](../d2/intop9-ospf09/intop9-ospf09.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [intop9-ospf09](../clab/intop9-ospf09/intop9-ospf09.yml) file  
        3. Launch ContainerLab `intop9-ospf09.yml` topology:  

        ```
           containerlab deploy --topo intop9-ospf09.yml  
        ```
        4. Destroy ContainerLab `intop9-ospf09.yml` topology:  

        ```
           containerlab destroy --topo intop9-ospf09.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `intop9-ospf09.tst` file [here](../tst/intop9-ospf09.tst)  
        3. Launch `intop9-ospf09.tst` test:  

        ```
           java -jar ../../rtr.jar test tester intop9-ospf09 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `intop9-ospf09.tst` test:  
