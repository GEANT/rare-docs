...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout008/p4lang-rout008.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout008](../clab/p4lang-rout008/p4lang-rout008.yml) file  
        3. Launch ContainerLab `p4lang-rout008.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout008.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout008.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout008.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout008.tst` file [here](../tst/p4lang-rout008.tst)  
        3. Launch `p4lang-rout008.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout008 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout008.tst` test:  
