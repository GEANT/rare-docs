...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp109/rout-bgp109.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp109](../clab/rout-bgp109/rout-bgp109.yml) file  
        3. Launch ContainerLab `rout-bgp109.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp109.yml  
        ```
        4. Destroy ContainerLab `rout-bgp109.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp109.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp109.tst` file [here](../tst/rout-bgp109.tst)  
        3. Launch `rout-bgp109.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp109 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp109.tst` test:  
