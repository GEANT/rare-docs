...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp169/rout-bgp169.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp169](../clab/rout-bgp169/rout-bgp169.yml) file  
        3. Launch ContainerLab `rout-bgp169.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp169.yml  
        ```
        4. Destroy ContainerLab `rout-bgp169.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp169.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp169.tst` file [here](../tst/rout-bgp169.tst)  
        3. Launch `rout-bgp169.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp169 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp169.tst` test:  
