# Example: other car colors over ebgp

=== "Topology"

    ![Alt text](../d2/rout-bgp759/rout-bgp759.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp759](../clab/rout-bgp759/rout-bgp759.yml) file  
        3. Launch ContainerLab `rout-bgp759.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp759.yml  
        ```
        4. Destroy ContainerLab `rout-bgp759.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp759.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp759.tst` file [here](../tst/rout-bgp759.tst)  
        3. Launch `rout-bgp759.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp759 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp759.tst` test:  
