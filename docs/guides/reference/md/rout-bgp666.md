# Example: bgp routepolicy rd rewrite

=== "Topology"

    ![Alt text](../d2/rout-bgp666/rout-bgp666.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp666](../clab/rout-bgp666/rout-bgp666.yml) file  
        3. Launch ContainerLab `rout-bgp666.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp666.yml  
        ```
        4. Destroy ContainerLab `rout-bgp666.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp666.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp666.tst` file [here](../tst/rout-bgp666.tst)  
        3. Launch `rout-bgp666.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp666 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp666.tst` test:  
