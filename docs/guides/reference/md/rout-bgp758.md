# Example: car colors over ebgp

=== "Topology"

    ![Alt text](../d2/rout-bgp758/rout-bgp758.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp758](../clab/rout-bgp758/rout-bgp758.yml) file  
        3. Launch ContainerLab `rout-bgp758.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp758.yml  
        ```
        4. Destroy ContainerLab `rout-bgp758.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp758.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp758.tst` file [here](../tst/rout-bgp758.tst)  
        3. Launch `rout-bgp758.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp758 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp758.tst` test:  
