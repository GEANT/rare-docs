...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp554/rout-bgp554.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp554](../clab/rout-bgp554/rout-bgp554.yml) file  
        3. Launch ContainerLab `rout-bgp554.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp554.yml  
        ```
        4. Destroy ContainerLab `rout-bgp554.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp554.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp554.tst` file [here](../tst/rout-bgp554.tst)  
        3. Launch `rout-bgp554.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp554 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp554.tst` test:  
