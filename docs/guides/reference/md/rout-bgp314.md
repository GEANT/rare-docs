...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp314/rout-bgp314.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp314](../clab/rout-bgp314/rout-bgp314.yml) file  
        3. Launch ContainerLab `rout-bgp314.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp314.yml  
        ```
        4. Destroy ContainerLab `rout-bgp314.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp314.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp314.tst` file [here](../tst/rout-bgp314.tst)  
        3. Launch `rout-bgp314.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp314 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp314.tst` test:  
