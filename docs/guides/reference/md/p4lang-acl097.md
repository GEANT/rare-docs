# Example: p4lang: tmux interface verify source

=== "Topology"

    ![Alt text](../d2/p4lang-acl097/p4lang-acl097.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl097](../clab/p4lang-acl097/p4lang-acl097.yml) file  
        3. Launch ContainerLab `p4lang-acl097.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl097.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl097.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl097.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl097.tst` file [here](../tst/p4lang-acl097.tst)  
        3. Launch `p4lang-acl097.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl097 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl097.tst` test:  
