...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp392/rout-bgp392.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp392](../clab/rout-bgp392/rout-bgp392.yml) file  
        3. Launch ContainerLab `rout-bgp392.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp392.yml  
        ```
        4. Destroy ContainerLab `rout-bgp392.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp392.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp392.tst` file [here](../tst/rout-bgp392.tst)  
        3. Launch `rout-bgp392.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp392 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp392.tst` test:  
