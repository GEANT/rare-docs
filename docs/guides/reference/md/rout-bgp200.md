...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp200/rout-bgp200.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp200](../clab/rout-bgp200/rout-bgp200.yml) file  
        3. Launch ContainerLab `rout-bgp200.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp200.yml  
        ```
        4. Destroy ContainerLab `rout-bgp200.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp200.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp200.tst` file [here](../tst/rout-bgp200.tst)  
        3. Launch `rout-bgp200.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp200 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp200.tst` test:  
