...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp159/rout-bgp159.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp159](../clab/rout-bgp159/rout-bgp159.yml) file  
        3. Launch ContainerLab `rout-bgp159.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp159.yml  
        ```
        4. Destroy ContainerLab `rout-bgp159.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp159.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp159.tst` file [here](../tst/rout-bgp159.tst)  
        3. Launch `rout-bgp159.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp159 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp159.tst` test:  
