...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout166/p4lang-rout166.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout166](../clab/p4lang-rout166/p4lang-rout166.yml) file  
        3. Launch ContainerLab `p4lang-rout166.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout166.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout166.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout166.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout166.tst` file [here](../tst/p4lang-rout166.tst)  
        3. Launch `p4lang-rout166.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout166 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout166.tst` test:  
