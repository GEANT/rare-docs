...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp067/rout-bgp067.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp067](../clab/rout-bgp067/rout-bgp067.yml) file  
        3. Launch ContainerLab `rout-bgp067.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp067.yml  
        ```
        4. Destroy ContainerLab `rout-bgp067.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp067.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp067.tst` file [here](../tst/rout-bgp067.tst)  
        3. Launch `rout-bgp067.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp067 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp067.tst` test:  
