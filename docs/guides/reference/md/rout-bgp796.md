# Example: bgp change in aggregator

=== "Topology"

    ![Alt text](../d2/rout-bgp796/rout-bgp796.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp796](../clab/rout-bgp796/rout-bgp796.yml) file  
        3. Launch ContainerLab `rout-bgp796.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp796.yml  
        ```
        4. Destroy ContainerLab `rout-bgp796.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp796.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp796.tst` file [here](../tst/rout-bgp796.tst)  
        3. Launch `rout-bgp796.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp796 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp796.tst` test:  
