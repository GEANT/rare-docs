...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout037/p4lang-rout037.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout037](../clab/p4lang-rout037/p4lang-rout037.yml) file  
        3. Launch ContainerLab `p4lang-rout037.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout037.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout037.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout037.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout037.tst` file [here](../tst/p4lang-rout037.tst)  
        3. Launch `p4lang-rout037.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout037 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout037.tst` test:  
