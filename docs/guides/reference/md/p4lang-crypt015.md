...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt015/p4lang-crypt015.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt015](../clab/p4lang-crypt015/p4lang-crypt015.yml) file  
        3. Launch ContainerLab `p4lang-crypt015.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt015.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt015.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt015.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt015.tst` file [here](../tst/p4lang-crypt015.tst)  
        3. Launch `p4lang-crypt015.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt015 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt015.tst` test:  
