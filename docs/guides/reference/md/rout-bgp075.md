...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp075/rout-bgp075.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp075](../clab/rout-bgp075/rout-bgp075.yml) file  
        3. Launch ContainerLab `rout-bgp075.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp075.yml  
        ```
        4. Destroy ContainerLab `rout-bgp075.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp075.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp075.tst` file [here](../tst/rout-bgp075.tst)  
        3. Launch `rout-bgp075.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp075 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp075.tst` test:  
