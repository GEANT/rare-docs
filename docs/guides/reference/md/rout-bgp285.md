...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp285/rout-bgp285.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp285](../clab/rout-bgp285/rout-bgp285.yml) file  
        3. Launch ContainerLab `rout-bgp285.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp285.yml  
        ```
        4. Destroy ContainerLab `rout-bgp285.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp285.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp285.tst` file [here](../tst/rout-bgp285.tst)  
        3. Launch `rout-bgp285.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp285 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp285.tst` test:  
