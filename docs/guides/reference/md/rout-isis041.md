...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis041/rout-isis041.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis041](../clab/rout-isis041/rout-isis041.yml) file  
        3. Launch ContainerLab `rout-isis041.yml` topology:  

        ```
           containerlab deploy --topo rout-isis041.yml  
        ```
        4. Destroy ContainerLab `rout-isis041.yml` topology:  

        ```
           containerlab destroy --topo rout-isis041.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis041.tst` file [here](../tst/rout-isis041.tst)  
        3. Launch `rout-isis041.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis041 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis041.tst` test:  
