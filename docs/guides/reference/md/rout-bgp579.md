...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp579/rout-bgp579.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp579](../clab/rout-bgp579/rout-bgp579.yml) file  
        3. Launch ContainerLab `rout-bgp579.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp579.yml  
        ```
        4. Destroy ContainerLab `rout-bgp579.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp579.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp579.tst` file [here](../tst/rout-bgp579.tst)  
        3. Launch `rout-bgp579.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp579 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp579.tst` test:  
