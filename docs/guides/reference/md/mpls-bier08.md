...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-bier08/mpls-bier08.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-bier08](../clab/mpls-bier08/mpls-bier08.yml) file  
        3. Launch ContainerLab `mpls-bier08.yml` topology:  

        ```
           containerlab deploy --topo mpls-bier08.yml  
        ```
        4. Destroy ContainerLab `mpls-bier08.yml` topology:  

        ```
           containerlab destroy --topo mpls-bier08.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-bier08.tst` file [here](../tst/mpls-bier08.tst)  
        3. Launch `mpls-bier08.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-bier08 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-bier08.tst` test:  
