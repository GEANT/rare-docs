...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp552/rout-bgp552.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp552](../clab/rout-bgp552/rout-bgp552.yml) file  
        3. Launch ContainerLab `rout-bgp552.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp552.yml  
        ```
        4. Destroy ContainerLab `rout-bgp552.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp552.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp552.tst` file [here](../tst/rout-bgp552.tst)  
        3. Launch `rout-bgp552.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp552 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp552.tst` test:  
