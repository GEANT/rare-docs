...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp004/rout-bgp004.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp004](../clab/rout-bgp004/rout-bgp004.yml) file  
        3. Launch ContainerLab `rout-bgp004.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp004.yml  
        ```
        4. Destroy ContainerLab `rout-bgp004.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp004.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp004.tst` file [here](../tst/rout-bgp004.tst)  
        3. Launch `rout-bgp004.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp004 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp004.tst` test:  
