...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp206/rout-bgp206.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp206](../clab/rout-bgp206/rout-bgp206.yml) file  
        3. Launch ContainerLab `rout-bgp206.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp206.yml  
        ```
        4. Destroy ContainerLab `rout-bgp206.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp206.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp206.tst` file [here](../tst/rout-bgp206.tst)  
        3. Launch `rout-bgp206.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp206 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp206.tst` test:  
