...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp214/rout-bgp214.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp214](../clab/rout-bgp214/rout-bgp214.yml) file  
        3. Launch ContainerLab `rout-bgp214.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp214.yml  
        ```
        4. Destroy ContainerLab `rout-bgp214.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp214.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp214.tst` file [here](../tst/rout-bgp214.tst)  
        3. Launch `rout-bgp214.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp214 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp214.tst` test:  
