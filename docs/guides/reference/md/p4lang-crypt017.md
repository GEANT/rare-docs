...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt017/p4lang-crypt017.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt017](../clab/p4lang-crypt017/p4lang-crypt017.yml) file  
        3. Launch ContainerLab `p4lang-crypt017.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt017.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt017.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt017.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt017.tst` file [here](../tst/p4lang-crypt017.tst)  
        3. Launch `p4lang-crypt017.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt017 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt017.tst` test:  
