...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp251/rout-bgp251.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp251](../clab/rout-bgp251/rout-bgp251.yml) file  
        3. Launch ContainerLab `rout-bgp251.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp251.yml  
        ```
        4. Destroy ContainerLab `rout-bgp251.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp251.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp251.tst` file [here](../tst/rout-bgp251.tst)  
        3. Launch `rout-bgp251.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp251 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp251.tst` test:  
