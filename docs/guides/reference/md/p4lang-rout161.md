...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout161/p4lang-rout161.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout161](../clab/p4lang-rout161/p4lang-rout161.yml) file  
        3. Launch ContainerLab `p4lang-rout161.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout161.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout161.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout161.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout161.tst` file [here](../tst/p4lang-rout161.tst)  
        3. Launch `p4lang-rout161.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout161 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout161.tst` test:  
