# Example: otherl3evpns ingress route filtering with routemap

=== "Topology"

    ![Alt text](../d2/rout-bgp840/rout-bgp840.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp840](../clab/rout-bgp840/rout-bgp840.yml) file  
        3. Launch ContainerLab `rout-bgp840.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp840.yml  
        ```
        4. Destroy ContainerLab `rout-bgp840.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp840.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp840.tst` file [here](../tst/rout-bgp840.tst)  
        3. Launch `rout-bgp840.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp840 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp840.tst` test:  
