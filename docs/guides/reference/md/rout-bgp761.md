# Example: other car colors over ibgp

=== "Topology"

    ![Alt text](../d2/rout-bgp761/rout-bgp761.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp761](../clab/rout-bgp761/rout-bgp761.yml) file  
        3. Launch ContainerLab `rout-bgp761.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp761.yml  
        ```
        4. Destroy ContainerLab `rout-bgp761.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp761.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp761.tst` file [here](../tst/rout-bgp761.tst)  
        3. Launch `rout-bgp761.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp761 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp761.tst` test:  
