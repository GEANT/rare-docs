...
=== "Topology"
    ...
    ![Alt text](../d2/rout-pvrp14/rout-pvrp14.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-pvrp14](../clab/rout-pvrp14/rout-pvrp14.yml) file  
        3. Launch ContainerLab `rout-pvrp14.yml` topology:  

        ```
           containerlab deploy --topo rout-pvrp14.yml  
        ```
        4. Destroy ContainerLab `rout-pvrp14.yml` topology:  

        ```
           containerlab destroy --topo rout-pvrp14.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-pvrp14.tst` file [here](../tst/rout-pvrp14.tst)  
        3. Launch `rout-pvrp14.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-pvrp14 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-pvrp14.tst` test:  
