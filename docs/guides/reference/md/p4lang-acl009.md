...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-acl009/p4lang-acl009.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl009](../clab/p4lang-acl009/p4lang-acl009.yml) file  
        3. Launch ContainerLab `p4lang-acl009.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl009.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl009.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl009.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl009.tst` file [here](../tst/p4lang-acl009.tst)  
        3. Launch `p4lang-acl009.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl009 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl009.tst` test:  
