...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp189/rout-bgp189.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp189](../clab/rout-bgp189/rout-bgp189.yml) file  
        3. Launch ContainerLab `rout-bgp189.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp189.yml  
        ```
        4. Destroy ContainerLab `rout-bgp189.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp189.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp189.tst` file [here](../tst/rout-bgp189.tst)  
        3. Launch `rout-bgp189.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp189 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp189.tst` test:  
