...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp318/rout-bgp318.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp318](../clab/rout-bgp318/rout-bgp318.yml) file  
        3. Launch ContainerLab `rout-bgp318.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp318.yml  
        ```
        4. Destroy ContainerLab `rout-bgp318.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp318.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp318.tst` file [here](../tst/rout-bgp318.tst)  
        3. Launch `rout-bgp318.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp318 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp318.tst` test:  
