...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf19/rout-ospf19.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf19](../clab/rout-ospf19/rout-ospf19.yml) file  
        3. Launch ContainerLab `rout-ospf19.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf19.yml  
        ```
        4. Destroy ContainerLab `rout-ospf19.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf19.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf19.tst` file [here](../tst/rout-ospf19.tst)  
        3. Launch `rout-ospf19.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf19 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf19.tst` test:  
