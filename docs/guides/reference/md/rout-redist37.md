# Example: redistribution filtering with accesslist in routemap

=== "Topology"

    ![Alt text](../d2/rout-redist37/rout-redist37.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist37](../clab/rout-redist37/rout-redist37.yml) file  
        3. Launch ContainerLab `rout-redist37.yml` topology:  

        ```
           containerlab deploy --topo rout-redist37.yml  
        ```
        4. Destroy ContainerLab `rout-redist37.yml` topology:  

        ```
           containerlab destroy --topo rout-redist37.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist37.tst` file [here](../tst/rout-redist37.tst)  
        3. Launch `rout-redist37.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist37 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist37.tst` test:  
