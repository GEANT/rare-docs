...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-bier07/mpls-bier07.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-bier07](../clab/mpls-bier07/mpls-bier07.yml) file  
        3. Launch ContainerLab `mpls-bier07.yml` topology:  

        ```
           containerlab deploy --topo mpls-bier07.yml  
        ```
        4. Destroy ContainerLab `mpls-bier07.yml` topology:  

        ```
           containerlab destroy --topo mpls-bier07.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-bier07.tst` file [here](../tst/mpls-bier07.tst)  
        3. Launch `mpls-bier07.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-bier07 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-bier07.tst` test:  
