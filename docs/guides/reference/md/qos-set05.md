...
=== "Topology"
    ...
    ![Alt text](../d2/qos-set05/qos-set05.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [qos-set05](../clab/qos-set05/qos-set05.yml) file  
        3. Launch ContainerLab `qos-set05.yml` topology:  

        ```
           containerlab deploy --topo qos-set05.yml  
        ```
        4. Destroy ContainerLab `qos-set05.yml` topology:  

        ```
           containerlab destroy --topo qos-set05.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `qos-set05.tst` file [here](../tst/qos-set05.tst)  
        3. Launch `qos-set05.tst` test:  

        ```
           java -jar ../../rtr.jar test tester qos-set05 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `qos-set05.tst` test:  
