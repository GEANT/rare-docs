# Example: rift change in tag

=== "Topology"

    ![Alt text](../d2/rout-rift14/rout-rift14.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rift14](../clab/rout-rift14/rout-rift14.yml) file  
        3. Launch ContainerLab `rout-rift14.yml` topology:  

        ```
           containerlab deploy --topo rout-rift14.yml  
        ```
        4. Destroy ContainerLab `rout-rift14.yml` topology:  

        ```
           containerlab destroy --topo rout-rift14.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rift14.tst` file [here](../tst/rout-rift14.tst)  
        3. Launch `rout-rift14.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rift14 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rift14.tst` test:  
