...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp451/rout-bgp451.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp451](../clab/rout-bgp451/rout-bgp451.yml) file  
        3. Launch ContainerLab `rout-bgp451.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp451.yml  
        ```
        4. Destroy ContainerLab `rout-bgp451.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp451.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp451.tst` file [here](../tst/rout-bgp451.tst)  
        3. Launch `rout-bgp451.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp451 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp451.tst` test:  
