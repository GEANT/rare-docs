...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp414/rout-bgp414.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp414](../clab/rout-bgp414/rout-bgp414.yml) file  
        3. Launch ContainerLab `rout-bgp414.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp414.yml  
        ```
        4. Destroy ContainerLab `rout-bgp414.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp414.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp414.tst` file [here](../tst/rout-bgp414.tst)  
        3. Launch `rout-bgp414.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp414 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp414.tst` test:  
