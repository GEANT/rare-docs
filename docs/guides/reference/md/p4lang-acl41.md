...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-acl41/p4lang-acl41.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl41](../clab/p4lang-acl41/p4lang-acl41.yml) file  
        3. Launch ContainerLab `p4lang-acl41.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl41.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl41.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl41.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl41.tst` file [here](../tst/p4lang-acl41.tst)  
        3. Launch `p4lang-acl41.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl41 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl41.tst` test:  
