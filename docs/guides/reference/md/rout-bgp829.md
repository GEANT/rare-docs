# Example: unicast+l3evpns over ibgp with dynamic capability

=== "Topology"

    ![Alt text](../d2/rout-bgp829/rout-bgp829.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp829](../clab/rout-bgp829/rout-bgp829.yml) file  
        3. Launch ContainerLab `rout-bgp829.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp829.yml  
        ```
        4. Destroy ContainerLab `rout-bgp829.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp829.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp829.tst` file [here](../tst/rout-bgp829.tst)  
        3. Launch `rout-bgp829.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp829 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp829.tst` test:  
