...
=== "Topology"
    ...
    ![Alt text](../d2/intop2-ldp03/intop2-ldp03.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [intop2-ldp03](../clab/intop2-ldp03/intop2-ldp03.yml) file  
        3. Launch ContainerLab `intop2-ldp03.yml` topology:  

        ```
           containerlab deploy --topo intop2-ldp03.yml  
        ```
        4. Destroy ContainerLab `intop2-ldp03.yml` topology:  

        ```
           containerlab destroy --topo intop2-ldp03.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `intop2-ldp03.tst` file [here](../tst/intop2-ldp03.tst)  
        3. Launch `intop2-ldp03.tst` test:  

        ```
           java -jar ../../rtr.jar test tester intop2-ldp03 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `intop2-ldp03.tst` test:  
