...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp064/rout-bgp064.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp064](../clab/rout-bgp064/rout-bgp064.yml) file  
        3. Launch ContainerLab `rout-bgp064.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp064.yml  
        ```
        4. Destroy ContainerLab `rout-bgp064.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp064.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp064.tst` file [here](../tst/rout-bgp064.tst)  
        3. Launch `rout-bgp064.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp064 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp064.tst` test:  
