...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp549/rout-bgp549.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp549](../clab/rout-bgp549/rout-bgp549.yml) file  
        3. Launch ContainerLab `rout-bgp549.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp549.yml  
        ```
        4. Destroy ContainerLab `rout-bgp549.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp549.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp549.tst` file [here](../tst/rout-bgp549.tst)  
        3. Launch `rout-bgp549.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp549 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp549.tst` test:  
