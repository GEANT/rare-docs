...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp406/rout-bgp406.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp406](../clab/rout-bgp406/rout-bgp406.yml) file  
        3. Launch ContainerLab `rout-bgp406.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp406.yml  
        ```
        4. Destroy ContainerLab `rout-bgp406.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp406.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp406.tst` file [here](../tst/rout-bgp406.tst)  
        3. Launch `rout-bgp406.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp406 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp406.tst` test:  
