...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-acl067/p4lang-acl067.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl067](../clab/p4lang-acl067/p4lang-acl067.yml) file  
        3. Launch ContainerLab `p4lang-acl067.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl067.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl067.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl067.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl067.tst` file [here](../tst/p4lang-acl067.tst)  
        3. Launch `p4lang-acl067.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl067 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl067.tst` test:  
