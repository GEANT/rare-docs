...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp03/rout-lsrp03.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp03](../clab/rout-lsrp03/rout-lsrp03.yml) file  
        3. Launch ContainerLab `rout-lsrp03.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp03.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp03.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp03.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp03.tst` file [here](../tst/rout-lsrp03.tst)  
        3. Launch `rout-lsrp03.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp03 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp03.tst` test:  
