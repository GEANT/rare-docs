...
=== "Topology"
    ...
    ![Alt text](../d2/rout-redist03/rout-redist03.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist03](../clab/rout-redist03/rout-redist03.yml) file  
        3. Launch ContainerLab `rout-redist03.yml` topology:  

        ```
           containerlab deploy --topo rout-redist03.yml  
        ```
        4. Destroy ContainerLab `rout-redist03.yml` topology:  

        ```
           containerlab destroy --topo rout-redist03.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist03.tst` file [here](../tst/rout-redist03.tst)  
        3. Launch `rout-redist03.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist03 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist03.tst` test:  
