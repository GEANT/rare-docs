...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp361/rout-bgp361.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp361](../clab/rout-bgp361/rout-bgp361.yml) file  
        3. Launch ContainerLab `rout-bgp361.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp361.yml  
        ```
        4. Destroy ContainerLab `rout-bgp361.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp361.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp361.tst` file [here](../tst/rout-bgp361.tst)  
        3. Launch `rout-bgp361.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp361 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp361.tst` test:  
