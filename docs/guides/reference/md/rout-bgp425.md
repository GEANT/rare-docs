...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp425/rout-bgp425.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp425](../clab/rout-bgp425/rout-bgp425.yml) file  
        3. Launch ContainerLab `rout-bgp425.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp425.yml  
        ```
        4. Destroy ContainerLab `rout-bgp425.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp425.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp425.tst` file [here](../tst/rout-bgp425.tst)  
        3. Launch `rout-bgp425.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp425 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp425.tst` test:  
