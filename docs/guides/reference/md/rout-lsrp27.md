...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp27/rout-lsrp27.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp27](../clab/rout-lsrp27/rout-lsrp27.yml) file  
        3. Launch ContainerLab `rout-lsrp27.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp27.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp27.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp27.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp27.tst` file [here](../tst/rout-lsrp27.tst)  
        3. Launch `rout-lsrp27.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp27 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp27.tst` test:  
