...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp220/rout-bgp220.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp220](../clab/rout-bgp220/rout-bgp220.yml) file  
        3. Launch ContainerLab `rout-bgp220.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp220.yml  
        ```
        4. Destroy ContainerLab `rout-bgp220.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp220.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp220.tst` file [here](../tst/rout-bgp220.tst)  
        3. Launch `rout-bgp220.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp220 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp220.tst` test:  
