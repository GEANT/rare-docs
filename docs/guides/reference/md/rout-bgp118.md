...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp118/rout-bgp118.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp118](../clab/rout-bgp118/rout-bgp118.yml) file  
        3. Launch ContainerLab `rout-bgp118.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp118.yml  
        ```
        4. Destroy ContainerLab `rout-bgp118.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp118.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp118.tst` file [here](../tst/rout-bgp118.tst)  
        3. Launch `rout-bgp118.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp118 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp118.tst` test:  
