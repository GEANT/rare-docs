...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf33/rout-ospf33.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf33](../clab/rout-ospf33/rout-ospf33.yml) file  
        3. Launch ContainerLab `rout-ospf33.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf33.yml  
        ```
        4. Destroy ContainerLab `rout-ospf33.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf33.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf33.tst` file [here](../tst/rout-ospf33.tst)  
        3. Launch `rout-ospf33.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf33 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf33.tst` test:  
