...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp128/rout-bgp128.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp128](../clab/rout-bgp128/rout-bgp128.yml) file  
        3. Launch ContainerLab `rout-bgp128.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp128.yml  
        ```
        4. Destroy ContainerLab `rout-bgp128.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp128.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp128.tst` file [here](../tst/rout-bgp128.tst)  
        3. Launch `rout-bgp128.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp128 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp128.tst` test:  
