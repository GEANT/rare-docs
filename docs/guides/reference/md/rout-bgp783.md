# Example: bgp routemap filtering with validity with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp783/rout-bgp783.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp783](../clab/rout-bgp783/rout-bgp783.yml) file  
        3. Launch ContainerLab `rout-bgp783.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp783.yml  
        ```
        4. Destroy ContainerLab `rout-bgp783.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp783.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp783.tst` file [here](../tst/rout-bgp783.tst)  
        3. Launch `rout-bgp783.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp783 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp783.tst` test:  
