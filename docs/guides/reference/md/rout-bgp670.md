# Example: ctp colors over ibgp

=== "Topology"

    ![Alt text](../d2/rout-bgp670/rout-bgp670.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp670](../clab/rout-bgp670/rout-bgp670.yml) file  
        3. Launch ContainerLab `rout-bgp670.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp670.yml  
        ```
        4. Destroy ContainerLab `rout-bgp670.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp670.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp670.tst` file [here](../tst/rout-bgp670.tst)  
        3. Launch `rout-bgp670.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp670 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp670.tst` test:  
