# Example: ibgp rr otherl3evpns prefix withdraw

=== "Topology"

    ![Alt text](../d2/rout-bgp823/rout-bgp823.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp823](../clab/rout-bgp823/rout-bgp823.yml) file  
        3. Launch ContainerLab `rout-bgp823.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp823.yml  
        ```
        4. Destroy ContainerLab `rout-bgp823.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp823.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp823.tst` file [here](../tst/rout-bgp823.tst)  
        3. Launch `rout-bgp823.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp823 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp823.tst` test:  
