...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp011/rout-bgp011.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp011](../clab/rout-bgp011/rout-bgp011.yml) file  
        3. Launch ContainerLab `rout-bgp011.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp011.yml  
        ```
        4. Destroy ContainerLab `rout-bgp011.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp011.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp011.tst` file [here](../tst/rout-bgp011.tst)  
        3. Launch `rout-bgp011.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp011 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp011.tst` test:  
