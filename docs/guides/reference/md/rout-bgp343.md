...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp343/rout-bgp343.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp343](../clab/rout-bgp343/rout-bgp343.yml) file  
        3. Launch ContainerLab `rout-bgp343.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp343.yml  
        ```
        4. Destroy ContainerLab `rout-bgp343.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp343.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp343.tst` file [here](../tst/rout-bgp343.tst)  
        3. Launch `rout-bgp343.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp343 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp343.tst` test:  
