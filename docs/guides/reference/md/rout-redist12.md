...
=== "Topology"
    ...
    ![Alt text](../d2/rout-redist12/rout-redist12.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist12](../clab/rout-redist12/rout-redist12.yml) file  
        3. Launch ContainerLab `rout-redist12.yml` topology:  

        ```
           containerlab deploy --topo rout-redist12.yml  
        ```
        4. Destroy ContainerLab `rout-redist12.yml` topology:  

        ```
           containerlab destroy --topo rout-redist12.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist12.tst` file [here](../tst/rout-redist12.tst)  
        3. Launch `rout-redist12.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist12 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist12.tst` test:  
