...
=== "Topology"
    ...
    ![Alt text](../d2/rout-pvrp02/rout-pvrp02.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-pvrp02](../clab/rout-pvrp02/rout-pvrp02.yml) file  
        3. Launch ContainerLab `rout-pvrp02.yml` topology:  

        ```
           containerlab deploy --topo rout-pvrp02.yml  
        ```
        4. Destroy ContainerLab `rout-pvrp02.yml` topology:  

        ```
           containerlab destroy --topo rout-pvrp02.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-pvrp02.tst` file [here](../tst/rout-pvrp02.tst)  
        3. Launch `rout-pvrp02.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-pvrp02 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-pvrp02.tst` test:  
