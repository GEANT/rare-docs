...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp119/rout-bgp119.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp119](../clab/rout-bgp119/rout-bgp119.yml) file  
        3. Launch ContainerLab `rout-bgp119.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp119.yml  
        ```
        4. Destroy ContainerLab `rout-bgp119.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp119.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp119.tst` file [here](../tst/rout-bgp119.tst)  
        3. Launch `rout-bgp119.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp119 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp119.tst` test:  
