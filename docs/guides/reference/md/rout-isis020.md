...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis020/rout-isis020.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis020](../clab/rout-isis020/rout-isis020.yml) file  
        3. Launch ContainerLab `rout-isis020.yml` topology:  

        ```
           containerlab deploy --topo rout-isis020.yml  
        ```
        4. Destroy ContainerLab `rout-isis020.yml` topology:  

        ```
           containerlab destroy --topo rout-isis020.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis020.tst` file [here](../tst/rout-isis020.tst)  
        3. Launch `rout-isis020.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis020 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis020.tst` test:  
