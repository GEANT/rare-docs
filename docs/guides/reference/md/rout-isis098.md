...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis098/rout-isis098.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis098](../clab/rout-isis098/rout-isis098.yml) file  
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis098.tst` file [here](../tst/rout-isis098.tst)  
