...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis085/rout-isis085.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis085](../clab/rout-isis085/rout-isis085.yml) file  
        3. Launch ContainerLab `rout-isis085.yml` topology:  

        ```
           containerlab deploy --topo rout-isis085.yml  
        ```
        4. Destroy ContainerLab `rout-isis085.yml` topology:  

        ```
           containerlab destroy --topo rout-isis085.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis085.tst` file [here](../tst/rout-isis085.tst)  
        3. Launch `rout-isis085.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis085 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis085.tst` test:  
