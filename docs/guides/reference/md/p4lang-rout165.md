...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout165/p4lang-rout165.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout165](../clab/p4lang-rout165/p4lang-rout165.yml) file  
        3. Launch ContainerLab `p4lang-rout165.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout165.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout165.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout165.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout165.tst` file [here](../tst/p4lang-rout165.tst)  
        3. Launch `p4lang-rout165.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout165 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout165.tst` test:  
