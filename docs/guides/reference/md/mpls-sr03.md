...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-sr03/mpls-sr03.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-sr03](../clab/mpls-sr03/mpls-sr03.yml) file  
        3. Launch ContainerLab `mpls-sr03.yml` topology:  

        ```
           containerlab deploy --topo mpls-sr03.yml  
        ```
        4. Destroy ContainerLab `mpls-sr03.yml` topology:  

        ```
           containerlab destroy --topo mpls-sr03.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-sr03.tst` file [here](../tst/mpls-sr03.tst)  
        3. Launch `mpls-sr03.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-sr03 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-sr03.tst` test:  
