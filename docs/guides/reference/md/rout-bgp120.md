...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp120/rout-bgp120.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp120](../clab/rout-bgp120/rout-bgp120.yml) file  
        3. Launch ContainerLab `rout-bgp120.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp120.yml  
        ```
        4. Destroy ContainerLab `rout-bgp120.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp120.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp120.tst` file [here](../tst/rout-bgp120.tst)  
        3. Launch `rout-bgp120.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp120 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp120.tst` test:  
