...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp356/rout-bgp356.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp356](../clab/rout-bgp356/rout-bgp356.yml) file  
        3. Launch ContainerLab `rout-bgp356.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp356.yml  
        ```
        4. Destroy ContainerLab `rout-bgp356.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp356.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp356.tst` file [here](../tst/rout-bgp356.tst)  
        3. Launch `rout-bgp356.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp356 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp356.tst` test:  
