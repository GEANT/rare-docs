...
=== "Topology"
    ...
    ![Alt text](../d2/rout-redist07/rout-redist07.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist07](../clab/rout-redist07/rout-redist07.yml) file  
        3. Launch ContainerLab `rout-redist07.yml` topology:  

        ```
           containerlab deploy --topo rout-redist07.yml  
        ```
        4. Destroy ContainerLab `rout-redist07.yml` topology:  

        ```
           containerlab destroy --topo rout-redist07.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist07.tst` file [here](../tst/rout-redist07.tst)  
        3. Launch `rout-redist07.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist07 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist07.tst` test:  
