# Example: l3evpns with ingress rtfilter

=== "Topology"

    ![Alt text](../d2/rout-bgp824/rout-bgp824.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp824](../clab/rout-bgp824/rout-bgp824.yml) file  
        3. Launch ContainerLab `rout-bgp824.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp824.yml  
        ```
        4. Destroy ContainerLab `rout-bgp824.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp824.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp824.tst` file [here](../tst/rout-bgp824.tst)  
        3. Launch `rout-bgp824.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp824 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp824.tst` test:  
