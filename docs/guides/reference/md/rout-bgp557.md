...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp557/rout-bgp557.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp557](../clab/rout-bgp557/rout-bgp557.yml) file  
        3. Launch ContainerLab `rout-bgp557.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp557.yml  
        ```
        4. Destroy ContainerLab `rout-bgp557.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp557.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp557.tst` file [here](../tst/rout-bgp557.tst)  
        3. Launch `rout-bgp557.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp557 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp557.tst` test:  
