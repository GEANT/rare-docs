...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rip16/rout-rip16.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rip16](../clab/rout-rip16/rout-rip16.yml) file  
        3. Launch ContainerLab `rout-rip16.yml` topology:  

        ```
           containerlab deploy --topo rout-rip16.yml  
        ```
        4. Destroy ContainerLab `rout-rip16.yml` topology:  

        ```
           containerlab destroy --topo rout-rip16.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rip16.tst` file [here](../tst/rout-rip16.tst)  
        3. Launch `rout-rip16.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rip16 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rip16.tst` test:  
