...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp248/rout-bgp248.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp248](../clab/rout-bgp248/rout-bgp248.yml) file  
        3. Launch ContainerLab `rout-bgp248.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp248.yml  
        ```
        4. Destroy ContainerLab `rout-bgp248.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp248.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp248.tst` file [here](../tst/rout-bgp248.tst)  
        3. Launch `rout-bgp248.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp248 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp248.tst` test:  
