# Example: otherl3evpns egress route filtering with routemap

=== "Topology"

    ![Alt text](../d2/rout-bgp841/rout-bgp841.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp841](../clab/rout-bgp841/rout-bgp841.yml) file  
        3. Launch ContainerLab `rout-bgp841.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp841.yml  
        ```
        4. Destroy ContainerLab `rout-bgp841.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp841.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp841.tst` file [here](../tst/rout-bgp841.tst)  
        3. Launch `rout-bgp841.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp841 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp841.tst` test:  
