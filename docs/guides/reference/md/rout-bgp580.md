...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp580/rout-bgp580.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp580](../clab/rout-bgp580/rout-bgp580.yml) file  
        3. Launch ContainerLab `rout-bgp580.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp580.yml  
        ```
        4. Destroy ContainerLab `rout-bgp580.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp580.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp580.tst` file [here](../tst/rout-bgp580.tst)  
        3. Launch `rout-bgp580.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp580 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp580.tst` test:  
