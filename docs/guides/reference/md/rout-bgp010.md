...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp010/rout-bgp010.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp010](../clab/rout-bgp010/rout-bgp010.yml) file  
        3. Launch ContainerLab `rout-bgp010.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp010.yml  
        ```
        4. Destroy ContainerLab `rout-bgp010.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp010.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp010.tst` file [here](../tst/rout-bgp010.tst)  
        3. Launch `rout-bgp010.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp010 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp010.tst` test:  
