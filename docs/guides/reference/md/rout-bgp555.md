...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp555/rout-bgp555.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp555](../clab/rout-bgp555/rout-bgp555.yml) file  
        3. Launch ContainerLab `rout-bgp555.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp555.yml  
        ```
        4. Destroy ContainerLab `rout-bgp555.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp555.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp555.tst` file [here](../tst/rout-bgp555.tst)  
        3. Launch `rout-bgp555.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp555 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp555.tst` test:  
