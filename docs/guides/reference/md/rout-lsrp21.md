...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp21/rout-lsrp21.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp21](../clab/rout-lsrp21/rout-lsrp21.yml) file  
        3. Launch ContainerLab `rout-lsrp21.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp21.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp21.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp21.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp21.tst` file [here](../tst/rout-lsrp21.tst)  
        3. Launch `rout-lsrp21.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp21 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp21.tst` test:  
