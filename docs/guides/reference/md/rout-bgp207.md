...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp207/rout-bgp207.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp207](../clab/rout-bgp207/rout-bgp207.yml) file  
        3. Launch ContainerLab `rout-bgp207.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp207.yml  
        ```
        4. Destroy ContainerLab `rout-bgp207.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp207.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp207.tst` file [here](../tst/rout-bgp207.tst)  
        3. Launch `rout-bgp207.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp207 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp207.tst` test:  
