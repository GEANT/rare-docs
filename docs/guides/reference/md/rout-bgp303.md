...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp303/rout-bgp303.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp303](../clab/rout-bgp303/rout-bgp303.yml) file  
        3. Launch ContainerLab `rout-bgp303.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp303.yml  
        ```
        4. Destroy ContainerLab `rout-bgp303.yml` topology:  
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp303.tst` file [here](../tst/rout-bgp303.tst)  
        3. Launch `rout-bgp303.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp303 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp303.tst` test:  
