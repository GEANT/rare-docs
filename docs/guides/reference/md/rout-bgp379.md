...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp379/rout-bgp379.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp379](../clab/rout-bgp379/rout-bgp379.yml) file  
        3. Launch ContainerLab `rout-bgp379.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp379.yml  
        ```
        4. Destroy ContainerLab `rout-bgp379.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp379.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp379.tst` file [here](../tst/rout-bgp379.tst)  
        3. Launch `rout-bgp379.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp379 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp379.tst` test:  
