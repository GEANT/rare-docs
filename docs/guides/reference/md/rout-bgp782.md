# Example: bgp routemap filtering with validity

=== "Topology"

    ![Alt text](../d2/rout-bgp782/rout-bgp782.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp782](../clab/rout-bgp782/rout-bgp782.yml) file  
        3. Launch ContainerLab `rout-bgp782.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp782.yml  
        ```
        4. Destroy ContainerLab `rout-bgp782.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp782.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp782.tst` file [here](../tst/rout-bgp782.tst)  
        3. Launch `rout-bgp782.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp782 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp782.tst` test:  
