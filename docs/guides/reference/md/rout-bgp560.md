...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp560/rout-bgp560.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp560](../clab/rout-bgp560/rout-bgp560.yml) file  
        3. Launch ContainerLab `rout-bgp560.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp560.yml  
        ```
        4. Destroy ContainerLab `rout-bgp560.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp560.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp560.tst` file [here](../tst/rout-bgp560.tst)  
        3. Launch `rout-bgp560.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp560 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp560.tst` test:  
