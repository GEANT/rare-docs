...
=== "Topology"
    ...
    ![Alt text](../d2/qos-set11/qos-set11.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [qos-set11](../clab/qos-set11/qos-set11.yml) file  
        3. Launch ContainerLab `qos-set11.yml` topology:  

        ```
           containerlab deploy --topo qos-set11.yml  
        ```
        4. Destroy ContainerLab `qos-set11.yml` topology:  

        ```
           containerlab destroy --topo qos-set11.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `qos-set11.tst` file [here](../tst/qos-set11.tst)  
        3. Launch `qos-set11.tst` test:  

        ```
           java -jar ../../rtr.jar test tester qos-set11 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `qos-set11.tst` test:  
