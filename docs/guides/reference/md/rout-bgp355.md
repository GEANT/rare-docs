...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp355/rout-bgp355.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp355](../clab/rout-bgp355/rout-bgp355.yml) file  
        3. Launch ContainerLab `rout-bgp355.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp355.yml  
        ```
        4. Destroy ContainerLab `rout-bgp355.yml` topology:  
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp355.tst` file [here](../tst/rout-bgp355.tst)  
        3. Launch `rout-bgp355.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp355 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp355.tst` test:  
