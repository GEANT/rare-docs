...
=== "Topology"
    ...
    ![Alt text](../d2/rout-babel28/rout-babel28.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-babel28](../clab/rout-babel28/rout-babel28.yml) file  
        3. Launch ContainerLab `rout-babel28.yml` topology:  

        ```
           containerlab deploy --topo rout-babel28.yml  
        ```
        4. Destroy ContainerLab `rout-babel28.yml` topology:  

        ```
           containerlab destroy --topo rout-babel28.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-babel28.tst` file [here](../tst/rout-babel28.tst)  
        3. Launch `rout-babel28.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-babel28 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-babel28.tst` test:  
