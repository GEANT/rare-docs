...
=== "Topology"
    ...
    ![Alt text](../d2/crypt-access01/crypt-access01.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [crypt-access01](../clab/crypt-access01/crypt-access01.yml) file  
        3. Launch ContainerLab `crypt-access01.yml` topology:  

        ```
           containerlab deploy --topo crypt-access01.yml  
        ```
        4. Destroy ContainerLab `crypt-access01.yml` topology:  

        ```
           containerlab destroy --topo crypt-access01.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `crypt-access01.tst` file [here](../tst/crypt-access01.tst)  
        3. Launch `crypt-access01.tst` test:  

        ```
           java -jar ../../rtr.jar test tester crypt-access01 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `crypt-access01.tst` test:  
