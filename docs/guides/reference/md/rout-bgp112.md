...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp112/rout-bgp112.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp112](../clab/rout-bgp112/rout-bgp112.yml) file  
        3. Launch ContainerLab `rout-bgp112.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp112.yml  
        ```
        4. Destroy ContainerLab `rout-bgp112.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp112.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp112.tst` file [here](../tst/rout-bgp112.tst)  
        3. Launch `rout-bgp112.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp112 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp112.tst` test:  
