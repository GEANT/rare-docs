...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp288/rout-bgp288.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp288](../clab/rout-bgp288/rout-bgp288.yml) file  
        3. Launch ContainerLab `rout-bgp288.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp288.yml  
        ```
        4. Destroy ContainerLab `rout-bgp288.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp288.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp288.tst` file [here](../tst/rout-bgp288.tst)  
        3. Launch `rout-bgp288.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp288 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp288.tst` test:  
