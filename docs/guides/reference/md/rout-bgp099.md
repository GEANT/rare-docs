...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp099/rout-bgp099.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp099](../clab/rout-bgp099/rout-bgp099.yml) file  
        3. Launch ContainerLab `rout-bgp099.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp099.yml  
        ```
        4. Destroy ContainerLab `rout-bgp099.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp099.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp099.tst` file [here](../tst/rout-bgp099.tst)  
        3. Launch `rout-bgp099.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp099 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp099.tst` test:  
