...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt087/p4lang-crypt087.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt087](../clab/p4lang-crypt087/p4lang-crypt087.yml) file  
        3. Launch ContainerLab `p4lang-crypt087.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt087.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt087.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt087.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt087.tst` file [here](../tst/p4lang-crypt087.tst)  
        3. Launch `p4lang-crypt087.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt087 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt087.tst` test:  
