# Example: p4lang: l2tp3 routing over ipv6

=== "Topology"

    ![Alt text](../d2/p4lang-rout244/p4lang-rout244.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout244](../clab/p4lang-rout244/p4lang-rout244.yml) file  
        3. Launch ContainerLab `p4lang-rout244.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout244.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout244.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout244.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout244.tst` file [here](../tst/p4lang-rout244.tst)  
        3. Launch `p4lang-rout244.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout244 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout244.tst` test:  
