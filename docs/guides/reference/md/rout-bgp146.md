...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp146/rout-bgp146.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp146](../clab/rout-bgp146/rout-bgp146.yml) file  
        3. Launch ContainerLab `rout-bgp146.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp146.yml  
        ```
        4. Destroy ContainerLab `rout-bgp146.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp146.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp146.tst` file [here](../tst/rout-bgp146.tst)  
        3. Launch `rout-bgp146.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp146 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp146.tst` test:  
