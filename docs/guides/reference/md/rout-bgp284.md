...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp284/rout-bgp284.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp284](../clab/rout-bgp284/rout-bgp284.yml) file  
        3. Launch ContainerLab `rout-bgp284.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp284.yml  
        ```
        4. Destroy ContainerLab `rout-bgp284.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp284.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp284.tst` file [here](../tst/rout-bgp284.tst)  
        3. Launch `rout-bgp284.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp284 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp284.tst` test:  
