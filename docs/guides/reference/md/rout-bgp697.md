# Example: bgp additional path with car

=== "Topology"

    ![Alt text](../d2/rout-bgp697/rout-bgp697.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp697](../clab/rout-bgp697/rout-bgp697.yml) file  
        3. Launch ContainerLab `rout-bgp697.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp697.yml  
        ```
        4. Destroy ContainerLab `rout-bgp697.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp697.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp697.tst` file [here](../tst/rout-bgp697.tst)  
        3. Launch `rout-bgp697.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp697 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp697.tst` test:  
