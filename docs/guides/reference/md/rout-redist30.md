...
=== "Topology"
    ...
    ![Alt text](../d2/rout-redist30/rout-redist30.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist30](../clab/rout-redist30/rout-redist30.yml) file  
        3. Launch ContainerLab `rout-redist30.yml` topology:  

        ```
           containerlab deploy --topo rout-redist30.yml  
        ```
        4. Destroy ContainerLab `rout-redist30.yml` topology:  

        ```
           containerlab destroy --topo rout-redist30.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist30.tst` file [here](../tst/rout-redist30.tst)  
        3. Launch `rout-redist30.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist30 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist30.tst` test:  
