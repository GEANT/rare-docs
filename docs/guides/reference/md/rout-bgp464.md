...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp464/rout-bgp464.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp464](../clab/rout-bgp464/rout-bgp464.yml) file  
        3. Launch ContainerLab `rout-bgp464.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp464.yml  
        ```
        4. Destroy ContainerLab `rout-bgp464.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp464.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp464.tst` file [here](../tst/rout-bgp464.tst)  
        3. Launch `rout-bgp464.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp464 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp464.tst` test:  
