# Example: bgp route server with ctp

=== "Topology"

    ![Alt text](../d2/rout-bgp613/rout-bgp613.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp613](../clab/rout-bgp613/rout-bgp613.yml) file  
        3. Launch ContainerLab `rout-bgp613.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp613.yml  
        ```
        4. Destroy ContainerLab `rout-bgp613.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp613.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp613.tst` file [here](../tst/rout-bgp613.tst)  
        3. Launch `rout-bgp613.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp613 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp613.tst` test:  
