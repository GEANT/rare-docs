...
=== "Topology"
    ...
    ![Alt text](../d2/qos-set06/qos-set06.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [qos-set06](../clab/qos-set06/qos-set06.yml) file  
        3. Launch ContainerLab `qos-set06.yml` topology:  

        ```
           containerlab deploy --topo qos-set06.yml  
        ```
        4. Destroy ContainerLab `qos-set06.yml` topology:  

        ```
           containerlab destroy --topo qos-set06.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `qos-set06.tst` file [here](../tst/qos-set06.tst)  
        3. Launch `qos-set06.tst` test:  

        ```
           java -jar ../../rtr.jar test tester qos-set06 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `qos-set06.tst` test:  
