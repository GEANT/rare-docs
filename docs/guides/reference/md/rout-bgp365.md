...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp365/rout-bgp365.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp365](../clab/rout-bgp365/rout-bgp365.yml) file  
        3. Launch ContainerLab `rout-bgp365.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp365.yml  
        ```
        4. Destroy ContainerLab `rout-bgp365.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp365.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp365.tst` file [here](../tst/rout-bgp365.tst)  
        3. Launch `rout-bgp365.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp365 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp365.tst` test:  
