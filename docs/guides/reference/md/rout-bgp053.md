...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp053/rout-bgp053.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp053](../clab/rout-bgp053/rout-bgp053.yml) file  
        3. Launch ContainerLab `rout-bgp053.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp053.yml  
        ```
        4. Destroy ContainerLab `rout-bgp053.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp053.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp053.tst` file [here](../tst/rout-bgp053.tst)  
        3. Launch `rout-bgp053.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp053 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp053.tst` test:  
