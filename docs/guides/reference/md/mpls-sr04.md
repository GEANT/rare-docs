...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-sr04/mpls-sr04.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-sr04](../clab/mpls-sr04/mpls-sr04.yml) file  
        3. Launch ContainerLab `mpls-sr04.yml` topology:  

        ```
           containerlab deploy --topo mpls-sr04.yml  
        ```
        4. Destroy ContainerLab `mpls-sr04.yml` topology:  

        ```
           containerlab destroy --topo mpls-sr04.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-sr04.tst` file [here](../tst/mpls-sr04.tst)  
        3. Launch `mpls-sr04.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-sr04 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-sr04.tst` test:  
