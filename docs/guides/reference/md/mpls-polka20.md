...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-polka20/mpls-polka20.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-polka20](../clab/mpls-polka20/mpls-polka20.yml) file  
        3. Launch ContainerLab `mpls-polka20.yml` topology:  

        ```
           containerlab deploy --topo mpls-polka20.yml  
        ```
        4. Destroy ContainerLab `mpls-polka20.yml` topology:  

        ```
           containerlab destroy --topo mpls-polka20.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-polka20.tst` file [here](../tst/mpls-polka20.tst)  
        3. Launch `mpls-polka20.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-polka20 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-polka20.tst` test:  
