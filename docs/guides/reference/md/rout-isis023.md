...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis023/rout-isis023.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis023](../clab/rout-isis023/rout-isis023.yml) file  
        3. Launch ContainerLab `rout-isis023.yml` topology:  

        ```
           containerlab deploy --topo rout-isis023.yml  
        ```
        4. Destroy ContainerLab `rout-isis023.yml` topology:  

        ```
           containerlab destroy --topo rout-isis023.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis023.tst` file [here](../tst/rout-isis023.tst)  
        3. Launch `rout-isis023.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis023 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis023.tst` test:  
