...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp390/rout-bgp390.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp390](../clab/rout-bgp390/rout-bgp390.yml) file  
        3. Launch ContainerLab `rout-bgp390.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp390.yml  
        ```
        4. Destroy ContainerLab `rout-bgp390.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp390.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp390.tst` file [here](../tst/rout-bgp390.tst)  
        3. Launch `rout-bgp390.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp390 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp390.tst` test:  
