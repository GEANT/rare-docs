...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp547/rout-bgp547.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp547](../clab/rout-bgp547/rout-bgp547.yml) file  
        3. Launch ContainerLab `rout-bgp547.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp547.yml  
        ```
        4. Destroy ContainerLab `rout-bgp547.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp547.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp547.tst` file [here](../tst/rout-bgp547.tst)  
        3. Launch `rout-bgp547.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp547 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp547.tst` test:  
