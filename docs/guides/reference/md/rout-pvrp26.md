...
=== "Topology"
    ...
    ![Alt text](../d2/rout-pvrp26/rout-pvrp26.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-pvrp26](../clab/rout-pvrp26/rout-pvrp26.yml) file  
        3. Launch ContainerLab `rout-pvrp26.yml` topology:  

        ```
           containerlab deploy --topo rout-pvrp26.yml  
        ```
        4. Destroy ContainerLab `rout-pvrp26.yml` topology:  

        ```
           containerlab destroy --topo rout-pvrp26.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-pvrp26.tst` file [here](../tst/rout-pvrp26.tst)  
        3. Launch `rout-pvrp26.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-pvrp26 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-pvrp26.tst` test:  
