# Example: pvrp with srgb sr

=== "Topology"

    ![Alt text](../d2/rout-pvrp50/rout-pvrp50.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-pvrp50](../clab/rout-pvrp50/rout-pvrp50.yml) file  
        3. Launch ContainerLab `rout-pvrp50.yml` topology:  

        ```
           containerlab deploy --topo rout-pvrp50.yml  
        ```
        4. Destroy ContainerLab `rout-pvrp50.yml` topology:  

        ```
           containerlab destroy --topo rout-pvrp50.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-pvrp50.tst` file [here](../tst/rout-pvrp50.tst)  
        3. Launch `rout-pvrp50.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-pvrp50 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-pvrp50.tst` test:  
