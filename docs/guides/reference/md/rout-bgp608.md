# Example: ebgp with php ctp

=== "Topology"

    ![Alt text](../d2/rout-bgp608/rout-bgp608.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp608](../clab/rout-bgp608/rout-bgp608.yml) file  
        3. Launch ContainerLab `rout-bgp608.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp608.yml  
        ```
        4. Destroy ContainerLab `rout-bgp608.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp608.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp608.tst` file [here](../tst/rout-bgp608.tst)  
        3. Launch `rout-bgp608.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp608 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp608.tst` test:  
