...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp135/rout-bgp135.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp135](../clab/rout-bgp135/rout-bgp135.yml) file  
        3. Launch ContainerLab `rout-bgp135.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp135.yml  
        ```
        4. Destroy ContainerLab `rout-bgp135.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp135.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp135.tst` file [here](../tst/rout-bgp135.tst)  
        3. Launch `rout-bgp135.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp135 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp135.tst` test:  
