...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis057/rout-isis057.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis057](../clab/rout-isis057/rout-isis057.yml) file  
        3. Launch ContainerLab `rout-isis057.yml` topology:  

        ```
           containerlab deploy --topo rout-isis057.yml  
        ```
        4. Destroy ContainerLab `rout-isis057.yml` topology:  

        ```
           containerlab destroy --topo rout-isis057.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis057.tst` file [here](../tst/rout-isis057.tst)  
        3. Launch `rout-isis057.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis057 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis057.tst` test:  
