...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp087/rout-bgp087.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp087](../clab/rout-bgp087/rout-bgp087.yml) file  
        3. Launch ContainerLab `rout-bgp087.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp087.yml  
        ```
        4. Destroy ContainerLab `rout-bgp087.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp087.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp087.tst` file [here](../tst/rout-bgp087.tst)  
        3. Launch `rout-bgp087.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp087 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp087.tst` test:  
