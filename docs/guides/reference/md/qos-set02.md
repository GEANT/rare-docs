...
=== "Topology"
    ...
    ![Alt text](../d2/qos-set02/qos-set02.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [qos-set02](../clab/qos-set02/qos-set02.yml) file  
        3. Launch ContainerLab `qos-set02.yml` topology:  

        ```
           containerlab deploy --topo qos-set02.yml  
        ```
        4. Destroy ContainerLab `qos-set02.yml` topology:  

        ```
           containerlab destroy --topo qos-set02.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `qos-set02.tst` file [here](../tst/qos-set02.tst)  
        3. Launch `qos-set02.tst` test:  

        ```
           java -jar ../../rtr.jar test tester qos-set02 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `qos-set02.tst` test:  
