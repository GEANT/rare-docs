...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp153/rout-bgp153.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp153](../clab/rout-bgp153/rout-bgp153.yml) file  
        3. Launch ContainerLab `rout-bgp153.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp153.yml  
        ```
        4. Destroy ContainerLab `rout-bgp153.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp153.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp153.tst` file [here](../tst/rout-bgp153.tst)  
        3. Launch `rout-bgp153.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp153 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp153.tst` test:  
