# Example: p4lang: multilink l2tp mpls over vlan

=== "Topology"

    ![Alt text](../d2/p4lang-rout234/p4lang-rout234.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout234](../clab/p4lang-rout234/p4lang-rout234.yml) file  
        3. Launch ContainerLab `p4lang-rout234.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout234.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout234.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout234.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout234.tst` file [here](../tst/p4lang-rout234.tst)  
        3. Launch `p4lang-rout234.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout234 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout234.tst` test:  
