...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt065/p4lang-crypt065.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt065](../clab/p4lang-crypt065/p4lang-crypt065.yml) file  
        3. Launch ContainerLab `p4lang-crypt065.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt065.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt065.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt065.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt065.tst` file [here](../tst/p4lang-crypt065.tst)  
        3. Launch `p4lang-crypt065.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt065 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt065.tst` test:  
