...
=== "Topology"
    ...
    ![Alt text](../d2/rout-babel01/rout-babel01.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-babel01](../clab/rout-babel01/rout-babel01.yml) file  
        3. Launch ContainerLab `rout-babel01.yml` topology:  

        ```
           containerlab deploy --topo rout-babel01.yml  
        ```
        4. Destroy ContainerLab `rout-babel01.yml` topology:  

        ```
           containerlab destroy --topo rout-babel01.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-babel01.tst` file [here](../tst/rout-babel01.tst)  
        3. Launch `rout-babel01.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-babel01 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-babel01.tst` test:  
