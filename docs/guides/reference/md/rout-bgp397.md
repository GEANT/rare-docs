...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp397/rout-bgp397.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp397](../clab/rout-bgp397/rout-bgp397.yml) file  
        3. Launch ContainerLab `rout-bgp397.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp397.yml  
        ```
        4. Destroy ContainerLab `rout-bgp397.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp397.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp397.tst` file [here](../tst/rout-bgp397.tst)  
        3. Launch `rout-bgp397.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp397 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp397.tst` test:  
