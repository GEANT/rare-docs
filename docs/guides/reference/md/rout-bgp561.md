...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp561/rout-bgp561.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp561](../clab/rout-bgp561/rout-bgp561.yml) file  
        3. Launch ContainerLab `rout-bgp561.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp561.yml  
        ```
        4. Destroy ContainerLab `rout-bgp561.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp561.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp561.tst` file [here](../tst/rout-bgp561.tst)  
        3. Launch `rout-bgp561.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp561 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp561.tst` test:  
