...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf07/rout-ospf07.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf07](../clab/rout-ospf07/rout-ospf07.yml) file  
        3. Launch ContainerLab `rout-ospf07.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf07.yml  
        ```
        4. Destroy ContainerLab `rout-ospf07.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf07.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf07.tst` file [here](../tst/rout-ospf07.tst)  
        3. Launch `rout-ospf07.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf07 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf07.tst` test:  
