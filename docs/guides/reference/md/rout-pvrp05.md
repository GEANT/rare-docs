...
=== "Topology"
    ...
    ![Alt text](../d2/rout-pvrp05/rout-pvrp05.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-pvrp05](../clab/rout-pvrp05/rout-pvrp05.yml) file  
        3. Launch ContainerLab `rout-pvrp05.yml` topology:  

        ```
           containerlab deploy --topo rout-pvrp05.yml  
        ```
        4. Destroy ContainerLab `rout-pvrp05.yml` topology:  

        ```
           containerlab destroy --topo rout-pvrp05.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-pvrp05.tst` file [here](../tst/rout-pvrp05.tst)  
        3. Launch `rout-pvrp05.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-pvrp05 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-pvrp05.tst` test:  
