...
=== "Topology"
    ...
    ![Alt text](../d2/rout-olsr10/rout-olsr10.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-olsr10](../clab/rout-olsr10/rout-olsr10.yml) file  
        3. Launch ContainerLab `rout-olsr10.yml` topology:  

        ```
           containerlab deploy --topo rout-olsr10.yml  
        ```
        4. Destroy ContainerLab `rout-olsr10.yml` topology:  

        ```
           containerlab destroy --topo rout-olsr10.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-olsr10.tst` file [here](../tst/rout-olsr10.tst)  
        3. Launch `rout-olsr10.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-olsr10 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-olsr10.tst` test:  
