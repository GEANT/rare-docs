# Example: other ctp colors over bgp route server

=== "Topology"

    ![Alt text](../d2/rout-bgp679/rout-bgp679.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp679](../clab/rout-bgp679/rout-bgp679.yml) file  
        3. Launch ContainerLab `rout-bgp679.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp679.yml  
        ```
        4. Destroy ContainerLab `rout-bgp679.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp679.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp679.tst` file [here](../tst/rout-bgp679.tst)  
        3. Launch `rout-bgp679.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp679 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp679.tst` test:  
