# Example: l3evpns ingress route filtering with routepolicy

=== "Topology"

    ![Alt text](../d2/rout-bgp836/rout-bgp836.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp836](../clab/rout-bgp836/rout-bgp836.yml) file  
        3. Launch ContainerLab `rout-bgp836.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp836.yml  
        ```
        4. Destroy ContainerLab `rout-bgp836.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp836.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp836.tst` file [here](../tst/rout-bgp836.tst)  
        3. Launch `rout-bgp836.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp836 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp836.tst` test:  
