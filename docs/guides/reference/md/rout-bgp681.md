# Example: other ctp colors over bgp with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp681/rout-bgp681.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp681](../clab/rout-bgp681/rout-bgp681.yml) file  
        3. Launch ContainerLab `rout-bgp681.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp681.yml  
        ```
        4. Destroy ContainerLab `rout-bgp681.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp681.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp681.tst` file [here](../tst/rout-bgp681.tst)  
        3. Launch `rout-bgp681.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp681 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp681.tst` test:  
