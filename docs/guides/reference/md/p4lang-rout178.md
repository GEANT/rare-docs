...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout178/p4lang-rout178.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout178](../clab/p4lang-rout178/p4lang-rout178.yml) file  
        3. Launch ContainerLab `p4lang-rout178.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout178.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout178.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout178.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout178.tst` file [here](../tst/p4lang-rout178.tst)  
        3. Launch `p4lang-rout178.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout178 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout178.tst` test:  
