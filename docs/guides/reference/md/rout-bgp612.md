# Example: confed bgp with ctp

=== "Topology"

    ![Alt text](../d2/rout-bgp612/rout-bgp612.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp612](../clab/rout-bgp612/rout-bgp612.yml) file  
        3. Launch ContainerLab `rout-bgp612.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp612.yml  
        ```
        4. Destroy ContainerLab `rout-bgp612.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp612.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp612.tst` file [here](../tst/rout-bgp612.tst)  
        3. Launch `rout-bgp612.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp612 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp612.tst` test:  
