...
=== "Topology"
    ...
    ![Alt text](../d2/serv-sdwan05/serv-sdwan05.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [serv-sdwan05](../clab/serv-sdwan05/serv-sdwan05.yml) file  
        3. Launch ContainerLab `serv-sdwan05.yml` topology:  

        ```
           containerlab deploy --topo serv-sdwan05.yml  
        ```
        4. Destroy ContainerLab `serv-sdwan05.yml` topology:  

        ```
           containerlab destroy --topo serv-sdwan05.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `serv-sdwan05.tst` file [here](../tst/serv-sdwan05.tst)  
        3. Launch `serv-sdwan05.tst` test:  

        ```
           java -jar ../../rtr.jar test tester serv-sdwan05 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `serv-sdwan05.tst` test:  
