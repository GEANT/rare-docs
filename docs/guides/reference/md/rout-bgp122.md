...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp122/rout-bgp122.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp122](../clab/rout-bgp122/rout-bgp122.yml) file  
        3. Launch ContainerLab `rout-bgp122.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp122.yml  
        ```
        4. Destroy ContainerLab `rout-bgp122.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp122.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp122.tst` file [here](../tst/rout-bgp122.tst)  
        3. Launch `rout-bgp122.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp122 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp122.tst` test:  
