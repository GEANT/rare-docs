# Example: unicast+vpns over ibgp with dynamic capability

=== "Topology"

    ![Alt text](../d2/rout-bgp777/rout-bgp777.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp777](../clab/rout-bgp777/rout-bgp777.yml) file  
        3. Launch ContainerLab `rout-bgp777.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp777.yml  
        ```
        4. Destroy ContainerLab `rout-bgp777.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp777.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp777.tst` file [here](../tst/rout-bgp777.tst)  
        3. Launch `rout-bgp777.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp777 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp777.tst` test:  
