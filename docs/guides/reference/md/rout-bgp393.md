...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp393/rout-bgp393.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp393](../clab/rout-bgp393/rout-bgp393.yml) file  
        3. Launch ContainerLab `rout-bgp393.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp393.yml  
        ```
        4. Destroy ContainerLab `rout-bgp393.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp393.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp393.tst` file [here](../tst/rout-bgp393.tst)  
        3. Launch `rout-bgp393.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp393 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp393.tst` test:  
