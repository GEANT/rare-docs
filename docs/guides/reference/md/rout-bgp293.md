...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp293/rout-bgp293.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp293](../clab/rout-bgp293/rout-bgp293.yml) file  
        3. Launch ContainerLab `rout-bgp293.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp293.yml  
        ```
        4. Destroy ContainerLab `rout-bgp293.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp293.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp293.tst` file [here](../tst/rout-bgp293.tst)  
        3. Launch `rout-bgp293.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp293 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp293.tst` test:  
