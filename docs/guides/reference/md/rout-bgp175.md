...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp175/rout-bgp175.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp175](../clab/rout-bgp175/rout-bgp175.yml) file  
        3. Launch ContainerLab `rout-bgp175.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp175.yml  
        ```
        4. Destroy ContainerLab `rout-bgp175.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp175.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp175.tst` file [here](../tst/rout-bgp175.tst)  
        3. Launch `rout-bgp175.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp175 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp175.tst` test:  
