...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp221/rout-bgp221.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp221](../clab/rout-bgp221/rout-bgp221.yml) file  
        3. Launch ContainerLab `rout-bgp221.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp221.yml  
        ```
        4. Destroy ContainerLab `rout-bgp221.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp221.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp221.tst` file [here](../tst/rout-bgp221.tst)  
        3. Launch `rout-bgp221.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp221 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp221.tst` test:  
