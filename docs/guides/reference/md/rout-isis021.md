...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis021/rout-isis021.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis021](../clab/rout-isis021/rout-isis021.yml) file  
        3. Launch ContainerLab `rout-isis021.yml` topology:  

        ```
           containerlab deploy --topo rout-isis021.yml  
        ```
        4. Destroy ContainerLab `rout-isis021.yml` topology:  

        ```
           containerlab destroy --topo rout-isis021.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis021.tst` file [here](../tst/rout-isis021.tst)  
        3. Launch `rout-isis021.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis021 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis021.tst` test:  
