...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp197/rout-bgp197.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp197](../clab/rout-bgp197/rout-bgp197.yml) file  
        3. Launch ContainerLab `rout-bgp197.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp197.yml  
        ```
        4. Destroy ContainerLab `rout-bgp197.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp197.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp197.tst` file [here](../tst/rout-bgp197.tst)  
        3. Launch `rout-bgp197.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp197 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp197.tst` test:  
