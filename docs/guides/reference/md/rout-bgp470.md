...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp470/rout-bgp470.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp470](../clab/rout-bgp470/rout-bgp470.yml) file  
        3. Launch ContainerLab `rout-bgp470.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp470.yml  
        ```
        4. Destroy ContainerLab `rout-bgp470.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp470.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp470.tst` file [here](../tst/rout-bgp470.tst)  
        3. Launch `rout-bgp470.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp470 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp470.tst` test:  
