...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp511/rout-bgp511.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp511](../clab/rout-bgp511/rout-bgp511.yml) file  
        3. Launch ContainerLab `rout-bgp511.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp511.yml  
        ```
        4. Destroy ContainerLab `rout-bgp511.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp511.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp511.tst` file [here](../tst/rout-bgp511.tst)  
        3. Launch `rout-bgp511.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp511 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp511.tst` test:  
