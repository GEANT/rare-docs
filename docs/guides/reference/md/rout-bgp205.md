...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp205/rout-bgp205.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp205](../clab/rout-bgp205/rout-bgp205.yml) file  
        3. Launch ContainerLab `rout-bgp205.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp205.yml  
        ```
        4. Destroy ContainerLab `rout-bgp205.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp205.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp205.tst` file [here](../tst/rout-bgp205.tst)  
        3. Launch `rout-bgp205.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp205 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp205.tst` test:  
