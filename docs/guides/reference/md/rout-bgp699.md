# Example: ibgp with php car

=== "Topology"

    ![Alt text](../d2/rout-bgp699/rout-bgp699.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp699](../clab/rout-bgp699/rout-bgp699.yml) file  
        3. Launch ContainerLab `rout-bgp699.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp699.yml  
        ```
        4. Destroy ContainerLab `rout-bgp699.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp699.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp699.tst` file [here](../tst/rout-bgp699.tst)  
        3. Launch `rout-bgp699.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp699 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp699.tst` test:  
