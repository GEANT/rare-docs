...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-bier10/mpls-bier10.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-bier10](../clab/mpls-bier10/mpls-bier10.yml) file  
        3. Launch ContainerLab `mpls-bier10.yml` topology:  

        ```
           containerlab deploy --topo mpls-bier10.yml  
        ```
        4. Destroy ContainerLab `mpls-bier10.yml` topology:  

        ```
           containerlab destroy --topo mpls-bier10.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-bier10.tst` file [here](../tst/mpls-bier10.tst)  
        3. Launch `mpls-bier10.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-bier10 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-bier10.tst` test:  
