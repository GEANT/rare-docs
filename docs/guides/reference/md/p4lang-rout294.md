# Example: p4lang: tmux routing over bridge

=== "Topology"

    ![Alt text](../d2/p4lang-rout294/p4lang-rout294.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout294](../clab/p4lang-rout294/p4lang-rout294.yml) file  
        3. Launch ContainerLab `p4lang-rout294.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout294.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout294.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout294.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout294.tst` file [here](../tst/p4lang-rout294.tst)  
        3. Launch `p4lang-rout294.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout294 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout294.tst` test:  
