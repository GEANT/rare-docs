...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rip19/rout-rip19.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rip19](../clab/rout-rip19/rout-rip19.yml) file  
        3. Launch ContainerLab `rout-rip19.yml` topology:  

        ```
           containerlab deploy --topo rout-rip19.yml  
        ```
        4. Destroy ContainerLab `rout-rip19.yml` topology:  

        ```
           containerlab destroy --topo rout-rip19.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rip19.tst` file [here](../tst/rout-rip19.tst)  
        3. Launch `rout-rip19.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rip19 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rip19.tst` test:  
