...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp405/rout-bgp405.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp405](../clab/rout-bgp405/rout-bgp405.yml) file  
        3. Launch ContainerLab `rout-bgp405.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp405.yml  
        ```
        4. Destroy ContainerLab `rout-bgp405.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp405.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp405.tst` file [here](../tst/rout-bgp405.tst)  
        3. Launch `rout-bgp405.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp405 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp405.tst` test:  
