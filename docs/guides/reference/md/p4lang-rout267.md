# Example: p4lang: multilink l2tp3 mpls over bundle

=== "Topology"

    ![Alt text](../d2/p4lang-rout267/p4lang-rout267.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout267](../clab/p4lang-rout267/p4lang-rout267.yml) file  
        3. Launch ContainerLab `p4lang-rout267.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout267.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout267.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout267.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout267.tst` file [here](../tst/p4lang-rout267.tst)  
        3. Launch `p4lang-rout267.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout267 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout267.tst` test:  
