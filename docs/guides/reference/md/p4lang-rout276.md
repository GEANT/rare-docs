# Example: p4lang: sdwan over ipv6 with l2tp

=== "Topology"

    ![Alt text](../d2/p4lang-rout276/p4lang-rout276.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout276](../clab/p4lang-rout276/p4lang-rout276.yml) file  
        3. Launch ContainerLab `p4lang-rout276.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout276.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout276.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout276.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout276.tst` file [here](../tst/p4lang-rout276.tst)  
        3. Launch `p4lang-rout276.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout276 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout276.tst` test:  
