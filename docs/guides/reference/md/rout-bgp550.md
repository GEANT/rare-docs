...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp550/rout-bgp550.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp550](../clab/rout-bgp550/rout-bgp550.yml) file  
        3. Launch ContainerLab `rout-bgp550.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp550.yml  
        ```
        4. Destroy ContainerLab `rout-bgp550.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp550.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp550.tst` file [here](../tst/rout-bgp550.tst)  
        3. Launch `rout-bgp550.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp550 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp550.tst` test:  
