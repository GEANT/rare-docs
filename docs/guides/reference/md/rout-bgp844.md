# Example: otherl3evpns ingress route filtering with routepolicy

=== "Topology"

    ![Alt text](../d2/rout-bgp844/rout-bgp844.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp844](../clab/rout-bgp844/rout-bgp844.yml) file  
        3. Launch ContainerLab `rout-bgp844.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp844.yml  
        ```
        4. Destroy ContainerLab `rout-bgp844.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp844.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp844.tst` file [here](../tst/rout-bgp844.tst)  
        3. Launch `rout-bgp844.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp844 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp844.tst` test:  
