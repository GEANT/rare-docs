...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp508/rout-bgp508.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp508](../clab/rout-bgp508/rout-bgp508.yml) file  
        3. Launch ContainerLab `rout-bgp508.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp508.yml  
        ```
        4. Destroy ContainerLab `rout-bgp508.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp508.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp508.tst` file [here](../tst/rout-bgp508.tst)  
        3. Launch `rout-bgp508.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp508 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp508.tst` test:  
