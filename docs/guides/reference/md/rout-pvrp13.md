...
=== "Topology"
    ...
    ![Alt text](../d2/rout-pvrp13/rout-pvrp13.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-pvrp13](../clab/rout-pvrp13/rout-pvrp13.yml) file  
        3. Launch ContainerLab `rout-pvrp13.yml` topology:  

        ```
           containerlab deploy --topo rout-pvrp13.yml  
        ```
        4. Destroy ContainerLab `rout-pvrp13.yml` topology:  

        ```
           containerlab destroy --topo rout-pvrp13.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-pvrp13.tst` file [here](../tst/rout-pvrp13.tst)  
        3. Launch `rout-pvrp13.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-pvrp13 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-pvrp13.tst` test:  
