...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp219/rout-bgp219.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp219](../clab/rout-bgp219/rout-bgp219.yml) file  
        3. Launch ContainerLab `rout-bgp219.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp219.yml  
        ```
        4. Destroy ContainerLab `rout-bgp219.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp219.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp219.tst` file [here](../tst/rout-bgp219.tst)  
        3. Launch `rout-bgp219.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp219 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp219.tst` test:  
