...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp578/rout-bgp578.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp578](../clab/rout-bgp578/rout-bgp578.yml) file  
        3. Launch ContainerLab `rout-bgp578.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp578.yml  
        ```
        4. Destroy ContainerLab `rout-bgp578.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp578.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp578.tst` file [here](../tst/rout-bgp578.tst)  
        3. Launch `rout-bgp578.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp578 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp578.tst` test:  
