...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis079/rout-isis079.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis079](../clab/rout-isis079/rout-isis079.yml) file  
        3. Launch ContainerLab `rout-isis079.yml` topology:  

        ```
           containerlab deploy --topo rout-isis079.yml  
        ```
        4. Destroy ContainerLab `rout-isis079.yml` topology:  

        ```
           containerlab destroy --topo rout-isis079.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis079.tst` file [here](../tst/rout-isis079.tst)  
        3. Launch `rout-isis079.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis079 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis079.tst` test:  
