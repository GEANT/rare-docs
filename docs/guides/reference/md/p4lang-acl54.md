...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-acl54/p4lang-acl54.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl54](../clab/p4lang-acl54/p4lang-acl54.yml) file  
        3. Launch ContainerLab `p4lang-acl54.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl54.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl54.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl54.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl54.tst` file [here](../tst/p4lang-acl54.tst)  
        3. Launch `p4lang-acl54.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl54 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl54.tst` test:  
