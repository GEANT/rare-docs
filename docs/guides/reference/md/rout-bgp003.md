...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp003/rout-bgp003.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp003](../clab/rout-bgp003/rout-bgp003.yml) file  
        3. Launch ContainerLab `rout-bgp003.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp003.yml  
        ```
        4. Destroy ContainerLab `rout-bgp003.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp003.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp003.tst` file [here](../tst/rout-bgp003.tst)  
        3. Launch `rout-bgp003.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp003 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp003.tst` test:  
