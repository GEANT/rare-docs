...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp035/rout-bgp035.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp035](../clab/rout-bgp035/rout-bgp035.yml) file  
        3. Launch ContainerLab `rout-bgp035.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp035.yml  
        ```
        4. Destroy ContainerLab `rout-bgp035.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp035.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp035.tst` file [here](../tst/rout-bgp035.tst)  
        3. Launch `rout-bgp035.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp035 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp035.tst` test:  
