# Example: sdwan with l2tp2 and tmux

=== "Topology"

    ![Alt text](../d2/serv-sdwan11/serv-sdwan11.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [serv-sdwan11](../clab/serv-sdwan11/serv-sdwan11.yml) file  
        3. Launch ContainerLab `serv-sdwan11.yml` topology:  

        ```
           containerlab deploy --topo serv-sdwan11.yml  
        ```
        4. Destroy ContainerLab `serv-sdwan11.yml` topology:  

        ```
           containerlab destroy --topo serv-sdwan11.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `serv-sdwan11.tst` file [here](../tst/serv-sdwan11.tst)  
        3. Launch `serv-sdwan11.tst` test:  

        ```
           java -jar ../../rtr.jar test tester serv-sdwan11 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `serv-sdwan11.tst` test:  
