...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp071/rout-bgp071.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp071](../clab/rout-bgp071/rout-bgp071.yml) file  
        3. Launch ContainerLab `rout-bgp071.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp071.yml  
        ```
        4. Destroy ContainerLab `rout-bgp071.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp071.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp071.tst` file [here](../tst/rout-bgp071.tst)  
        3. Launch `rout-bgp071.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp071 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp071.tst` test:  
