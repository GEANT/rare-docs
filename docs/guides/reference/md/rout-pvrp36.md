...
=== "Topology"
    ...
    ![Alt text](../d2/rout-pvrp36/rout-pvrp36.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-pvrp36](../clab/rout-pvrp36/rout-pvrp36.yml) file  
        3. Launch ContainerLab `rout-pvrp36.yml` topology:  

        ```
           containerlab deploy --topo rout-pvrp36.yml  
        ```
        4. Destroy ContainerLab `rout-pvrp36.yml` topology:  

        ```
           containerlab destroy --topo rout-pvrp36.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-pvrp36.tst` file [here](../tst/rout-pvrp36.tst)  
        3. Launch `rout-pvrp36.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-pvrp36 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-pvrp36.tst` test:  
