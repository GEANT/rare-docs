...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp113/rout-bgp113.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp113](../clab/rout-bgp113/rout-bgp113.yml) file  
        3. Launch ContainerLab `rout-bgp113.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp113.yml  
        ```
        4. Destroy ContainerLab `rout-bgp113.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp113.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp113.tst` file [here](../tst/rout-bgp113.tst)  
        3. Launch `rout-bgp113.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp113 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp113.tst` test:  
