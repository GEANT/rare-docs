# Example: ocar bgp change in metric

=== "Topology"

    ![Alt text](../d2/rout-bgp750/rout-bgp750.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp750](../clab/rout-bgp750/rout-bgp750.yml) file  
        3. Launch ContainerLab `rout-bgp750.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp750.yml  
        ```
        4. Destroy ContainerLab `rout-bgp750.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp750.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp750.tst` file [here](../tst/rout-bgp750.tst)  
        3. Launch `rout-bgp750.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp750 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp750.tst` test:  
