...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp088/rout-bgp088.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp088](../clab/rout-bgp088/rout-bgp088.yml) file  
        3. Launch ContainerLab `rout-bgp088.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp088.yml  
        ```
        4. Destroy ContainerLab `rout-bgp088.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp088.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp088.tst` file [here](../tst/rout-bgp088.tst)  
        3. Launch `rout-bgp088.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp088 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp088.tst` test:  
