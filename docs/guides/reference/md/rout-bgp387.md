...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp387/rout-bgp387.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp387](../clab/rout-bgp387/rout-bgp387.yml) file  
        3. Launch ContainerLab `rout-bgp387.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp387.yml  
        ```
        4. Destroy ContainerLab `rout-bgp387.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp387.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp387.tst` file [here](../tst/rout-bgp387.tst)  
        3. Launch `rout-bgp387.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp387 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp387.tst` test:  
