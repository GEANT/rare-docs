...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp520/rout-bgp520.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp520](../clab/rout-bgp520/rout-bgp520.yml) file  
        3. Launch ContainerLab `rout-bgp520.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp520.yml  
        ```
        4. Destroy ContainerLab `rout-bgp520.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp520.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp520.tst` file [here](../tst/rout-bgp520.tst)  
        3. Launch `rout-bgp520.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp520 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp520.tst` test:  
