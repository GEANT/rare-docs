...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf23/rout-ospf23.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf23](../clab/rout-ospf23/rout-ospf23.yml) file  
        3. Launch ContainerLab `rout-ospf23.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf23.yml  
        ```
        4. Destroy ContainerLab `rout-ospf23.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf23.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf23.tst` file [here](../tst/rout-ospf23.tst)  
        3. Launch `rout-ospf23.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf23 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf23.tst` test:  
