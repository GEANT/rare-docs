...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp34/rout-lsrp34.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp34](../clab/rout-lsrp34/rout-lsrp34.yml) file  
        3. Launch ContainerLab `rout-lsrp34.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp34.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp34.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp34.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp34.tst` file [here](../tst/rout-lsrp34.tst)  
        3. Launch `rout-lsrp34.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp34 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp34.tst` test:  
