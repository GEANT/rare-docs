...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp144/rout-bgp144.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp144](../clab/rout-bgp144/rout-bgp144.yml) file  
        3. Launch ContainerLab `rout-bgp144.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp144.yml  
        ```
        4. Destroy ContainerLab `rout-bgp144.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp144.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp144.tst` file [here](../tst/rout-bgp144.tst)  
        3. Launch `rout-bgp144.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp144 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp144.tst` test:  
