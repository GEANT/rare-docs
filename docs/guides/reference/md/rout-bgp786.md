# Example: bgp routepolicy filtering with validity

=== "Topology"

    ![Alt text](../d2/rout-bgp786/rout-bgp786.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp786](../clab/rout-bgp786/rout-bgp786.yml) file  
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp786.tst` file [here](../tst/rout-bgp786.tst)  
