...
=== "Topology"
    ...
    ![Alt text](../d2/rout-eigrp07/rout-eigrp07.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-eigrp07](../clab/rout-eigrp07/rout-eigrp07.yml) file  
        3. Launch ContainerLab `rout-eigrp07.yml` topology:  

        ```
           containerlab deploy --topo rout-eigrp07.yml  
        ```
        4. Destroy ContainerLab `rout-eigrp07.yml` topology:  

        ```
           containerlab destroy --topo rout-eigrp07.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-eigrp07.tst` file [here](../tst/rout-eigrp07.tst)  
        3. Launch `rout-eigrp07.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-eigrp07 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-eigrp07.tst` test:  
