...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp558/rout-bgp558.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp558](../clab/rout-bgp558/rout-bgp558.yml) file  
        3. Launch ContainerLab `rout-bgp558.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp558.yml  
        ```
        4. Destroy ContainerLab `rout-bgp558.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp558.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp558.tst` file [here](../tst/rout-bgp558.tst)  
        3. Launch `rout-bgp558.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp558 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp558.tst` test:  
