...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-bier13/mpls-bier13.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-bier13](../clab/mpls-bier13/mpls-bier13.yml) file  
        3. Launch ContainerLab `mpls-bier13.yml` topology:  

        ```
           containerlab deploy --topo mpls-bier13.yml  
        ```
        4. Destroy ContainerLab `mpls-bier13.yml` topology:  

        ```
           containerlab destroy --topo mpls-bier13.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-bier13.tst` file [here](../tst/mpls-bier13.tst)  
        3. Launch `mpls-bier13.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-bier13 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-bier13.tst` test:  
