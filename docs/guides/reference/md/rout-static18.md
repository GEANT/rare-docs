...
=== "Topology"
    ...
    ![Alt text](../d2/rout-static18/rout-static18.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-static18](../clab/rout-static18/rout-static18.yml) file  
        3. Launch ContainerLab `rout-static18.yml` topology:  

        ```
           containerlab deploy --topo rout-static18.yml  
        ```
        4. Destroy ContainerLab `rout-static18.yml` topology:  

        ```
           containerlab destroy --topo rout-static18.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-static18.tst` file [here](../tst/rout-static18.tst)  
        3. Launch `rout-static18.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-static18 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-static18.tst` test:  
