...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rift08/rout-rift08.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rift08](../clab/rout-rift08/rout-rift08.yml) file  
        3. Launch ContainerLab `rout-rift08.yml` topology:  

        ```
           containerlab deploy --topo rout-rift08.yml  
        ```
        4. Destroy ContainerLab `rout-rift08.yml` topology:  

        ```
           containerlab destroy --topo rout-rift08.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rift08.tst` file [here](../tst/rout-rift08.tst)  
        3. Launch `rout-rift08.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rift08 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rift08.tst` test:  
