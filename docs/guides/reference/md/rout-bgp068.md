...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp068/rout-bgp068.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp068](../clab/rout-bgp068/rout-bgp068.yml) file  
        3. Launch ContainerLab `rout-bgp068.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp068.yml  
        ```
        4. Destroy ContainerLab `rout-bgp068.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp068.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp068.tst` file [here](../tst/rout-bgp068.tst)  
        3. Launch `rout-bgp068.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp068 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp068.tst` test:  
