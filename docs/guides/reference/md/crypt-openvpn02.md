...
=== "Topology"
    ...
    ![Alt text](../d2/crypt-openvpn02/crypt-openvpn02.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [crypt-openvpn02](../clab/crypt-openvpn02/crypt-openvpn02.yml) file  
        3. Launch ContainerLab `crypt-openvpn02.yml` topology:  

        ```
           containerlab deploy --topo crypt-openvpn02.yml  
        ```
        4. Destroy ContainerLab `crypt-openvpn02.yml` topology:  

        ```
           containerlab destroy --topo crypt-openvpn02.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `crypt-openvpn02.tst` file [here](../tst/crypt-openvpn02.tst)  
        3. Launch `crypt-openvpn02.tst` test:  

        ```
           java -jar ../../rtr.jar test tester crypt-openvpn02 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `crypt-openvpn02.tst` test:  
