...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp452/rout-bgp452.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp452](../clab/rout-bgp452/rout-bgp452.yml) file  
        3. Launch ContainerLab `rout-bgp452.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp452.yml  
        ```
        4. Destroy ContainerLab `rout-bgp452.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp452.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp452.tst` file [here](../tst/rout-bgp452.tst)  
        3. Launch `rout-bgp452.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp452 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp452.tst` test:  
