# Example: bgp with ctp over sr

=== "Topology"

    ![Alt text](../d2/mpls-sr14/mpls-sr14.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-sr14](../clab/mpls-sr14/mpls-sr14.yml) file  
        3. Launch ContainerLab `mpls-sr14.yml` topology:  

        ```
           containerlab deploy --topo mpls-sr14.yml  
        ```
        4. Destroy ContainerLab `mpls-sr14.yml` topology:  

        ```
           containerlab destroy --topo mpls-sr14.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-sr14.tst` file [here](../tst/mpls-sr14.tst)  
        3. Launch `mpls-sr14.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-sr14 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-sr14.tst` test:  
