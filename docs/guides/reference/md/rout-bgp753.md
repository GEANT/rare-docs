# Example: ocar ibgp fullmesh prefix withdraw

=== "Topology"

    ![Alt text](../d2/rout-bgp753/rout-bgp753.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp753](../clab/rout-bgp753/rout-bgp753.yml) file  
        3. Launch ContainerLab `rout-bgp753.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp753.yml  
        ```
        4. Destroy ContainerLab `rout-bgp753.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp753.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp753.tst` file [here](../tst/rout-bgp753.tst)  
        3. Launch `rout-bgp753.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp753 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp753.tst` test:  
