# Example: p4lang: tmux mpls push

=== "Topology"

    ![Alt text](../d2/p4lang-rout312/p4lang-rout312.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout312](../clab/p4lang-rout312/p4lang-rout312.yml) file  
        3. Launch ContainerLab `p4lang-rout312.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout312.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout312.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout312.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout312.tst` file [here](../tst/p4lang-rout312.tst)  
        3. Launch `p4lang-rout312.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout312 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout312.tst` test:  
