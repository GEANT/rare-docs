# Example: p4lang: tmux routing over bundle

=== "Topology"

    ![Alt text](../d2/p4lang-rout290/p4lang-rout290.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout290](../clab/p4lang-rout290/p4lang-rout290.yml) file  
        3. Launch ContainerLab `p4lang-rout290.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout290.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout290.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout290.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout290.tst` file [here](../tst/p4lang-rout290.tst)  
        3. Launch `p4lang-rout290.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout290 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout290.tst` test:  
