...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-bier06/mpls-bier06.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-bier06](../clab/mpls-bier06/mpls-bier06.yml) file  
        3. Launch ContainerLab `mpls-bier06.yml` topology:  

        ```
           containerlab deploy --topo mpls-bier06.yml  
        ```
        4. Destroy ContainerLab `mpls-bier06.yml` topology:  

        ```
           containerlab destroy --topo mpls-bier06.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-bier06.tst` file [here](../tst/mpls-bier06.tst)  
        3. Launch `mpls-bier06.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-bier06 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-bier06.tst` test:  
