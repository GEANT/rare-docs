...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp384/rout-bgp384.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp384](../clab/rout-bgp384/rout-bgp384.yml) file  
        3. Launch ContainerLab `rout-bgp384.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp384.yml  
        ```
        4. Destroy ContainerLab `rout-bgp384.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp384.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp384.tst` file [here](../tst/rout-bgp384.tst)  
        3. Launch `rout-bgp384.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp384 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp384.tst` test:  
