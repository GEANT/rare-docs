...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp562/rout-bgp562.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp562](../clab/rout-bgp562/rout-bgp562.yml) file  
        3. Launch ContainerLab `rout-bgp562.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp562.yml  
        ```
        4. Destroy ContainerLab `rout-bgp562.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp562.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp562.tst` file [here](../tst/rout-bgp562.tst)  
        3. Launch `rout-bgp562.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp562 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp562.tst` test:  
