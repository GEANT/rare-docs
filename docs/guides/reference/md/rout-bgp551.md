...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp551/rout-bgp551.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp551](../clab/rout-bgp551/rout-bgp551.yml) file  
        3. Launch ContainerLab `rout-bgp551.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp551.yml  
        ```
        4. Destroy ContainerLab `rout-bgp551.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp551.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp551.tst` file [here](../tst/rout-bgp551.tst)  
        3. Launch `rout-bgp551.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp551 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp551.tst` test:  
