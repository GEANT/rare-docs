...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp105/rout-bgp105.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp105](../clab/rout-bgp105/rout-bgp105.yml) file  
        3. Launch ContainerLab `rout-bgp105.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp105.yml  
        ```
        4. Destroy ContainerLab `rout-bgp105.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp105.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp105.tst` file [here](../tst/rout-bgp105.tst)  
        3. Launch `rout-bgp105.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp105 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp105.tst` test:  
