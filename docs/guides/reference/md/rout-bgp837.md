# Example: l3evpns egress route filtering with routepolicy

=== "Topology"

    ![Alt text](../d2/rout-bgp837/rout-bgp837.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp837](../clab/rout-bgp837/rout-bgp837.yml) file  
        3. Launch ContainerLab `rout-bgp837.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp837.yml  
        ```
        4. Destroy ContainerLab `rout-bgp837.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp837.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp837.tst` file [here](../tst/rout-bgp837.tst)  
        3. Launch `rout-bgp837.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp837 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp837.tst` test:  
