# Example: l3otherevpns over ebgp

=== "Topology"

    ![Alt text](../d2/rout-bgp808/rout-bgp808.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp808](../clab/rout-bgp808/rout-bgp808.yml) file  
        3. Launch ContainerLab `rout-bgp808.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp808.yml  
        ```
        4. Destroy ContainerLab `rout-bgp808.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp808.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp808.tst` file [here](../tst/rout-bgp808.tst)  
        3. Launch `rout-bgp808.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp808 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp808.tst` test:  
