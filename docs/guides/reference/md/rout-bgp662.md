# Example: octp ibgp rr prefix withdraw

=== "Topology"

    ![Alt text](../d2/rout-bgp662/rout-bgp662.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp662](../clab/rout-bgp662/rout-bgp662.yml) file  
        3. Launch ContainerLab `rout-bgp662.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp662.yml  
        ```
        4. Destroy ContainerLab `rout-bgp662.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp662.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp662.tst` file [here](../tst/rout-bgp662.tst)  
        3. Launch `rout-bgp662.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp662 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp662.tst` test:  
