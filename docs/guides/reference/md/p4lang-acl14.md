...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-acl14/p4lang-acl14.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl14](../clab/p4lang-acl14/p4lang-acl14.yml) file  
        3. Launch ContainerLab `p4lang-acl14.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl14.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl14.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl14.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl14.tst` file [here](../tst/p4lang-acl14.tst)  
        3. Launch `p4lang-acl14.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl14 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl14.tst` test:  
