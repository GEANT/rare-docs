...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rip17/rout-rip17.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rip17](../clab/rout-rip17/rout-rip17.yml) file  
        3. Launch ContainerLab `rout-rip17.yml` topology:  

        ```
           containerlab deploy --topo rout-rip17.yml  
        ```
        4. Destroy ContainerLab `rout-rip17.yml` topology:  

        ```
           containerlab destroy --topo rout-rip17.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rip17.tst` file [here](../tst/rout-rip17.tst)  
        3. Launch `rout-rip17.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rip17 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rip17.tst` test:  
