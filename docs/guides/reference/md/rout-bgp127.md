...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp127/rout-bgp127.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp127](../clab/rout-bgp127/rout-bgp127.yml) file  
        3. Launch ContainerLab `rout-bgp127.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp127.yml  
        ```
        4. Destroy ContainerLab `rout-bgp127.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp127.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp127.tst` file [here](../tst/rout-bgp127.tst)  
        3. Launch `rout-bgp127.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp127 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp127.tst` test:  
