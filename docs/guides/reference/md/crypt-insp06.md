...
=== "Topology"
    ...
    ![Alt text](../d2/crypt-insp06/crypt-insp06.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [crypt-insp06](../clab/crypt-insp06/crypt-insp06.yml) file  
        3. Launch ContainerLab `crypt-insp06.yml` topology:  

        ```
           containerlab deploy --topo crypt-insp06.yml  
        ```
        4. Destroy ContainerLab `crypt-insp06.yml` topology:  

        ```
           containerlab destroy --topo crypt-insp06.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `crypt-insp06.tst` file [here](../tst/crypt-insp06.tst)  
        3. Launch `crypt-insp06.tst` test:  

        ```
           java -jar ../../rtr.jar test tester crypt-insp06 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `crypt-insp06.tst` test:  
