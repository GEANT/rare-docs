# Example: p4lang: tmux mpls over hairpin

=== "Topology"

    ![Alt text](../d2/p4lang-rout303/p4lang-rout303.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout303](../clab/p4lang-rout303/p4lang-rout303.yml) file  
        3. Launch ContainerLab `p4lang-rout303.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout303.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout303.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout303.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout303.tst` file [here](../tst/p4lang-rout303.tst)  
        3. Launch `p4lang-rout303.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout303 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout303.tst` test:  
