...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rip15/rout-rip15.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rip15](../clab/rout-rip15/rout-rip15.yml) file  
        3. Launch ContainerLab `rout-rip15.yml` topology:  

        ```
           containerlab deploy --topo rout-rip15.yml  
        ```
        4. Destroy ContainerLab `rout-rip15.yml` topology:  

        ```
           containerlab destroy --topo rout-rip15.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rip15.tst` file [here](../tst/rout-rip15.tst)  
        3. Launch `rout-rip15.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rip15 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rip15.tst` test:  
