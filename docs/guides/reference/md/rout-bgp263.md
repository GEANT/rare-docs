...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp263/rout-bgp263.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp263](../clab/rout-bgp263/rout-bgp263.yml) file  
        3. Launch ContainerLab `rout-bgp263.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp263.yml  
        ```
        4. Destroy ContainerLab `rout-bgp263.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp263.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp263.tst` file [here](../tst/rout-bgp263.tst)  
        3. Launch `rout-bgp263.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp263 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp263.tst` test:  
