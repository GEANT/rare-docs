...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp162/rout-bgp162.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp162](../clab/rout-bgp162/rout-bgp162.yml) file  
        3. Launch ContainerLab `rout-bgp162.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp162.yml  
        ```
        4. Destroy ContainerLab `rout-bgp162.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp162.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp162.tst` file [here](../tst/rout-bgp162.tst)  
        3. Launch `rout-bgp162.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp162 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp162.tst` test:  
