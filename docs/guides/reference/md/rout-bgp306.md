...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp306/rout-bgp306.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp306](../clab/rout-bgp306/rout-bgp306.yml) file  
        3. Launch ContainerLab `rout-bgp306.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp306.yml  
        ```
        4. Destroy ContainerLab `rout-bgp306.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp306.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp306.tst` file [here](../tst/rout-bgp306.tst)  
        3. Launch `rout-bgp306.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp306 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp306.tst` test:  
