...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp294/rout-bgp294.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp294](../clab/rout-bgp294/rout-bgp294.yml) file  
        3. Launch ContainerLab `rout-bgp294.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp294.yml  
        ```
        4. Destroy ContainerLab `rout-bgp294.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp294.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp294.tst` file [here](../tst/rout-bgp294.tst)  
        3. Launch `rout-bgp294.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp294 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp294.tst` test:  
