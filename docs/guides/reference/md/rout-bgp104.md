...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp104/rout-bgp104.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp104](../clab/rout-bgp104/rout-bgp104.yml) file  
        3. Launch ContainerLab `rout-bgp104.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp104.yml  
        ```
        4. Destroy ContainerLab `rout-bgp104.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp104.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp104.tst` file [here](../tst/rout-bgp104.tst)  
        3. Launch `rout-bgp104.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp104 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp104.tst` test:  
