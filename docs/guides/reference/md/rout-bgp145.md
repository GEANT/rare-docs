...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp145/rout-bgp145.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp145](../clab/rout-bgp145/rout-bgp145.yml) file  
        3. Launch ContainerLab `rout-bgp145.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp145.yml  
        ```
        4. Destroy ContainerLab `rout-bgp145.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp145.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp145.tst` file [here](../tst/rout-bgp145.tst)  
        3. Launch `rout-bgp145.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp145 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp145.tst` test:  
