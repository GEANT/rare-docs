# Example: unicast+vpns over confed bgp with dynamic capability

=== "Topology"

    ![Alt text](../d2/rout-bgp778/rout-bgp778.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp778](../clab/rout-bgp778/rout-bgp778.yml) file  
        3. Launch ContainerLab `rout-bgp778.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp778.yml  
        ```
        4. Destroy ContainerLab `rout-bgp778.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp778.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp778.tst` file [here](../tst/rout-bgp778.tst)  
        3. Launch `rout-bgp778.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp778 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp778.tst` test:  
