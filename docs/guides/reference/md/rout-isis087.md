...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis087/rout-isis087.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis087](../clab/rout-isis087/rout-isis087.yml) file  
        3. Launch ContainerLab `rout-isis087.yml` topology:  

        ```
           containerlab deploy --topo rout-isis087.yml  
        ```
        4. Destroy ContainerLab `rout-isis087.yml` topology:  

        ```
           containerlab destroy --topo rout-isis087.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis087.tst` file [here](../tst/rout-isis087.tst)  
        3. Launch `rout-isis087.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis087 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis087.tst` test:  
