# Example: redistribution filtering with routepolicy in routemap

=== "Topology"

    ![Alt text](../d2/rout-redist39/rout-redist39.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist39](../clab/rout-redist39/rout-redist39.yml) file  
        3. Launch ContainerLab `rout-redist39.yml` topology:  

        ```
           containerlab deploy --topo rout-redist39.yml  
        ```
        4. Destroy ContainerLab `rout-redist39.yml` topology:  

        ```
           containerlab destroy --topo rout-redist39.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist39.tst` file [here](../tst/rout-redist39.tst)  
        3. Launch `rout-redist39.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist39 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist39.tst` test:  
