...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp553/rout-bgp553.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp553](../clab/rout-bgp553/rout-bgp553.yml) file  
        3. Launch ContainerLab `rout-bgp553.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp553.yml  
        ```
        4. Destroy ContainerLab `rout-bgp553.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp553.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp553.tst` file [here](../tst/rout-bgp553.tst)  
        3. Launch `rout-bgp553.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp553 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp553.tst` test:  
