...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp227/rout-bgp227.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp227](../clab/rout-bgp227/rout-bgp227.yml) file  
        3. Launch ContainerLab `rout-bgp227.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp227.yml  
        ```
        4. Destroy ContainerLab `rout-bgp227.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp227.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp227.tst` file [here](../tst/rout-bgp227.tst)  
        3. Launch `rout-bgp227.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp227 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp227.tst` test:  
