...
=== "Topology"
    ...
    ![Alt text](../d2/crypt-openvpn01/crypt-openvpn01.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [crypt-openvpn01](../clab/crypt-openvpn01/crypt-openvpn01.yml) file  
        3. Launch ContainerLab `crypt-openvpn01.yml` topology:  

        ```
           containerlab deploy --topo crypt-openvpn01.yml  
        ```
        4. Destroy ContainerLab `crypt-openvpn01.yml` topology:  

        ```
           containerlab destroy --topo crypt-openvpn01.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `crypt-openvpn01.tst` file [here](../tst/crypt-openvpn01.tst)  
        3. Launch `crypt-openvpn01.tst` test:  

        ```
           java -jar ../../rtr.jar test tester crypt-openvpn01 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `crypt-openvpn01.tst` test:  
