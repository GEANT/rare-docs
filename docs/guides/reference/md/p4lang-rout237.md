# Example: p4lang: null routing

=== "Topology"

    ![Alt text](../d2/p4lang-rout237/p4lang-rout237.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout237](../clab/p4lang-rout237/p4lang-rout237.yml) file  
        3. Launch ContainerLab `p4lang-rout237.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout237.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout237.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout237.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout237.tst` file [here](../tst/p4lang-rout237.tst)  
        3. Launch `p4lang-rout237.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout237 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout237.tst` test:  
