...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout065/p4lang-rout065.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout065](../clab/p4lang-rout065/p4lang-rout065.yml) file  
        3. Launch ContainerLab `p4lang-rout065.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout065.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout065.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout065.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout065.tst` file [here](../tst/p4lang-rout065.tst)  
        3. Launch `p4lang-rout065.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout065 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout065.tst` test:  
