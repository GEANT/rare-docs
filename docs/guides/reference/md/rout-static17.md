...
=== "Topology"
    ...
    ![Alt text](../d2/rout-static17/rout-static17.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-static17](../clab/rout-static17/rout-static17.yml) file  
        3. Launch ContainerLab `rout-static17.yml` topology:  

        ```
           containerlab deploy --topo rout-static17.yml  
        ```
        4. Destroy ContainerLab `rout-static17.yml` topology:  

        ```
           containerlab destroy --topo rout-static17.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-static17.tst` file [here](../tst/rout-static17.tst)  
        3. Launch `rout-static17.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-static17 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-static17.tst` test:  
