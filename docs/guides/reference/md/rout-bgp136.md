...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp136/rout-bgp136.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp136](../clab/rout-bgp136/rout-bgp136.yml) file  
        3. Launch ContainerLab `rout-bgp136.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp136.yml  
        ```
        4. Destroy ContainerLab `rout-bgp136.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp136.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp136.tst` file [here](../tst/rout-bgp136.tst)  
        3. Launch `rout-bgp136.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp136 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp136.tst` test:  
