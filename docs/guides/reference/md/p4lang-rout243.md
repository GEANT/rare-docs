# Example: p4lang: l2tp3 routing over ipv4

=== "Topology"

    ![Alt text](../d2/p4lang-rout243/p4lang-rout243.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout243](../clab/p4lang-rout243/p4lang-rout243.yml) file  
        3. Launch ContainerLab `p4lang-rout243.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout243.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout243.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout243.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout243.tst` file [here](../tst/p4lang-rout243.tst)  
        3. Launch `p4lang-rout243.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout243 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout243.tst` test:  
