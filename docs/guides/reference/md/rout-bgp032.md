...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp032/rout-bgp032.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp032](../clab/rout-bgp032/rout-bgp032.yml) file  
        3. Launch ContainerLab `rout-bgp032.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp032.yml  
        ```
        4. Destroy ContainerLab `rout-bgp032.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp032.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp032.tst` file [here](../tst/rout-bgp032.tst)  
        3. Launch `rout-bgp032.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp032 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp032.tst` test:  
