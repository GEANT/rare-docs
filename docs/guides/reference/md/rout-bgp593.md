# Example: othervpns with egress rtfilter

=== "Topology"

    ![Alt text](../d2/rout-bgp593/rout-bgp593.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp593](../clab/rout-bgp593/rout-bgp593.yml) file  
        3. Launch ContainerLab `rout-bgp593.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp593.yml  
        ```
        4. Destroy ContainerLab `rout-bgp593.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp593.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp593.tst` file [here](../tst/rout-bgp593.tst)  
        3. Launch `rout-bgp593.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp593 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp593.tst` test:  
