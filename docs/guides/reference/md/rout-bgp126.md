...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp126/rout-bgp126.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp126](../clab/rout-bgp126/rout-bgp126.yml) file  
        3. Launch ContainerLab `rout-bgp126.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp126.yml  
        ```
        4. Destroy ContainerLab `rout-bgp126.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp126.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp126.tst` file [here](../tst/rout-bgp126.tst)  
        3. Launch `rout-bgp126.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp126 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp126.tst` test:  
