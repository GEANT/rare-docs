...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp129/rout-bgp129.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp129](../clab/rout-bgp129/rout-bgp129.yml) file  
        3. Launch ContainerLab `rout-bgp129.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp129.yml  
        ```
        4. Destroy ContainerLab `rout-bgp129.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp129.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp129.tst` file [here](../tst/rout-bgp129.tst)  
        3. Launch `rout-bgp129.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp129 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp129.tst` test:  
