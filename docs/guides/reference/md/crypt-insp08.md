...
=== "Topology"
    ...
    ![Alt text](../d2/crypt-insp08/crypt-insp08.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [crypt-insp08](../clab/crypt-insp08/crypt-insp08.yml) file  
        3. Launch ContainerLab `crypt-insp08.yml` topology:  

        ```
           containerlab deploy --topo crypt-insp08.yml  
        ```
        4. Destroy ContainerLab `crypt-insp08.yml` topology:  

        ```
           containerlab destroy --topo crypt-insp08.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `crypt-insp08.tst` file [here](../tst/crypt-insp08.tst)  
        3. Launch `crypt-insp08.tst` test:  

        ```
           java -jar ../../rtr.jar test tester crypt-insp08 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `crypt-insp08.tst` test:  
