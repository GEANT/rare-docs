...
=== "Topology"
    ...
    ![Alt text](../d2/rout-babel27/rout-babel27.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-babel27](../clab/rout-babel27/rout-babel27.yml) file  
        3. Launch ContainerLab `rout-babel27.yml` topology:  

        ```
           containerlab deploy --topo rout-babel27.yml  
        ```
        4. Destroy ContainerLab `rout-babel27.yml` topology:  

        ```
           containerlab destroy --topo rout-babel27.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-babel27.tst` file [here](../tst/rout-babel27.tst)  
        3. Launch `rout-babel27.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-babel27 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-babel27.tst` test:  
