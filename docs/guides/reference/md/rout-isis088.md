...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis088/rout-isis088.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis088](../clab/rout-isis088/rout-isis088.yml) file  
        3. Launch ContainerLab `rout-isis088.yml` topology:  

        ```
           containerlab deploy --topo rout-isis088.yml  
        ```
        4. Destroy ContainerLab `rout-isis088.yml` topology:  

        ```
           containerlab destroy --topo rout-isis088.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis088.tst` file [here](../tst/rout-isis088.tst)  
        3. Launch `rout-isis088.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis088 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis088.tst` test:  
