# Example: bgp change in metric with car

=== "Topology"

    ![Alt text](../d2/rout-bgp719/rout-bgp719.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp719](../clab/rout-bgp719/rout-bgp719.yml) file  
        3. Launch ContainerLab `rout-bgp719.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp719.yml  
        ```
        4. Destroy ContainerLab `rout-bgp719.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp719.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp719.tst` file [here](../tst/rout-bgp719.tst)  
        3. Launch `rout-bgp719.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp719 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp719.tst` test:  
