...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp211/rout-bgp211.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp211](../clab/rout-bgp211/rout-bgp211.yml) file  
        3. Launch ContainerLab `rout-bgp211.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp211.yml  
        ```
        4. Destroy ContainerLab `rout-bgp211.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp211.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp211.tst` file [here](../tst/rout-bgp211.tst)  
        3. Launch `rout-bgp211.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp211 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp211.tst` test:  
