...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt108/p4lang-crypt108.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt108](../clab/p4lang-crypt108/p4lang-crypt108.yml) file  
        3. Launch ContainerLab `p4lang-crypt108.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt108.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt108.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt108.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt108.tst` file [here](../tst/p4lang-crypt108.tst)  
        3. Launch `p4lang-crypt108.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt108 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt108.tst` test:  
