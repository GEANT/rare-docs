...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis076/rout-isis076.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis076](../clab/rout-isis076/rout-isis076.yml) file  
        3. Launch ContainerLab `rout-isis076.yml` topology:  

        ```
           containerlab deploy --topo rout-isis076.yml  
        ```
        4. Destroy ContainerLab `rout-isis076.yml` topology:  

        ```
           containerlab destroy --topo rout-isis076.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis076.tst` file [here](../tst/rout-isis076.tst)  
        3. Launch `rout-isis076.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis076 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis076.tst` test:  
