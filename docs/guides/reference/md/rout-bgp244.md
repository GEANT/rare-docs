...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp244/rout-bgp244.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp244](../clab/rout-bgp244/rout-bgp244.yml) file  
        3. Launch ContainerLab `rout-bgp244.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp244.yml  
        ```
        4. Destroy ContainerLab `rout-bgp244.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp244.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp244.tst` file [here](../tst/rout-bgp244.tst)  
        3. Launch `rout-bgp244.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp244 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp244.tst` test:  
