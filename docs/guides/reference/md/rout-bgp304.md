...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp304/rout-bgp304.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp304](../clab/rout-bgp304/rout-bgp304.yml) file  
        3. Launch ContainerLab `rout-bgp304.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp304.yml  
        ```
        4. Destroy ContainerLab `rout-bgp304.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp304.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp304.tst` file [here](../tst/rout-bgp304.tst)  
        3. Launch `rout-bgp304.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp304 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp304.tst` test:  
