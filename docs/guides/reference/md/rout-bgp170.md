...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp170/rout-bgp170.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp170](../clab/rout-bgp170/rout-bgp170.yml) file  
        3. Launch ContainerLab `rout-bgp170.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp170.yml  
        ```
        4. Destroy ContainerLab `rout-bgp170.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp170.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp170.tst` file [here](../tst/rout-bgp170.tst)  
        3. Launch `rout-bgp170.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp170 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp170.tst` test:  
