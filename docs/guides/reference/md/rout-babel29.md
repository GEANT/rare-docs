# Example: babel auto summarization

=== "Topology"

    ![Alt text](../d2/rout-babel29/rout-babel29.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-babel29](../clab/rout-babel29/rout-babel29.yml) file  
        3. Launch ContainerLab `rout-babel29.yml` topology:  

        ```
           containerlab deploy --topo rout-babel29.yml  
        ```
        4. Destroy ContainerLab `rout-babel29.yml` topology:  

        ```
           containerlab destroy --topo rout-babel29.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-babel29.tst` file [here](../tst/rout-babel29.tst)  
        3. Launch `rout-babel29.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-babel29 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-babel29.tst` test:  
