...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf14/rout-ospf14.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf14](../clab/rout-ospf14/rout-ospf14.yml) file  
        3. Launch ContainerLab `rout-ospf14.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf14.yml  
        ```
        4. Destroy ContainerLab `rout-ospf14.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf14.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf14.tst` file [here](../tst/rout-ospf14.tst)  
        3. Launch `rout-ospf14.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf14 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf14.tst` test:  
