...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt013/p4lang-crypt013.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt013](../clab/p4lang-crypt013/p4lang-crypt013.yml) file  
        3. Launch ContainerLab `p4lang-crypt013.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt013.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt013.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt013.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt013.tst` file [here](../tst/p4lang-crypt013.tst)  
        3. Launch `p4lang-crypt013.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt013 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt013.tst` test:  
