...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp005/rout-bgp005.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp005](../clab/rout-bgp005/rout-bgp005.yml) file  
        3. Launch ContainerLab `rout-bgp005.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp005.yml  
        ```
        4. Destroy ContainerLab `rout-bgp005.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp005.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp005.tst` file [here](../tst/rout-bgp005.tst)  
        3. Launch `rout-bgp005.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp005 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp005.tst` test:  
