...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp258/rout-bgp258.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp258](../clab/rout-bgp258/rout-bgp258.yml) file  
        3. Launch ContainerLab `rout-bgp258.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp258.yml  
        ```
        4. Destroy ContainerLab `rout-bgp258.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp258.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp258.tst` file [here](../tst/rout-bgp258.tst)  
        3. Launch `rout-bgp258.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp258 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp258.tst` test:  
