...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp152/rout-bgp152.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp152](../clab/rout-bgp152/rout-bgp152.yml) file  
        3. Launch ContainerLab `rout-bgp152.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp152.yml  
        ```
        4. Destroy ContainerLab `rout-bgp152.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp152.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp152.tst` file [here](../tst/rout-bgp152.tst)  
        3. Launch `rout-bgp152.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp152 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp152.tst` test:  
