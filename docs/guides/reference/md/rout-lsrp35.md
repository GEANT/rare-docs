...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp35/rout-lsrp35.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp35](../clab/rout-lsrp35/rout-lsrp35.yml) file  
        3. Launch ContainerLab `rout-lsrp35.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp35.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp35.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp35.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp35.tst` file [here](../tst/rout-lsrp35.tst)  
        3. Launch `rout-lsrp35.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp35 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp35.tst` test:  
