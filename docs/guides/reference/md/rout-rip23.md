...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rip23/rout-rip23.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rip23](../clab/rout-rip23/rout-rip23.yml) file  
        3. Launch ContainerLab `rout-rip23.yml` topology:  

        ```
           containerlab deploy --topo rout-rip23.yml  
        ```
        4. Destroy ContainerLab `rout-rip23.yml` topology:  

        ```
           containerlab destroy --topo rout-rip23.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rip23.tst` file [here](../tst/rout-rip23.tst)  
        3. Launch `rout-rip23.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rip23 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rip23.tst` test:  
