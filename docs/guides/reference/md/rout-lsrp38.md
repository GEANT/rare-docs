...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp38/rout-lsrp38.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp38](../clab/rout-lsrp38/rout-lsrp38.yml) file  
        3. Launch ContainerLab `rout-lsrp38.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp38.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp38.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp38.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp38.tst` file [here](../tst/rout-lsrp38.tst)  
        3. Launch `rout-lsrp38.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp38 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp38.tst` test:  
