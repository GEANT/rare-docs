...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp215/rout-bgp215.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp215](../clab/rout-bgp215/rout-bgp215.yml) file  
        3. Launch ContainerLab `rout-bgp215.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp215.yml  
        ```
        4. Destroy ContainerLab `rout-bgp215.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp215.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp215.tst` file [here](../tst/rout-bgp215.tst)  
        3. Launch `rout-bgp215.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp215 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp215.tst` test:  
