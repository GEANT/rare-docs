...
=== "Topology"
    ...
    ![Alt text](../d2/rout-redist18/rout-redist18.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist18](../clab/rout-redist18/rout-redist18.yml) file  
        3. Launch ContainerLab `rout-redist18.yml` topology:  

        ```
           containerlab deploy --topo rout-redist18.yml  
        ```
        4. Destroy ContainerLab `rout-redist18.yml` topology:  

        ```
           containerlab destroy --topo rout-redist18.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist18.tst` file [here](../tst/rout-redist18.tst)  
        3. Launch `rout-redist18.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist18 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist18.tst` test:  
