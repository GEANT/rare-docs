...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-polka05/mpls-polka05.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-polka05](../clab/mpls-polka05/mpls-polka05.yml) file  
        3. Launch ContainerLab `mpls-polka05.yml` topology:  

        ```
           containerlab deploy --topo mpls-polka05.yml  
        ```
        4. Destroy ContainerLab `mpls-polka05.yml` topology:  

        ```
           containerlab destroy --topo mpls-polka05.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-polka05.tst` file [here](../tst/mpls-polka05.tst)  
        3. Launch `mpls-polka05.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-polka05 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-polka05.tst` test:  
