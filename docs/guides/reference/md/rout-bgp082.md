...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp082/rout-bgp082.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp082](../clab/rout-bgp082/rout-bgp082.yml) file  
        3. Launch ContainerLab `rout-bgp082.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp082.yml  
        ```
        4. Destroy ContainerLab `rout-bgp082.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp082.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp082.tst` file [here](../tst/rout-bgp082.tst)  
        3. Launch `rout-bgp082.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp082 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp082.tst` test:  
