...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp07/rout-lsrp07.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp07](../clab/rout-lsrp07/rout-lsrp07.yml) file  
        3. Launch ContainerLab `rout-lsrp07.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp07.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp07.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp07.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp07.tst` file [here](../tst/rout-lsrp07.tst)  
        3. Launch `rout-lsrp07.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp07 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp07.tst` test:  
