...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-acl65/p4lang-acl65.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl65](../clab/p4lang-acl65/p4lang-acl65.yml) file  
        3. Launch ContainerLab `p4lang-acl65.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl65.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl65.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl65.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl65.tst` file [here](../tst/p4lang-acl65.tst)  
        3. Launch `p4lang-acl65.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl65 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl65.tst` test:  
