...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis077/rout-isis077.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis077](../clab/rout-isis077/rout-isis077.yml) file  
        3. Launch ContainerLab `rout-isis077.yml` topology:  

        ```
           containerlab deploy --topo rout-isis077.yml  
        ```
        4. Destroy ContainerLab `rout-isis077.yml` topology:  

        ```
           containerlab destroy --topo rout-isis077.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis077.tst` file [here](../tst/rout-isis077.tst)  
        3. Launch `rout-isis077.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis077 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis077.tst` test:  
