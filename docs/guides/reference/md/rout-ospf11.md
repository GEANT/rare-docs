...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf11/rout-ospf11.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf11](../clab/rout-ospf11/rout-ospf11.yml) file  
        3. Launch ContainerLab `rout-ospf11.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf11.yml  
        ```
        4. Destroy ContainerLab `rout-ospf11.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf11.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf11.tst` file [here](../tst/rout-ospf11.tst)  
        3. Launch `rout-ospf11.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf11 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf11.tst` test:  
