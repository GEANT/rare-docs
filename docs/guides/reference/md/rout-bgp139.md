...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp139/rout-bgp139.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp139](../clab/rout-bgp139/rout-bgp139.yml) file  
        3. Launch ContainerLab `rout-bgp139.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp139.yml  
        ```
        4. Destroy ContainerLab `rout-bgp139.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp139.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp139.tst` file [here](../tst/rout-bgp139.tst)  
        3. Launch `rout-bgp139.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp139 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp139.tst` test:  
