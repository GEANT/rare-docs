...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-polka01/mpls-polka01.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-polka01](../clab/mpls-polka01/mpls-polka01.yml) file  
        3. Launch ContainerLab `mpls-polka01.yml` topology:  

        ```
           containerlab deploy --topo mpls-polka01.yml  
        ```
        4. Destroy ContainerLab `mpls-polka01.yml` topology:  

        ```
           containerlab destroy --topo mpls-polka01.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-polka01.tst` file [here](../tst/mpls-polka01.tst)  
        3. Launch `mpls-polka01.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-polka01 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-polka01.tst` test:  
