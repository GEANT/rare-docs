...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp091/rout-bgp091.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp091](../clab/rout-bgp091/rout-bgp091.yml) file  
        3. Launch ContainerLab `rout-bgp091.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp091.yml  
        ```
        4. Destroy ContainerLab `rout-bgp091.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp091.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp091.tst` file [here](../tst/rout-bgp091.tst)  
        3. Launch `rout-bgp091.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp091 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp091.tst` test:  
