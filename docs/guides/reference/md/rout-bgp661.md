# Example: octp ibgp rr prefix movement

=== "Topology"

    ![Alt text](../d2/rout-bgp661/rout-bgp661.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp661](../clab/rout-bgp661/rout-bgp661.yml) file  
        3. Launch ContainerLab `rout-bgp661.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp661.yml  
        ```
        4. Destroy ContainerLab `rout-bgp661.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp661.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp661.tst` file [here](../tst/rout-bgp661.tst)  
        3. Launch `rout-bgp661.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp661 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp661.tst` test:  
