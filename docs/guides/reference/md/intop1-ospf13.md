...
=== "Topology"
    ...
    ![Alt text](../d2/intop1-ospf13/intop1-ospf13.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [intop1-ospf13](../clab/intop1-ospf13/intop1-ospf13.yml) file  
        3. Launch ContainerLab `intop1-ospf13.yml` topology:  

        ```
           containerlab deploy --topo intop1-ospf13.yml  
        ```
        4. Destroy ContainerLab `intop1-ospf13.yml` topology:  

        ```
           containerlab destroy --topo intop1-ospf13.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `intop1-ospf13.tst` file [here](../tst/intop1-ospf13.tst)  
        3. Launch `intop1-ospf13.tst` test:  

        ```
           java -jar ../../rtr.jar test tester intop1-ospf13 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `intop1-ospf13.tst` test:  
