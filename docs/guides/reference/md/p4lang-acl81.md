...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-acl81/p4lang-acl81.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl81](../clab/p4lang-acl81/p4lang-acl81.yml) file  
        3. Launch ContainerLab `p4lang-acl81.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl81.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl81.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl81.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl81.tst` file [here](../tst/p4lang-acl81.tst)  
        3. Launch `p4lang-acl81.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl81 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl81.tst` test:  
