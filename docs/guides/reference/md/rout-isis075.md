...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis075/rout-isis075.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis075](../clab/rout-isis075/rout-isis075.yml) file  
        3. Launch ContainerLab `rout-isis075.yml` topology:  

        ```
           containerlab deploy --topo rout-isis075.yml  
        ```
        4. Destroy ContainerLab `rout-isis075.yml` topology:  

        ```
           containerlab destroy --topo rout-isis075.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis075.tst` file [here](../tst/rout-isis075.tst)  
        3. Launch `rout-isis075.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis075 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis075.tst` test:  
