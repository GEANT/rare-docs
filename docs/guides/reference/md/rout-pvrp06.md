...
=== "Topology"
    ...
    ![Alt text](../d2/rout-pvrp06/rout-pvrp06.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-pvrp06](../clab/rout-pvrp06/rout-pvrp06.yml) file  
        3. Launch ContainerLab `rout-pvrp06.yml` topology:  

        ```
           containerlab deploy --topo rout-pvrp06.yml  
        ```
        4. Destroy ContainerLab `rout-pvrp06.yml` topology:  

        ```
           containerlab destroy --topo rout-pvrp06.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-pvrp06.tst` file [here](../tst/rout-pvrp06.tst)  
        3. Launch `rout-pvrp06.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-pvrp06 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-pvrp06.tst` test:  
