# Example: other car colors over bgp with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp771/rout-bgp771.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp771](../clab/rout-bgp771/rout-bgp771.yml) file  
        3. Launch ContainerLab `rout-bgp771.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp771.yml  
        ```
        4. Destroy ContainerLab `rout-bgp771.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp771.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp771.tst` file [here](../tst/rout-bgp771.tst)  
        3. Launch `rout-bgp771.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp771 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp771.tst` test:  
