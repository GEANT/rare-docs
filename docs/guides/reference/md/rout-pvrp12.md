...
=== "Topology"
    ...
    ![Alt text](../d2/rout-pvrp12/rout-pvrp12.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-pvrp12](../clab/rout-pvrp12/rout-pvrp12.yml) file  
        3. Launch ContainerLab `rout-pvrp12.yml` topology:  

        ```
           containerlab deploy --topo rout-pvrp12.yml  
        ```
        4. Destroy ContainerLab `rout-pvrp12.yml` topology:  

        ```
           containerlab destroy --topo rout-pvrp12.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-pvrp12.tst` file [here](../tst/rout-pvrp12.tst)  
        3. Launch `rout-pvrp12.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-pvrp12 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-pvrp12.tst` test:  
