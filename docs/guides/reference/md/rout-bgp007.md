...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp007/rout-bgp007.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp007](../clab/rout-bgp007/rout-bgp007.yml) file  
        3. Launch ContainerLab `rout-bgp007.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp007.yml  
        ```
        4. Destroy ContainerLab `rout-bgp007.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp007.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp007.tst` file [here](../tst/rout-bgp007.tst)  
        3. Launch `rout-bgp007.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp007 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp007.tst` test:  
