...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp577/rout-bgp577.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp577](../clab/rout-bgp577/rout-bgp577.yml) file  
        3. Launch ContainerLab `rout-bgp577.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp577.yml  
        ```
        4. Destroy ContainerLab `rout-bgp577.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp577.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp577.tst` file [here](../tst/rout-bgp577.tst)  
        3. Launch `rout-bgp577.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp577 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp577.tst` test:  
