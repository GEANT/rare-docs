...
=== "Topology"
    ...
    ![Alt text](../d2/qos-match01/qos-match01.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [qos-match01](../clab/qos-match01/qos-match01.yml) file  
        3. Launch ContainerLab `qos-match01.yml` topology:  

        ```
           containerlab deploy --topo qos-match01.yml  
        ```
        4. Destroy ContainerLab `qos-match01.yml` topology:  

        ```
           containerlab destroy --topo qos-match01.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `qos-match01.tst` file [here](../tst/qos-match01.tst)  
        3. Launch `qos-match01.tst` test:  

        ```
           java -jar ../../rtr.jar test tester qos-match01 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `qos-match01.tst` test:  
