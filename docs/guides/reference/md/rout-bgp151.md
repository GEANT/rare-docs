...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp151/rout-bgp151.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp151](../clab/rout-bgp151/rout-bgp151.yml) file  
        3. Launch ContainerLab `rout-bgp151.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp151.yml  
        ```
        4. Destroy ContainerLab `rout-bgp151.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp151.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp151.tst` file [here](../tst/rout-bgp151.tst)  
        3. Launch `rout-bgp151.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp151 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp151.tst` test:  
