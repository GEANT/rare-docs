...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-acl013/p4lang-acl013.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl013](../clab/p4lang-acl013/p4lang-acl013.yml) file  
        3. Launch ContainerLab `p4lang-acl013.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl013.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl013.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl013.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl013.tst` file [here](../tst/p4lang-acl013.tst)  
        3. Launch `p4lang-acl013.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl013 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl013.tst` test:  
