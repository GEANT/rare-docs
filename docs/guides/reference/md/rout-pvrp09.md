...
=== "Topology"
    ...
    ![Alt text](../d2/rout-pvrp09/rout-pvrp09.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-pvrp09](../clab/rout-pvrp09/rout-pvrp09.yml) file  
        3. Launch ContainerLab `rout-pvrp09.yml` topology:  

        ```
           containerlab deploy --topo rout-pvrp09.yml  
        ```
        4. Destroy ContainerLab `rout-pvrp09.yml` topology:  

        ```
           containerlab destroy --topo rout-pvrp09.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-pvrp09.tst` file [here](../tst/rout-pvrp09.tst)  
        3. Launch `rout-pvrp09.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-pvrp09 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-pvrp09.tst` test:  
