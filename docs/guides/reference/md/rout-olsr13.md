...
=== "Topology"
    ...
    ![Alt text](../d2/rout-olsr13/rout-olsr13.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-olsr13](../clab/rout-olsr13/rout-olsr13.yml) file  
        3. Launch ContainerLab `rout-olsr13.yml` topology:  

        ```
           containerlab deploy --topo rout-olsr13.yml  
        ```
        4. Destroy ContainerLab `rout-olsr13.yml` topology:  

        ```
           containerlab destroy --topo rout-olsr13.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-olsr13.tst` file [here](../tst/rout-olsr13.tst)  
        3. Launch `rout-olsr13.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-olsr13 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-olsr13.tst` test:  
