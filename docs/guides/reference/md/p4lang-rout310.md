# Example: p4lang: bier core over tmux

=== "Topology"

    ![Alt text](../d2/p4lang-rout310/p4lang-rout310.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout310](../clab/p4lang-rout310/p4lang-rout310.yml) file  
        3. Launch ContainerLab `p4lang-rout310.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout310.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout310.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout310.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout310.tst` file [here](../tst/p4lang-rout310.tst)  
        3. Launch `p4lang-rout310.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout310 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout310.tst` test:  
