# Example: bgp change in leak-role with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp791/rout-bgp791.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp791](../clab/rout-bgp791/rout-bgp791.yml) file  
        3. Launch ContainerLab `rout-bgp791.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp791.yml  
        ```
        4. Destroy ContainerLab `rout-bgp791.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp791.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp791.tst` file [here](../tst/rout-bgp791.tst)  
        3. Launch `rout-bgp791.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp791 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp791.tst` test:  
