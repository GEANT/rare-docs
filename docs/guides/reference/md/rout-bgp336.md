...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp336/rout-bgp336.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp336](../clab/rout-bgp336/rout-bgp336.yml) file  
        3. Launch ContainerLab `rout-bgp336.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp336.yml  
        ```
        4. Destroy ContainerLab `rout-bgp336.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp336.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp336.tst` file [here](../tst/rout-bgp336.tst)  
        3. Launch `rout-bgp336.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp336 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp336.tst` test:  
