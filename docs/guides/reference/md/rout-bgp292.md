...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp292/rout-bgp292.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp292](../clab/rout-bgp292/rout-bgp292.yml) file  
        3. Launch ContainerLab `rout-bgp292.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp292.yml  
        ```
        4. Destroy ContainerLab `rout-bgp292.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp292.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp292.tst` file [here](../tst/rout-bgp292.tst)  
        3. Launch `rout-bgp292.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp292 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp292.tst` test:  
