# Example: l3evpns over bgp with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp805/rout-bgp805.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp805](../clab/rout-bgp805/rout-bgp805.yml) file  
        3. Launch ContainerLab `rout-bgp805.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp805.yml  
        ```
        4. Destroy ContainerLab `rout-bgp805.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp805.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp805.tst` file [here](../tst/rout-bgp805.tst)  
        3. Launch `rout-bgp805.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp805 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp805.tst` test:  
