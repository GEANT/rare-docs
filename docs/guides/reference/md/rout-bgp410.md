...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp410/rout-bgp410.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp410](../clab/rout-bgp410/rout-bgp410.yml) file  
        3. Launch ContainerLab `rout-bgp410.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp410.yml  
        ```
        4. Destroy ContainerLab `rout-bgp410.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp410.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp410.tst` file [here](../tst/rout-bgp410.tst)  
        3. Launch `rout-bgp410.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp410 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp410.tst` test:  
