...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp024/rout-bgp024.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp024](../clab/rout-bgp024/rout-bgp024.yml) file  
        3. Launch ContainerLab `rout-bgp024.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp024.yml  
        ```
        4. Destroy ContainerLab `rout-bgp024.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp024.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp024.tst` file [here](../tst/rout-bgp024.tst)  
        3. Launch `rout-bgp024.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp024 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp024.tst` test:  
