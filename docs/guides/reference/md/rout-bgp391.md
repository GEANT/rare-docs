...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp391/rout-bgp391.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp391](../clab/rout-bgp391/rout-bgp391.yml) file  
        3. Launch ContainerLab `rout-bgp391.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp391.yml  
        ```
        4. Destroy ContainerLab `rout-bgp391.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp391.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp391.tst` file [here](../tst/rout-bgp391.tst)  
        3. Launch `rout-bgp391.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp391 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp391.tst` test:  
