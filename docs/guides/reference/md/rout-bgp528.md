...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp528/rout-bgp528.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp528](../clab/rout-bgp528/rout-bgp528.yml) file  
        3. Launch ContainerLab `rout-bgp528.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp528.yml  
        ```
        4. Destroy ContainerLab `rout-bgp528.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp528.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp528.tst` file [here](../tst/rout-bgp528.tst)  
        3. Launch `rout-bgp528.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp528 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp528.tst` test:  
