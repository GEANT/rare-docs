...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp199/rout-bgp199.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp199](../clab/rout-bgp199/rout-bgp199.yml) file  
        3. Launch ContainerLab `rout-bgp199.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp199.yml  
        ```
        4. Destroy ContainerLab `rout-bgp199.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp199.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp199.tst` file [here](../tst/rout-bgp199.tst)  
        3. Launch `rout-bgp199.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp199 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp199.tst` test:  
