...
=== "Topology"
    ...
    ![Alt text](../d2/rout-babel02/rout-babel02.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-babel02](../clab/rout-babel02/rout-babel02.yml) file  
        3. Launch ContainerLab `rout-babel02.yml` topology:  

        ```
           containerlab deploy --topo rout-babel02.yml  
        ```
        4. Destroy ContainerLab `rout-babel02.yml` topology:  

        ```
           containerlab destroy --topo rout-babel02.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-babel02.tst` file [here](../tst/rout-babel02.tst)  
        3. Launch `rout-babel02.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-babel02 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-babel02.tst` test:  
