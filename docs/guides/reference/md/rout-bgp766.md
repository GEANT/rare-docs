# Example: car colors over confed bgp

=== "Topology"

    ![Alt text](../d2/rout-bgp766/rout-bgp766.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp766](../clab/rout-bgp766/rout-bgp766.yml) file  
        3. Launch ContainerLab `rout-bgp766.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp766.yml  
        ```
        4. Destroy ContainerLab `rout-bgp766.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp766.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp766.tst` file [here](../tst/rout-bgp766.tst)  
        3. Launch `rout-bgp766.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp766 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp766.tst` test:  
