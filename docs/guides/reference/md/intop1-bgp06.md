...
=== "Topology"
    ...
    ![Alt text](../d2/intop1-bgp06/intop1-bgp06.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [intop1-bgp06](../clab/intop1-bgp06/intop1-bgp06.yml) file  
        3. Launch ContainerLab `intop1-bgp06.yml` topology:  

        ```
           containerlab deploy --topo intop1-bgp06.yml  
        ```
        4. Destroy ContainerLab `intop1-bgp06.yml` topology:  

        ```
           containerlab destroy --topo intop1-bgp06.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `intop1-bgp06.tst` file [here](../tst/intop1-bgp06.tst)  
        3. Launch `intop1-bgp06.tst` test:  

        ```
           java -jar ../../rtr.jar test tester intop1-bgp06 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `intop1-bgp06.tst` test:  
