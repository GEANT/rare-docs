# Example: ebgp with ctp

=== "Topology"

    ![Alt text](../d2/rout-bgp605/rout-bgp605.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp605](../clab/rout-bgp605/rout-bgp605.yml) file  
        3. Launch ContainerLab `rout-bgp605.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp605.yml  
        ```
        4. Destroy ContainerLab `rout-bgp605.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp605.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp605.tst` file [here](../tst/rout-bgp605.tst)  
        3. Launch `rout-bgp605.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp605 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp605.tst` test:  
