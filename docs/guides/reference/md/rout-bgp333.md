...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp333/rout-bgp333.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp333](../clab/rout-bgp333/rout-bgp333.yml) file  
        3. Launch ContainerLab `rout-bgp333.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp333.yml  
        ```
        4. Destroy ContainerLab `rout-bgp333.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp333.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp333.tst` file [here](../tst/rout-bgp333.tst)  
        3. Launch `rout-bgp333.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp333 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp333.tst` test:  
