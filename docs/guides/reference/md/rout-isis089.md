...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis089/rout-isis089.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis089](../clab/rout-isis089/rout-isis089.yml) file  
        3. Launch ContainerLab `rout-isis089.yml` topology:  

        ```
           containerlab deploy --topo rout-isis089.yml  
        ```
        4. Destroy ContainerLab `rout-isis089.yml` topology:  

        ```
           containerlab destroy --topo rout-isis089.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis089.tst` file [here](../tst/rout-isis089.tst)  
        3. Launch `rout-isis089.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis089 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis089.tst` test:  
