# Example: l3evpns egress route filtering with routemap with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp835/rout-bgp835.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp835](../clab/rout-bgp835/rout-bgp835.yml) file  
        3. Launch ContainerLab `rout-bgp835.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp835.yml  
        ```
        4. Destroy ContainerLab `rout-bgp835.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp835.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp835.tst` file [here](../tst/rout-bgp835.tst)  
        3. Launch `rout-bgp835.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp835 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp835.tst` test:  
