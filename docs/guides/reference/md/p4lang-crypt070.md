...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt070/p4lang-crypt070.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt070](../clab/p4lang-crypt070/p4lang-crypt070.yml) file  
        3. Launch ContainerLab `p4lang-crypt070.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt070.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt070.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt070.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt070.tst` file [here](../tst/p4lang-crypt070.tst)  
        3. Launch `p4lang-crypt070.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt070 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt070.tst` test:  
