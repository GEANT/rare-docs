...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-acl66/p4lang-acl66.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl66](../clab/p4lang-acl66/p4lang-acl66.yml) file  
        3. Launch ContainerLab `p4lang-acl66.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl66.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl66.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl66.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl66.tst` file [here](../tst/p4lang-acl66.tst)  
        3. Launch `p4lang-acl66.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl66 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl66.tst` test:  
