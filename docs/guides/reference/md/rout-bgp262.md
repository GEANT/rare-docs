...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp262/rout-bgp262.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp262](../clab/rout-bgp262/rout-bgp262.yml) file  
        3. Launch ContainerLab `rout-bgp262.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp262.yml  
        ```
        4. Destroy ContainerLab `rout-bgp262.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp262.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp262.tst` file [here](../tst/rout-bgp262.tst)  
        3. Launch `rout-bgp262.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp262 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp262.tst` test:  
