...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp372/rout-bgp372.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp372](../clab/rout-bgp372/rout-bgp372.yml) file  
        3. Launch ContainerLab `rout-bgp372.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp372.yml  
        ```
        4. Destroy ContainerLab `rout-bgp372.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp372.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp372.tst` file [here](../tst/rout-bgp372.tst)  
        3. Launch `rout-bgp372.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp372 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp372.tst` test:  
