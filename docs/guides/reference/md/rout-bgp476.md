...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp476/rout-bgp476.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp476](../clab/rout-bgp476/rout-bgp476.yml) file  
        3. Launch ContainerLab `rout-bgp476.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp476.yml  
        ```
        4. Destroy ContainerLab `rout-bgp476.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp476.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp476.tst` file [here](../tst/rout-bgp476.tst)  
        3. Launch `rout-bgp476.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp476 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp476.tst` test:  
