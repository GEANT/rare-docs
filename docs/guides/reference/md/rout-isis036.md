...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis036/rout-isis036.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis036](../clab/rout-isis036/rout-isis036.yml) file  
        3. Launch ContainerLab `rout-isis036.yml` topology:  

        ```
           containerlab deploy --topo rout-isis036.yml  
        ```
        4. Destroy ContainerLab `rout-isis036.yml` topology:  

        ```
           containerlab destroy --topo rout-isis036.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis036.tst` file [here](../tst/rout-isis036.tst)  
        3. Launch `rout-isis036.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis036 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis036.tst` test:  
