...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rip02/rout-rip02.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rip02](../clab/rout-rip02/rout-rip02.yml) file  
        3. Launch ContainerLab `rout-rip02.yml` topology:  

        ```
           containerlab deploy --topo rout-rip02.yml  
        ```
        4. Destroy ContainerLab `rout-rip02.yml` topology:  

        ```
           containerlab destroy --topo rout-rip02.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rip02.tst` file [here](../tst/rout-rip02.tst)  
        3. Launch `rout-rip02.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rip02 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rip02.tst` test:  
