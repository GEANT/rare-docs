...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt074/p4lang-crypt074.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt074](../clab/p4lang-crypt074/p4lang-crypt074.yml) file  
        3. Launch ContainerLab `p4lang-crypt074.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt074.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt074.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt074.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt074.tst` file [here](../tst/p4lang-crypt074.tst)  
        3. Launch `p4lang-crypt074.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt074 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt074.tst` test:  
