...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rip25/rout-rip25.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rip25](../clab/rout-rip25/rout-rip25.yml) file  
        3. Launch ContainerLab `rout-rip25.yml` topology:  

        ```
           containerlab deploy --topo rout-rip25.yml  
        ```
        4. Destroy ContainerLab `rout-rip25.yml` topology:  

        ```
           containerlab destroy --topo rout-rip25.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rip25.tst` file [here](../tst/rout-rip25.tst)  
        3. Launch `rout-rip25.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rip25 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rip25.tst` test:  
