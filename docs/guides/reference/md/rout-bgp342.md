...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp342/rout-bgp342.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp342](../clab/rout-bgp342/rout-bgp342.yml) file  
        3. Launch ContainerLab `rout-bgp342.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp342.yml  
        ```
        4. Destroy ContainerLab `rout-bgp342.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp342.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp342.tst` file [here](../tst/rout-bgp342.tst)  
        3. Launch `rout-bgp342.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp342 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp342.tst` test:  
