...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp027/rout-bgp027.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp027](../clab/rout-bgp027/rout-bgp027.yml) file  
        3. Launch ContainerLab `rout-bgp027.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp027.yml  
        ```
        4. Destroy ContainerLab `rout-bgp027.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp027.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp027.tst` file [here](../tst/rout-bgp027.tst)  
        3. Launch `rout-bgp027.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp027 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp027.tst` test:  
