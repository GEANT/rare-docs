# Example: l3evpns egress route filtering with routepolicy with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp839/rout-bgp839.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp839](../clab/rout-bgp839/rout-bgp839.yml) file  
        3. Launch ContainerLab `rout-bgp839.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp839.yml  
        ```
        4. Destroy ContainerLab `rout-bgp839.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp839.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp839.tst` file [here](../tst/rout-bgp839.tst)  
        3. Launch `rout-bgp839.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp839 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp839.tst` test:  
