# Example: ctp colors over bgp with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp680/rout-bgp680.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp680](../clab/rout-bgp680/rout-bgp680.yml) file  
        3. Launch ContainerLab `rout-bgp680.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp680.yml  
        ```
        4. Destroy ContainerLab `rout-bgp680.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp680.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp680.tst` file [here](../tst/rout-bgp680.tst)  
        3. Launch `rout-bgp680.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp680 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp680.tst` test:  
