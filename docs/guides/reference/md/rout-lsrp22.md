...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp22/rout-lsrp22.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp22](../clab/rout-lsrp22/rout-lsrp22.yml) file  
        3. Launch ContainerLab `rout-lsrp22.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp22.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp22.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp22.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp22.tst` file [here](../tst/rout-lsrp22.tst)  
        3. Launch `rout-lsrp22.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp22 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp22.tst` test:  
