...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp101/rout-bgp101.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp101](../clab/rout-bgp101/rout-bgp101.yml) file  
        3. Launch ContainerLab `rout-bgp101.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp101.yml  
        ```
        4. Destroy ContainerLab `rout-bgp101.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp101.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp101.tst` file [here](../tst/rout-bgp101.tst)  
        3. Launch `rout-bgp101.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp101 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp101.tst` test:  
