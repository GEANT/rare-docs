...
=== "Topology"
    ...
    ![Alt text](../d2/crypt-insp13/crypt-insp13.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [crypt-insp13](../clab/crypt-insp13/crypt-insp13.yml) file  
        3. Launch ContainerLab `crypt-insp13.yml` topology:  

        ```
           containerlab deploy --topo crypt-insp13.yml  
        ```
        4. Destroy ContainerLab `crypt-insp13.yml` topology:  

        ```
           containerlab destroy --topo crypt-insp13.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `crypt-insp13.tst` file [here](../tst/crypt-insp13.tst)  
        3. Launch `crypt-insp13.tst` test:  

        ```
           java -jar ../../rtr.jar test tester crypt-insp13 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `crypt-insp13.tst` test:  
