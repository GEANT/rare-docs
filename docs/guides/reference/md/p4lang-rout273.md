# Example: p4lang: bridging over l2tp3

=== "Topology"

    ![Alt text](../d2/p4lang-rout273/p4lang-rout273.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout273](../clab/p4lang-rout273/p4lang-rout273.yml) file  
        3. Launch ContainerLab `p4lang-rout273.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout273.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout273.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout273.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout273.tst` file [here](../tst/p4lang-rout273.tst)  
        3. Launch `p4lang-rout273.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout273 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout273.tst` test:  
