# Example: bgp auto summarization

=== "Topology"

    ![Alt text](../d2/rout-bgp688/rout-bgp688.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp688](../clab/rout-bgp688/rout-bgp688.yml) file  
        3. Launch ContainerLab `rout-bgp688.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp688.yml  
        ```
        4. Destroy ContainerLab `rout-bgp688.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp688.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp688.tst` file [here](../tst/rout-bgp688.tst)  
        3. Launch `rout-bgp688.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp688 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp688.tst` test:  
