...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp002/rout-bgp002.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp002](../clab/rout-bgp002/rout-bgp002.yml) file  
        3. Launch ContainerLab `rout-bgp002.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp002.yml  
        ```
        4. Destroy ContainerLab `rout-bgp002.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp002.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp002.tst` file [here](../tst/rout-bgp002.tst)  
        3. Launch `rout-bgp002.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp002 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp002.tst` test:  
