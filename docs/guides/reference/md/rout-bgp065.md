...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp065/rout-bgp065.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp065](../clab/rout-bgp065/rout-bgp065.yml) file  
        3. Launch ContainerLab `rout-bgp065.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp065.yml  
        ```
        4. Destroy ContainerLab `rout-bgp065.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp065.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp065.tst` file [here](../tst/rout-bgp065.tst)  
        3. Launch `rout-bgp065.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp065 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp065.tst` test:  
