# Example: ocar bgp ingress route filtering with routemap with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp743/rout-bgp743.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp743](../clab/rout-bgp743/rout-bgp743.yml) file  
        3. Launch ContainerLab `rout-bgp743.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp743.yml  
        ```
        4. Destroy ContainerLab `rout-bgp743.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp743.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp743.tst` file [here](../tst/rout-bgp743.tst)  
        3. Launch `rout-bgp743.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp743 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp743.tst` test:  
