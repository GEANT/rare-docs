# Example: ibgp rr prefix movement with car

=== "Topology"

    ![Alt text](../d2/rout-bgp720/rout-bgp720.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp720](../clab/rout-bgp720/rout-bgp720.yml) file  
        3. Launch ContainerLab `rout-bgp720.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp720.yml  
        ```
        4. Destroy ContainerLab `rout-bgp720.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp720.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp720.tst` file [here](../tst/rout-bgp720.tst)  
        3. Launch `rout-bgp720.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp720 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp720.tst` test:  
