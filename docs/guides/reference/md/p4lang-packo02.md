...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-packo02/p4lang-packo02.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-packo02](../clab/p4lang-packo02/p4lang-packo02.yml) file  
        3. Launch ContainerLab `p4lang-packo02.yml` topology:  

        ```
           containerlab deploy --topo p4lang-packo02.yml  
        ```
        4. Destroy ContainerLab `p4lang-packo02.yml` topology:  

        ```
           containerlab destroy --topo p4lang-packo02.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-packo02.tst` file [here](../tst/p4lang-packo02.tst)  
        3. Launch `p4lang-packo02.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-packo02 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-packo02.tst` test:  
