# Example: p4lang: l2tp3 server mpls

=== "Topology"

    ![Alt text](../d2/p4lang-rout247/p4lang-rout247.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout247](../clab/p4lang-rout247/p4lang-rout247.yml) file  
        3. Launch ContainerLab `p4lang-rout247.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout247.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout247.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout247.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout247.tst` file [here](../tst/p4lang-rout247.tst)  
        3. Launch `p4lang-rout247.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout247 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout247.tst` test:  
