...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-bier11/mpls-bier11.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-bier11](../clab/mpls-bier11/mpls-bier11.yml) file  
        3. Launch ContainerLab `mpls-bier11.yml` topology:  

        ```
           containerlab deploy --topo mpls-bier11.yml  
        ```
        4. Destroy ContainerLab `mpls-bier11.yml` topology:  

        ```
           containerlab destroy --topo mpls-bier11.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-bier11.tst` file [here](../tst/mpls-bier11.tst)  
        3. Launch `mpls-bier11.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-bier11 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-bier11.tst` test:  
