...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-bier09/mpls-bier09.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-bier09](../clab/mpls-bier09/mpls-bier09.yml) file  
        3. Launch ContainerLab `mpls-bier09.yml` topology:  

        ```
           containerlab deploy --topo mpls-bier09.yml  
        ```
        4. Destroy ContainerLab `mpls-bier09.yml` topology:  

        ```
           containerlab destroy --topo mpls-bier09.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-bier09.tst` file [here](../tst/mpls-bier09.tst)  
        3. Launch `mpls-bier09.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-bier09 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-bier09.tst` test:  
