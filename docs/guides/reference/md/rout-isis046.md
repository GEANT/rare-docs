...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis046/rout-isis046.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis046](../clab/rout-isis046/rout-isis046.yml) file  
        3. Launch ContainerLab `rout-isis046.yml` topology:  

        ```
           containerlab deploy --topo rout-isis046.yml  
        ```
        4. Destroy ContainerLab `rout-isis046.yml` topology:  

        ```
           containerlab destroy --topo rout-isis046.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis046.tst` file [here](../tst/rout-isis046.tst)  
        3. Launch `rout-isis046.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis046 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis046.tst` test:  
