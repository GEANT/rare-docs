...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp028/rout-bgp028.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp028](../clab/rout-bgp028/rout-bgp028.yml) file  
        3. Launch ContainerLab `rout-bgp028.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp028.yml  
        ```
        4. Destroy ContainerLab `rout-bgp028.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp028.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp028.tst` file [here](../tst/rout-bgp028.tst)  
        3. Launch `rout-bgp028.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp028 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp028.tst` test:  
