# Example: p4lang: l3vpn over l2tp3 mpls

=== "Topology"

    ![Alt text](../d2/p4lang-rout254/p4lang-rout254.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout254](../clab/p4lang-rout254/p4lang-rout254.yml) file  
        3. Launch ContainerLab `p4lang-rout254.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout254.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout254.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout254.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout254.tst` file [here](../tst/p4lang-rout254.tst)  
        3. Launch `p4lang-rout254.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout254 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout254.tst` test:  
