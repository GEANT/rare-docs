...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp195/rout-bgp195.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp195](../clab/rout-bgp195/rout-bgp195.yml) file  
        3. Launch ContainerLab `rout-bgp195.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp195.yml  
        ```
        4. Destroy ContainerLab `rout-bgp195.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp195.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp195.tst` file [here](../tst/rout-bgp195.tst)  
        3. Launch `rout-bgp195.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp195 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp195.tst` test:  
