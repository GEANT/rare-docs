...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp006/rout-bgp006.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp006](../clab/rout-bgp006/rout-bgp006.yml) file  
        3. Launch ContainerLab `rout-bgp006.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp006.yml  
        ```
        4. Destroy ContainerLab `rout-bgp006.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp006.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp006.tst` file [here](../tst/rout-bgp006.tst)  
        3. Launch `rout-bgp006.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp006 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp006.tst` test:  
