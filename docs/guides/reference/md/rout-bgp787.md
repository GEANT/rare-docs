# Example: bgp routepolicy filtering with validity with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp787/rout-bgp787.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp787](../clab/rout-bgp787/rout-bgp787.yml) file  
        3. Launch ContainerLab `rout-bgp787.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp787.yml  
        ```
        4. Destroy ContainerLab `rout-bgp787.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp787.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp787.tst` file [here](../tst/rout-bgp787.tst)  
        3. Launch `rout-bgp787.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp787 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp787.tst` test:  
