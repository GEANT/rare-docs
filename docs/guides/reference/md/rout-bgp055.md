...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp055/rout-bgp055.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp055](../clab/rout-bgp055/rout-bgp055.yml) file  
        3. Launch ContainerLab `rout-bgp055.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp055.yml  
        ```
        4. Destroy ContainerLab `rout-bgp055.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp055.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp055.tst` file [here](../tst/rout-bgp055.tst)  
        3. Launch `rout-bgp055.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp055 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp055.tst` test:  
