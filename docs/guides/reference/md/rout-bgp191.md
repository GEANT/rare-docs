...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp191/rout-bgp191.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp191](../clab/rout-bgp191/rout-bgp191.yml) file  
        3. Launch ContainerLab `rout-bgp191.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp191.yml  
        ```
        4. Destroy ContainerLab `rout-bgp191.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp191.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp191.tst` file [here](../tst/rout-bgp191.tst)  
        3. Launch `rout-bgp191.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp191 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp191.tst` test:  
