...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp510/rout-bgp510.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp510](../clab/rout-bgp510/rout-bgp510.yml) file  
        3. Launch ContainerLab `rout-bgp510.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp510.yml  
        ```
        4. Destroy ContainerLab `rout-bgp510.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp510.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp510.tst` file [here](../tst/rout-bgp510.tst)  
        3. Launch `rout-bgp510.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp510 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp510.tst` test:  
