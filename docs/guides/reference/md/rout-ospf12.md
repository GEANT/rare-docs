...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf12/rout-ospf12.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf12](../clab/rout-ospf12/rout-ospf12.yml) file  
        3. Launch ContainerLab `rout-ospf12.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf12.yml  
        ```
        4. Destroy ContainerLab `rout-ospf12.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf12.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf12.tst` file [here](../tst/rout-ospf12.tst)  
        3. Launch `rout-ospf12.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf12 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf12.tst` test:  
