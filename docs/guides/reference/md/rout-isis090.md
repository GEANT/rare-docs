...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis090/rout-isis090.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis090](../clab/rout-isis090/rout-isis090.yml) file  
        3. Launch ContainerLab `rout-isis090.yml` topology:  

        ```
           containerlab deploy --topo rout-isis090.yml  
        ```
        4. Destroy ContainerLab `rout-isis090.yml` topology:  

        ```
           containerlab destroy --topo rout-isis090.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis090.tst` file [here](../tst/rout-isis090.tst)  
        3. Launch `rout-isis090.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis090 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis090.tst` test:  
