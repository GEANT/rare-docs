...
=== "Topology"
    ...
    ![Alt text](../d2/intop8-bgp05/intop8-bgp05.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [intop8-bgp05](../clab/intop8-bgp05/intop8-bgp05.yml) file  
        3. Launch ContainerLab `intop8-bgp05.yml` topology:  

        ```
           containerlab deploy --topo intop8-bgp05.yml  
        ```
        4. Destroy ContainerLab `intop8-bgp05.yml` topology:  

        ```
           containerlab destroy --topo intop8-bgp05.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `intop8-bgp05.tst` file [here](../tst/intop8-bgp05.tst)  
        3. Launch `intop8-bgp05.tst` test:  

        ```
           java -jar ../../rtr.jar test tester intop8-bgp05 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `intop8-bgp05.tst` test:  
