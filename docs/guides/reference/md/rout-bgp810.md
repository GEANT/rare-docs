# Example: l3otherevpns over ibgp rr

=== "Topology"

    ![Alt text](../d2/rout-bgp810/rout-bgp810.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp810](../clab/rout-bgp810/rout-bgp810.yml) file  
        3. Launch ContainerLab `rout-bgp810.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp810.yml  
        ```
        4. Destroy ContainerLab `rout-bgp810.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp810.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp810.tst` file [here](../tst/rout-bgp810.tst)  
        3. Launch `rout-bgp810.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp810 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp810.tst` test:  
