...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp25/rout-lsrp25.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp25](../clab/rout-lsrp25/rout-lsrp25.yml) file  
        3. Launch ContainerLab `rout-lsrp25.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp25.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp25.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp25.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp25.tst` file [here](../tst/rout-lsrp25.tst)  
        3. Launch `rout-lsrp25.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp25 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp25.tst` test:  
