...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt103/p4lang-crypt103.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt103](../clab/p4lang-crypt103/p4lang-crypt103.yml) file  
        3. Launch ContainerLab `p4lang-crypt103.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt103.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt103.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt103.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt103.tst` file [here](../tst/p4lang-crypt103.tst)  
        3. Launch `p4lang-crypt103.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt103 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt103.tst` test:  
