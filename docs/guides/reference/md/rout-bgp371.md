...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp371/rout-bgp371.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp371](../clab/rout-bgp371/rout-bgp371.yml) file  
        3. Launch ContainerLab `rout-bgp371.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp371.yml  
        ```
        4. Destroy ContainerLab `rout-bgp371.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp371.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp371.tst` file [here](../tst/rout-bgp371.tst)  
        3. Launch `rout-bgp371.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp371 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp371.tst` test:  
