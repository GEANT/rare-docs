# Example: ebgp with car

=== "Topology"

    ![Alt text](../d2/rout-bgp695/rout-bgp695.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp695](../clab/rout-bgp695/rout-bgp695.yml) file  
        3. Launch ContainerLab `rout-bgp695.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp695.yml  
        ```
        4. Destroy ContainerLab `rout-bgp695.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp695.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp695.tst` file [here](../tst/rout-bgp695.tst)  
        3. Launch `rout-bgp695.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp695 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp695.tst` test:  
