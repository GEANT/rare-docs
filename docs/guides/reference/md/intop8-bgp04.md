...
=== "Topology"
    ...
    ![Alt text](../d2/intop8-bgp04/intop8-bgp04.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [intop8-bgp04](../clab/intop8-bgp04/intop8-bgp04.yml) file  
        3. Launch ContainerLab `intop8-bgp04.yml` topology:  

        ```
           containerlab deploy --topo intop8-bgp04.yml  
        ```
        4. Destroy ContainerLab `intop8-bgp04.yml` topology:  

        ```
           containerlab destroy --topo intop8-bgp04.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `intop8-bgp04.tst` file [here](../tst/intop8-bgp04.tst)  
        3. Launch `intop8-bgp04.tst` test:  

        ```
           java -jar ../../rtr.jar test tester intop8-bgp04 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `intop8-bgp04.tst` test:  
