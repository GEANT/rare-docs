...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp286/rout-bgp286.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp286](../clab/rout-bgp286/rout-bgp286.yml) file  
        3. Launch ContainerLab `rout-bgp286.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp286.yml  
        ```
        4. Destroy ContainerLab `rout-bgp286.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp286.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp286.tst` file [here](../tst/rout-bgp286.tst)  
        3. Launch `rout-bgp286.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp286 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp286.tst` test:  
