...
=== "Topology"
    ...
    ![Alt text](../d2/rout-redist08/rout-redist08.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist08](../clab/rout-redist08/rout-redist08.yml) file  
        3. Launch ContainerLab `rout-redist08.yml` topology:  

        ```
           containerlab deploy --topo rout-redist08.yml  
        ```
        4. Destroy ContainerLab `rout-redist08.yml` topology:  

        ```
           containerlab destroy --topo rout-redist08.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist08.tst` file [here](../tst/rout-redist08.tst)  
        3. Launch `rout-redist08.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist08 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist08.tst` test:  
