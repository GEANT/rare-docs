...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt002/p4lang-crypt002.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt002](../clab/p4lang-crypt002/p4lang-crypt002.yml) file  
        3. Launch ContainerLab `p4lang-crypt002.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt002.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt002.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt002.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt002.tst` file [here](../tst/p4lang-crypt002.tst)  
        3. Launch `p4lang-crypt002.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt002 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt002.tst` test:  
