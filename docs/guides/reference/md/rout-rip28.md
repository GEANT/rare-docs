...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rip28/rout-rip28.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rip28](../clab/rout-rip28/rout-rip28.yml) file  
        3. Launch ContainerLab `rout-rip28.yml` topology:  

        ```
           containerlab deploy --topo rout-rip28.yml  
        ```
        4. Destroy ContainerLab `rout-rip28.yml` topology:  

        ```
           containerlab destroy --topo rout-rip28.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rip28.tst` file [here](../tst/rout-rip28.tst)  
        3. Launch `rout-rip28.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rip28 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rip28.tst` test:  
