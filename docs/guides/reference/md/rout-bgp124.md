...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp124/rout-bgp124.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp124](../clab/rout-bgp124/rout-bgp124.yml) file  
        3. Launch ContainerLab `rout-bgp124.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp124.yml  
        ```
        4. Destroy ContainerLab `rout-bgp124.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp124.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp124.tst` file [here](../tst/rout-bgp124.tst)  
        3. Launch `rout-bgp124.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp124 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp124.tst` test:  
