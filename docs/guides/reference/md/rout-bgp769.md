# Example: other car colors over bgp route server

=== "Topology"

    ![Alt text](../d2/rout-bgp769/rout-bgp769.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp769](../clab/rout-bgp769/rout-bgp769.yml) file  
        3. Launch ContainerLab `rout-bgp769.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp769.yml  
        ```
        4. Destroy ContainerLab `rout-bgp769.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp769.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp769.tst` file [here](../tst/rout-bgp769.tst)  
        3. Launch `rout-bgp769.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp769 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp769.tst` test:  
