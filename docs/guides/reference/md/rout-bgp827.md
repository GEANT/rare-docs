# Example: otherl3evpns with egress rtfilter

=== "Topology"

    ![Alt text](../d2/rout-bgp827/rout-bgp827.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp827](../clab/rout-bgp827/rout-bgp827.yml) file  
        3. Launch ContainerLab `rout-bgp827.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp827.yml  
        ```
        4. Destroy ContainerLab `rout-bgp827.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp827.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp827.tst` file [here](../tst/rout-bgp827.tst)  
        3. Launch `rout-bgp827.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp827 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp827.tst` test:  
