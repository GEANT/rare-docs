...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis037/rout-isis037.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis037](../clab/rout-isis037/rout-isis037.yml) file  
        3. Launch ContainerLab `rout-isis037.yml` topology:  

        ```
           containerlab deploy --topo rout-isis037.yml  
        ```
        4. Destroy ContainerLab `rout-isis037.yml` topology:  

        ```
           containerlab destroy --topo rout-isis037.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis037.tst` file [here](../tst/rout-isis037.tst)  
        3. Launch `rout-isis037.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis037 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis037.tst` test:  
