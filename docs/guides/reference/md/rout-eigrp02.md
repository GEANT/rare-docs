...
=== "Topology"
    ...
    ![Alt text](../d2/rout-eigrp02/rout-eigrp02.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-eigrp02](../clab/rout-eigrp02/rout-eigrp02.yml) file  
        3. Launch ContainerLab `rout-eigrp02.yml` topology:  

        ```
           containerlab deploy --topo rout-eigrp02.yml  
        ```
        4. Destroy ContainerLab `rout-eigrp02.yml` topology:  

        ```
           containerlab destroy --topo rout-eigrp02.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-eigrp02.tst` file [here](../tst/rout-eigrp02.tst)  
        3. Launch `rout-eigrp02.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-eigrp02 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-eigrp02.tst` test:  
