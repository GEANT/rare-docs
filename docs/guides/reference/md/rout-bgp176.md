...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp176/rout-bgp176.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp176](../clab/rout-bgp176/rout-bgp176.yml) file  
        3. Launch ContainerLab `rout-bgp176.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp176.yml  
        ```
        4. Destroy ContainerLab `rout-bgp176.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp176.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp176.tst` file [here](../tst/rout-bgp176.tst)  
        3. Launch `rout-bgp176.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp176 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp176.tst` test:  
