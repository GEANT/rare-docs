...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp255/rout-bgp255.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp255](../clab/rout-bgp255/rout-bgp255.yml) file  
        3. Launch ContainerLab `rout-bgp255.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp255.yml  
        ```
        4. Destroy ContainerLab `rout-bgp255.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp255.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp255.tst` file [here](../tst/rout-bgp255.tst)  
        3. Launch `rout-bgp255.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp255 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp255.tst` test:  
