...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp085/rout-bgp085.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp085](../clab/rout-bgp085/rout-bgp085.yml) file  
        3. Launch ContainerLab `rout-bgp085.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp085.yml  
        ```
        4. Destroy ContainerLab `rout-bgp085.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp085.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp085.tst` file [here](../tst/rout-bgp085.tst)  
        3. Launch `rout-bgp085.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp085 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp085.tst` test:  
