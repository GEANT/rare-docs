# Example: p4lang: sdwan over ipv4 with amt

=== "Topology"

    ![Alt text](../d2/p4lang-rout281/p4lang-rout281.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout281](../clab/p4lang-rout281/p4lang-rout281.yml) file  
        3. Launch ContainerLab `p4lang-rout281.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout281.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout281.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout281.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout281.tst` file [here](../tst/p4lang-rout281.tst)  
        3. Launch `p4lang-rout281.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout281 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout281.tst` test:  
