...
=== "Topology"
    ...
    ![Alt text](../d2/rout-olsr21/rout-olsr21.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-olsr21](../clab/rout-olsr21/rout-olsr21.yml) file  
        3. Launch ContainerLab `rout-olsr21.yml` topology:  

        ```
           containerlab deploy --topo rout-olsr21.yml  
        ```
        4. Destroy ContainerLab `rout-olsr21.yml` topology:  

        ```
           containerlab destroy --topo rout-olsr21.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-olsr21.tst` file [here](../tst/rout-olsr21.tst)  
        3. Launch `rout-olsr21.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-olsr21 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-olsr21.tst` test:  
