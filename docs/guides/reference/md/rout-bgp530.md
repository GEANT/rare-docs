...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp530/rout-bgp530.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp530](../clab/rout-bgp530/rout-bgp530.yml) file  
        3. Launch ContainerLab `rout-bgp530.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp530.yml  
        ```
        4. Destroy ContainerLab `rout-bgp530.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp530.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp530.tst` file [here](../tst/rout-bgp530.tst)  
        3. Launch `rout-bgp530.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp530 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp530.tst` test:  
