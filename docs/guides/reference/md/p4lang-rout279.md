# Example: p4lang: sdwan over ipv4 with gre

=== "Topology"

    ![Alt text](../d2/p4lang-rout279/p4lang-rout279.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout279](../clab/p4lang-rout279/p4lang-rout279.yml) file  
        3. Launch ContainerLab `p4lang-rout279.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout279.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout279.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout279.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout279.tst` file [here](../tst/p4lang-rout279.tst)  
        3. Launch `p4lang-rout279.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout279 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout279.tst` test:  
