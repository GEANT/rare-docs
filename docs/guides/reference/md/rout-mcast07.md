...
=== "Topology"
    ...
    ![Alt text](../d2/rout-mcast07/rout-mcast07.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-mcast07](../clab/rout-mcast07/rout-mcast07.yml) file  
        3. Launch ContainerLab `rout-mcast07.yml` topology:  

        ```
           containerlab deploy --topo rout-mcast07.yml  
        ```
        4. Destroy ContainerLab `rout-mcast07.yml` topology:  

        ```
           containerlab destroy --topo rout-mcast07.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-mcast07.tst` file [here](../tst/rout-mcast07.tst)  
        3. Launch `rout-mcast07.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-mcast07 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-mcast07.tst` test:  
