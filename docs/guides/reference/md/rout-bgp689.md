# Example: bgp interas vpn with multiple labels

=== "Topology"

    ![Alt text](../d2/rout-bgp689/rout-bgp689.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp689](../clab/rout-bgp689/rout-bgp689.yml) file  
        3. Launch ContainerLab `rout-bgp689.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp689.yml  
        ```
        4. Destroy ContainerLab `rout-bgp689.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp689.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp689.tst` file [here](../tst/rout-bgp689.tst)  
        3. Launch `rout-bgp689.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp689 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp689.tst` test:  
