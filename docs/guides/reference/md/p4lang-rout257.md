# Example: p4lang: l2tp3 routing over vlan

=== "Topology"

    ![Alt text](../d2/p4lang-rout257/p4lang-rout257.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout257](../clab/p4lang-rout257/p4lang-rout257.yml) file  
        3. Launch ContainerLab `p4lang-rout257.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout257.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout257.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout257.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout257.tst` file [here](../tst/p4lang-rout257.tst)  
        3. Launch `p4lang-rout257.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout257 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout257.tst` test:  
