...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp506/rout-bgp506.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp506](../clab/rout-bgp506/rout-bgp506.yml) file  
        3. Launch ContainerLab `rout-bgp506.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp506.yml  
        ```
        4. Destroy ContainerLab `rout-bgp506.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp506.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp506.tst` file [here](../tst/rout-bgp506.tst)  
        3. Launch `rout-bgp506.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp506 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp506.tst` test:  
