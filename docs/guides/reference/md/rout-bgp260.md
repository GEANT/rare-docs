...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp260/rout-bgp260.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp260](../clab/rout-bgp260/rout-bgp260.yml) file  
        3. Launch ContainerLab `rout-bgp260.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp260.yml  
        ```
        4. Destroy ContainerLab `rout-bgp260.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp260.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp260.tst` file [here](../tst/rout-bgp260.tst)  
        3. Launch `rout-bgp260.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp260 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp260.tst` test:  
