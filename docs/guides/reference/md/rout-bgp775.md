# Example: ibgp with any remote

=== "Topology"

    ![Alt text](../d2/rout-bgp775/rout-bgp775.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp775](../clab/rout-bgp775/rout-bgp775.yml) file  
        3. Launch ContainerLab `rout-bgp775.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp775.yml  
        ```
        4. Destroy ContainerLab `rout-bgp775.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp775.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp775.tst` file [here](../tst/rout-bgp775.tst)  
        3. Launch `rout-bgp775.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp775 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp775.tst` test:  
