...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis014/rout-isis014.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis014](../clab/rout-isis014/rout-isis014.yml) file  
        3. Launch ContainerLab `rout-isis014.yml` topology:  

        ```
           containerlab deploy --topo rout-isis014.yml  
        ```
        4. Destroy ContainerLab `rout-isis014.yml` topology:  

        ```
           containerlab destroy --topo rout-isis014.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis014.tst` file [here](../tst/rout-isis014.tst)  
        3. Launch `rout-isis014.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis014 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis014.tst` test:  
