# Example: l3evpns over ebgp

=== "Topology"

    ![Alt text](../d2/rout-bgp800/rout-bgp800.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp800](../clab/rout-bgp800/rout-bgp800.yml) file  
        3. Launch ContainerLab `rout-bgp800.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp800.yml  
        ```
        4. Destroy ContainerLab `rout-bgp800.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp800.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp800.tst` file [here](../tst/rout-bgp800.tst)  
        3. Launch `rout-bgp800.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp800 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp800.tst` test:  
