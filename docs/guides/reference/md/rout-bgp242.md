...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp242/rout-bgp242.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp242](../clab/rout-bgp242/rout-bgp242.yml) file  
        3. Launch ContainerLab `rout-bgp242.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp242.yml  
        ```
        4. Destroy ContainerLab `rout-bgp242.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp242.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp242.tst` file [here](../tst/rout-bgp242.tst)  
        3. Launch `rout-bgp242.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp242 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp242.tst` test:  
