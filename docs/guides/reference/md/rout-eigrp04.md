...
=== "Topology"
    ...
    ![Alt text](../d2/rout-eigrp04/rout-eigrp04.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-eigrp04](../clab/rout-eigrp04/rout-eigrp04.yml) file  
        3. Launch ContainerLab `rout-eigrp04.yml` topology:  

        ```
           containerlab deploy --topo rout-eigrp04.yml  
        ```
        4. Destroy ContainerLab `rout-eigrp04.yml` topology:  

        ```
           containerlab destroy --topo rout-eigrp04.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-eigrp04.tst` file [here](../tst/rout-eigrp04.tst)  
        3. Launch `rout-eigrp04.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-eigrp04 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-eigrp04.tst` test:  
