...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout090/p4lang-rout090.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout090](../clab/p4lang-rout090/p4lang-rout090.yml) file  
        3. Launch ContainerLab `p4lang-rout090.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout090.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout090.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout090.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout090.tst` file [here](../tst/p4lang-rout090.tst)  
        3. Launch `p4lang-rout090.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout090 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout090.tst` test:  
