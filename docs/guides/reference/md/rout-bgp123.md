...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp123/rout-bgp123.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp123](../clab/rout-bgp123/rout-bgp123.yml) file  
        3. Launch ContainerLab `rout-bgp123.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp123.yml  
        ```
        4. Destroy ContainerLab `rout-bgp123.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp123.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp123.tst` file [here](../tst/rout-bgp123.tst)  
        3. Launch `rout-bgp123.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp123 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp123.tst` test:  
