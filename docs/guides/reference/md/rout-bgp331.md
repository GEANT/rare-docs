...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp331/rout-bgp331.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp331](../clab/rout-bgp331/rout-bgp331.yml) file  
        3. Launch ContainerLab `rout-bgp331.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp331.yml  
        ```
        4. Destroy ContainerLab `rout-bgp331.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp331.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp331.tst` file [here](../tst/rout-bgp331.tst)  
        3. Launch `rout-bgp331.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp331 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp331.tst` test:  
