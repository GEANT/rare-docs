# Example: l3eothervpns over ibgp

=== "Topology"

    ![Alt text](../d2/rout-bgp809/rout-bgp809.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp809](../clab/rout-bgp809/rout-bgp809.yml) file  
        3. Launch ContainerLab `rout-bgp809.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp809.yml  
        ```
        4. Destroy ContainerLab `rout-bgp809.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp809.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp809.tst` file [here](../tst/rout-bgp809.tst)  
        3. Launch `rout-bgp809.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp809 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp809.tst` test:  
