# Example: l3evpns egress route filtering with routemap

=== "Topology"

    ![Alt text](../d2/rout-bgp833/rout-bgp833.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp833](../clab/rout-bgp833/rout-bgp833.yml) file  
        3. Launch ContainerLab `rout-bgp833.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp833.yml  
        ```
        4. Destroy ContainerLab `rout-bgp833.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp833.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp833.tst` file [here](../tst/rout-bgp833.tst)  
        3. Launch `rout-bgp833.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp833 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp833.tst` test:  
