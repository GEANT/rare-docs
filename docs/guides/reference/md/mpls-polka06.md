...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-polka06/mpls-polka06.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-polka06](../clab/mpls-polka06/mpls-polka06.yml) file  
        3. Launch ContainerLab `mpls-polka06.yml` topology:  

        ```
           containerlab deploy --topo mpls-polka06.yml  
        ```
        4. Destroy ContainerLab `mpls-polka06.yml` topology:  

        ```
           containerlab destroy --topo mpls-polka06.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-polka06.tst` file [here](../tst/mpls-polka06.tst)  
        3. Launch `mpls-polka06.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-polka06 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-polka06.tst` test:  
