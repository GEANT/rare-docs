...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp548/rout-bgp548.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp548](../clab/rout-bgp548/rout-bgp548.yml) file  
        3. Launch ContainerLab `rout-bgp548.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp548.yml  
        ```
        4. Destroy ContainerLab `rout-bgp548.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp548.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp548.tst` file [here](../tst/rout-bgp548.tst)  
        3. Launch `rout-bgp548.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp548 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp548.tst` test:  
