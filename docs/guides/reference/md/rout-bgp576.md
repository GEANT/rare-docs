...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp576/rout-bgp576.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp576](../clab/rout-bgp576/rout-bgp576.yml) file  
        3. Launch ContainerLab `rout-bgp576.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp576.yml  
        ```
        4. Destroy ContainerLab `rout-bgp576.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp576.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp576.tst` file [here](../tst/rout-bgp576.tst)  
        3. Launch `rout-bgp576.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp576 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp576.tst` test:  
