...
=== "Topology"
    ...
    ![Alt text](../d2/intop9-ldp03/intop9-ldp03.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [intop9-ldp03](../clab/intop9-ldp03/intop9-ldp03.yml) file  
        3. Launch ContainerLab `intop9-ldp03.yml` topology:  

        ```
           containerlab deploy --topo intop9-ldp03.yml  
        ```
        4. Destroy ContainerLab `intop9-ldp03.yml` topology:  

        ```
           containerlab destroy --topo intop9-ldp03.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `intop9-ldp03.tst` file [here](../tst/intop9-ldp03.tst)  
        3. Launch `intop9-ldp03.tst` test:  

        ```
           java -jar ../../rtr.jar test tester intop9-ldp03 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `intop9-ldp03.tst` test:  
