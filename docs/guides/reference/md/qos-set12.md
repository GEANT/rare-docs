...
=== "Topology"
    ...
    ![Alt text](../d2/qos-set12/qos-set12.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [qos-set12](../clab/qos-set12/qos-set12.yml) file  
        3. Launch ContainerLab `qos-set12.yml` topology:  

        ```
           containerlab deploy --topo qos-set12.yml  
        ```
        4. Destroy ContainerLab `qos-set12.yml` topology:  

        ```
           containerlab destroy --topo qos-set12.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `qos-set12.tst` file [here](../tst/qos-set12.tst)  
        3. Launch `qos-set12.tst` test:  

        ```
           java -jar ../../rtr.jar test tester qos-set12 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `qos-set12.tst` test:  
