...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf36/rout-ospf36.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf36](../clab/rout-ospf36/rout-ospf36.yml) file  
        3. Launch ContainerLab `rout-ospf36.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf36.yml  
        ```
        4. Destroy ContainerLab `rout-ospf36.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf36.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf36.tst` file [here](../tst/rout-ospf36.tst)  
        3. Launch `rout-ospf36.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf36 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf36.tst` test:  
