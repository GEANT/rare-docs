# Example: l3evpns over ibgp rr

=== "Topology"

    ![Alt text](../d2/rout-bgp802/rout-bgp802.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp802](../clab/rout-bgp802/rout-bgp802.yml) file  
        3. Launch ContainerLab `rout-bgp802.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp802.yml  
        ```
        4. Destroy ContainerLab `rout-bgp802.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp802.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp802.tst` file [here](../tst/rout-bgp802.tst)  
        3. Launch `rout-bgp802.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp802 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp802.tst` test:  
