...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf04/rout-ospf04.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf04](../clab/rout-ospf04/rout-ospf04.yml) file  
        3. Launch ContainerLab `rout-ospf04.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf04.yml  
        ```
        4. Destroy ContainerLab `rout-ospf04.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf04.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf04.tst` file [here](../tst/rout-ospf04.tst)  
        3. Launch `rout-ospf04.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf04 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf04.tst` test:  
