...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rip04/rout-rip04.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rip04](../clab/rout-rip04/rout-rip04.yml) file  
        3. Launch ContainerLab `rout-rip04.yml` topology:  

        ```
           containerlab deploy --topo rout-rip04.yml  
        ```
        4. Destroy ContainerLab `rout-rip04.yml` topology:  

        ```
           containerlab destroy --topo rout-rip04.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rip04.tst` file [here](../tst/rout-rip04.tst)  
        3. Launch `rout-rip04.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rip04 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rip04.tst` test:  
