# Example: other car colors over ibgp rr

=== "Topology"

    ![Alt text](../d2/rout-bgp765/rout-bgp765.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp765](../clab/rout-bgp765/rout-bgp765.yml) file  
        3. Launch ContainerLab `rout-bgp765.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp765.yml  
        ```
        4. Destroy ContainerLab `rout-bgp765.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp765.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp765.tst` file [here](../tst/rout-bgp765.tst)  
        3. Launch `rout-bgp765.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp765 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp765.tst` test:  
