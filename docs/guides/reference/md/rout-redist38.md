# Example: redistribution filtering with accesslist in routepolicy

=== "Topology"

    ![Alt text](../d2/rout-redist38/rout-redist38.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist38](../clab/rout-redist38/rout-redist38.yml) file  
        3. Launch ContainerLab `rout-redist38.yml` topology:  

        ```
           containerlab deploy --topo rout-redist38.yml  
        ```
        4. Destroy ContainerLab `rout-redist38.yml` topology:  

        ```
           containerlab destroy --topo rout-redist38.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist38.tst` file [here](../tst/rout-redist38.tst)  
        3. Launch `rout-redist38.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist38 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist38.tst` test:  
