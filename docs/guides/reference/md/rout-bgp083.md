...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp083/rout-bgp083.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp083](../clab/rout-bgp083/rout-bgp083.yml) file  
        3. Launch ContainerLab `rout-bgp083.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp083.yml  
        ```
        4. Destroy ContainerLab `rout-bgp083.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp083.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp083.tst` file [here](../tst/rout-bgp083.tst)  
        3. Launch `rout-bgp083.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp083 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp083.tst` test:  
