...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp310/rout-bgp310.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp310](../clab/rout-bgp310/rout-bgp310.yml) file  
        3. Launch ContainerLab `rout-bgp310.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp310.yml  
        ```
        4. Destroy ContainerLab `rout-bgp310.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp310.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp310.tst` file [here](../tst/rout-bgp310.tst)  
        3. Launch `rout-bgp310.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp310 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp310.tst` test:  
