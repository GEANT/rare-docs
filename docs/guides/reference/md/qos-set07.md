...
=== "Topology"
    ...
    ![Alt text](../d2/qos-set07/qos-set07.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [qos-set07](../clab/qos-set07/qos-set07.yml) file  
        3. Launch ContainerLab `qos-set07.yml` topology:  

        ```
           containerlab deploy --topo qos-set07.yml  
        ```
        4. Destroy ContainerLab `qos-set07.yml` topology:  

        ```
           containerlab destroy --topo qos-set07.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `qos-set07.tst` file [here](../tst/qos-set07.tst)  
        3. Launch `qos-set07.tst` test:  

        ```
           java -jar ../../rtr.jar test tester qos-set07 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `qos-set07.tst` test:  
