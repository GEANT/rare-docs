...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-bier12/mpls-bier12.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-bier12](../clab/mpls-bier12/mpls-bier12.yml) file  
        3. Launch ContainerLab `mpls-bier12.yml` topology:  

        ```
           containerlab deploy --topo mpls-bier12.yml  
        ```
        4. Destroy ContainerLab `mpls-bier12.yml` topology:  

        ```
           containerlab destroy --topo mpls-bier12.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-bier12.tst` file [here](../tst/mpls-bier12.tst)  
        3. Launch `mpls-bier12.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-bier12 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-bier12.tst` test:  
