...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp02/rout-lsrp02.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp02](../clab/rout-lsrp02/rout-lsrp02.yml) file  
        3. Launch ContainerLab `rout-lsrp02.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp02.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp02.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp02.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp02.tst` file [here](../tst/rout-lsrp02.tst)  
        3. Launch `rout-lsrp02.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp02 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp02.tst` test:  
