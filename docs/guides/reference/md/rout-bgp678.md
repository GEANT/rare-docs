# Example: ctp colors over bgp route server

=== "Topology"

    ![Alt text](../d2/rout-bgp678/rout-bgp678.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp678](../clab/rout-bgp678/rout-bgp678.yml) file  
        3. Launch ContainerLab `rout-bgp678.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp678.yml  
        ```
        4. Destroy ContainerLab `rout-bgp678.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp678.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp678.tst` file [here](../tst/rout-bgp678.tst)  
        3. Launch `rout-bgp678.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp678 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp678.tst` test:  
