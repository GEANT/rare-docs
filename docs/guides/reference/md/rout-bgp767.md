# Example: other car colors over confed bgp

=== "Topology"

    ![Alt text](../d2/rout-bgp767/rout-bgp767.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp767](../clab/rout-bgp767/rout-bgp767.yml) file  
        3. Launch ContainerLab `rout-bgp767.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp767.yml  
        ```
        4. Destroy ContainerLab `rout-bgp767.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp767.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp767.tst` file [here](../tst/rout-bgp767.tst)  
        3. Launch `rout-bgp767.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp767 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp767.tst` test:  
