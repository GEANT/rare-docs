...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp165/rout-bgp165.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp165](../clab/rout-bgp165/rout-bgp165.yml) file  
        3. Launch ContainerLab `rout-bgp165.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp165.yml  
        ```
        4. Destroy ContainerLab `rout-bgp165.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp165.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp165.tst` file [here](../tst/rout-bgp165.tst)  
        3. Launch `rout-bgp165.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp165 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp165.tst` test:  
