...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis091/rout-isis091.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis091](../clab/rout-isis091/rout-isis091.yml) file  
        3. Launch ContainerLab `rout-isis091.yml` topology:  

        ```
           containerlab deploy --topo rout-isis091.yml  
        ```
        4. Destroy ContainerLab `rout-isis091.yml` topology:  

        ```
           containerlab destroy --topo rout-isis091.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis091.tst` file [here](../tst/rout-isis091.tst)  
        3. Launch `rout-isis091.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis091 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis091.tst` test:  
