...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp517/rout-bgp517.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp517](../clab/rout-bgp517/rout-bgp517.yml) file  
        3. Launch ContainerLab `rout-bgp517.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp517.yml  
        ```
        4. Destroy ContainerLab `rout-bgp517.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp517.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp517.tst` file [here](../tst/rout-bgp517.tst)  
        3. Launch `rout-bgp517.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp517 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp517.tst` test:  
