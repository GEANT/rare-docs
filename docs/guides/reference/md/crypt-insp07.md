...
=== "Topology"
    ...
    ![Alt text](../d2/crypt-insp07/crypt-insp07.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [crypt-insp07](../clab/crypt-insp07/crypt-insp07.yml) file  
        3. Launch ContainerLab `crypt-insp07.yml` topology:  

        ```
           containerlab deploy --topo crypt-insp07.yml  
        ```
        4. Destroy ContainerLab `crypt-insp07.yml` topology:  

        ```
           containerlab destroy --topo crypt-insp07.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `crypt-insp07.tst` file [here](../tst/crypt-insp07.tst)  
        3. Launch `crypt-insp07.tst` test:  

        ```
           java -jar ../../rtr.jar test tester crypt-insp07 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `crypt-insp07.tst` test:  
