# Example: ctp colors over bgp additional path

=== "Topology"

    ![Alt text](../d2/rout-bgp672/rout-bgp672.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp672](../clab/rout-bgp672/rout-bgp672.yml) file  
        3. Launch ContainerLab `rout-bgp672.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp672.yml  
        ```
        4. Destroy ContainerLab `rout-bgp672.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp672.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp672.tst` file [here](../tst/rout-bgp672.tst)  
        3. Launch `rout-bgp672.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp672 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp672.tst` test:  
