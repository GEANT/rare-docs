# Example: ibgp rr prefix withdraw with ctp

=== "Topology"

    ![Alt text](../d2/rout-bgp631/rout-bgp631.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp631](../clab/rout-bgp631/rout-bgp631.yml) file  
        3. Launch ContainerLab `rout-bgp631.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp631.yml  
        ```
        4. Destroy ContainerLab `rout-bgp631.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp631.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp631.tst` file [here](../tst/rout-bgp631.tst)  
        3. Launch `rout-bgp631.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp631 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp631.tst` test:  
