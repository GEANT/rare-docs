# Example: bgp change in leak-role

=== "Topology"

    ![Alt text](../d2/rout-bgp790/rout-bgp790.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp790](../clab/rout-bgp790/rout-bgp790.yml) file  
        3. Launch ContainerLab `rout-bgp790.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp790.yml  
        ```
        4. Destroy ContainerLab `rout-bgp790.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp790.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp790.tst` file [here](../tst/rout-bgp790.tst)  
        3. Launch `rout-bgp790.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp790 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp790.tst` test:  
