...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp497/rout-bgp497.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp497](../clab/rout-bgp497/rout-bgp497.yml) file  
        3. Launch ContainerLab `rout-bgp497.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp497.yml  
        ```
        4. Destroy ContainerLab `rout-bgp497.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp497.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp497.tst` file [here](../tst/rout-bgp497.tst)  
        3. Launch `rout-bgp497.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp497 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp497.tst` test:  
