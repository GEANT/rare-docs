# Example: p4lang: l2tp3 mpls over ipv6 loopback

=== "Topology"

    ![Alt text](../d2/p4lang-rout270/p4lang-rout270.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout270](../clab/p4lang-rout270/p4lang-rout270.yml) file  
        3. Launch ContainerLab `p4lang-rout270.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout270.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout270.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout270.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout270.tst` file [here](../tst/p4lang-rout270.tst)  
        3. Launch `p4lang-rout270.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout270 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout270.tst` test:  
