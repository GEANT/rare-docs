# Example: redistribution filtering with routemap in routepolicy

=== "Topology"

    ![Alt text](../d2/rout-redist40/rout-redist40.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist40](../clab/rout-redist40/rout-redist40.yml) file  
        3. Launch ContainerLab `rout-redist40.yml` topology:  

        ```
           containerlab deploy --topo rout-redist40.yml  
        ```
        4. Destroy ContainerLab `rout-redist40.yml` topology:  

        ```
           containerlab destroy --topo rout-redist40.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist40.tst` file [here](../tst/rout-redist40.tst)  
        3. Launch `rout-redist40.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist40 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist40.tst` test:  
