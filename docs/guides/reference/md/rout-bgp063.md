...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp063/rout-bgp063.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp063](../clab/rout-bgp063/rout-bgp063.yml) file  
        3. Launch ContainerLab `rout-bgp063.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp063.yml  
        ```
        4. Destroy ContainerLab `rout-bgp063.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp063.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp063.tst` file [here](../tst/rout-bgp063.tst)  
        3. Launch `rout-bgp063.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp063 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp063.tst` test:  
