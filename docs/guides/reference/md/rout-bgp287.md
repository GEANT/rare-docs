...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp287/rout-bgp287.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp287](../clab/rout-bgp287/rout-bgp287.yml) file  
        3. Launch ContainerLab `rout-bgp287.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp287.yml  
        ```
        4. Destroy ContainerLab `rout-bgp287.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp287.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp287.tst` file [here](../tst/rout-bgp287.tst)  
        3. Launch `rout-bgp287.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp287 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp287.tst` test:  
