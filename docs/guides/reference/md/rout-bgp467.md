...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp467/rout-bgp467.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp467](../clab/rout-bgp467/rout-bgp467.yml) file  
        3. Launch ContainerLab `rout-bgp467.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp467.yml  
        ```
        4. Destroy ContainerLab `rout-bgp467.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp467.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp467.tst` file [here](../tst/rout-bgp467.tst)  
        3. Launch `rout-bgp467.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp467 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp467.tst` test:  
