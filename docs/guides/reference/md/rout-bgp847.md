# Example: otherl3evpns egress route filtering with routepolicy with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp847/rout-bgp847.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp847](../clab/rout-bgp847/rout-bgp847.yml) file  
        3. Launch ContainerLab `rout-bgp847.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp847.yml  
        ```
        4. Destroy ContainerLab `rout-bgp847.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp847.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp847.tst` file [here](../tst/rout-bgp847.tst)  
        3. Launch `rout-bgp847.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp847 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp847.tst` test:  
