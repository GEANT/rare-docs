...
=== "Topology"
    ...
    ![Alt text](../d2/rout-babel17/rout-babel17.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-babel17](../clab/rout-babel17/rout-babel17.yml) file  
        3. Launch ContainerLab `rout-babel17.yml` topology:  

        ```
           containerlab deploy --topo rout-babel17.yml  
        ```
        4. Destroy ContainerLab `rout-babel17.yml` topology:  

        ```
           containerlab destroy --topo rout-babel17.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-babel17.tst` file [here](../tst/rout-babel17.tst)  
        3. Launch `rout-babel17.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-babel17 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-babel17.tst` test:  
