# Example: ocar ibgp rr prefix withdraw

=== "Topology"

    ![Alt text](../d2/rout-bgp752/rout-bgp752.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp752](../clab/rout-bgp752/rout-bgp752.yml) file  
        3. Launch ContainerLab `rout-bgp752.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp752.yml  
        ```
        4. Destroy ContainerLab `rout-bgp752.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp752.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp752.tst` file [here](../tst/rout-bgp752.tst)  
        3. Launch `rout-bgp752.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp752 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp752.tst` test:  
