...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf09/rout-ospf09.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf09](../clab/rout-ospf09/rout-ospf09.yml) file  
        3. Launch ContainerLab `rout-ospf09.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf09.yml  
        ```
        4. Destroy ContainerLab `rout-ospf09.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf09.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf09.tst` file [here](../tst/rout-ospf09.tst)  
        3. Launch `rout-ospf09.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf09 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf09.tst` test:  
