...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis028/rout-isis028.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis028](../clab/rout-isis028/rout-isis028.yml) file  
        3. Launch ContainerLab `rout-isis028.yml` topology:  

        ```
           containerlab deploy --topo rout-isis028.yml  
        ```
        4. Destroy ContainerLab `rout-isis028.yml` topology:  

        ```
           containerlab destroy --topo rout-isis028.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis028.tst` file [here](../tst/rout-isis028.tst)  
        3. Launch `rout-isis028.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis028 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis028.tst` test:  
