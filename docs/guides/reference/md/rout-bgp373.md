...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp373/rout-bgp373.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp373](../clab/rout-bgp373/rout-bgp373.yml) file  
        3. Launch ContainerLab `rout-bgp373.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp373.yml  
        ```
        4. Destroy ContainerLab `rout-bgp373.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp373.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp373.tst` file [here](../tst/rout-bgp373.tst)  
        3. Launch `rout-bgp373.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp373 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp373.tst` test:  
