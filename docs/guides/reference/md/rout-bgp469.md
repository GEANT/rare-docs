...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp469/rout-bgp469.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp469](../clab/rout-bgp469/rout-bgp469.yml) file  
        3. Launch ContainerLab `rout-bgp469.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp469.yml  
        ```
        4. Destroy ContainerLab `rout-bgp469.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp469.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp469.tst` file [here](../tst/rout-bgp469.tst)  
        3. Launch `rout-bgp469.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp469 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp469.tst` test:  
