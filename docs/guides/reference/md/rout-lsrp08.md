...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp08/rout-lsrp08.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp08](../clab/rout-lsrp08/rout-lsrp08.yml) file  
        3. Launch ContainerLab `rout-lsrp08.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp08.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp08.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp08.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp08.tst` file [here](../tst/rout-lsrp08.tst)  
        3. Launch `rout-lsrp08.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp08 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp08.tst` test:  
