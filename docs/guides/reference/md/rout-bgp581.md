...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp581/rout-bgp581.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp581](../clab/rout-bgp581/rout-bgp581.yml) file  
        3. Launch ContainerLab `rout-bgp581.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp581.yml  
        ```
        4. Destroy ContainerLab `rout-bgp581.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp581.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp581.tst` file [here](../tst/rout-bgp581.tst)  
        3. Launch `rout-bgp581.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp581 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp581.tst` test:  
