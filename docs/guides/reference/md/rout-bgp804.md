# Example: l3evpns over bgp route server

=== "Topology"

    ![Alt text](../d2/rout-bgp804/rout-bgp804.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp804](../clab/rout-bgp804/rout-bgp804.yml) file  
        3. Launch ContainerLab `rout-bgp804.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp804.yml  
        ```
        4. Destroy ContainerLab `rout-bgp804.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp804.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp804.tst` file [here](../tst/rout-bgp804.tst)  
        3. Launch `rout-bgp804.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp804 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp804.tst` test:  
