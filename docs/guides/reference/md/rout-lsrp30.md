...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp30/rout-lsrp30.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp30](../clab/rout-lsrp30/rout-lsrp30.yml) file  
        3. Launch ContainerLab `rout-lsrp30.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp30.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp30.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp30.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp30.tst` file [here](../tst/rout-lsrp30.tst)  
        3. Launch `rout-lsrp30.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp30 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp30.tst` test:  
