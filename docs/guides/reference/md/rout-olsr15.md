...
=== "Topology"
    ...
    ![Alt text](../d2/rout-olsr15/rout-olsr15.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-olsr15](../clab/rout-olsr15/rout-olsr15.yml) file  
        3. Launch ContainerLab `rout-olsr15.yml` topology:  

        ```
           containerlab deploy --topo rout-olsr15.yml  
        ```
        4. Destroy ContainerLab `rout-olsr15.yml` topology:  

        ```
           containerlab destroy --topo rout-olsr15.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-olsr15.tst` file [here](../tst/rout-olsr15.tst)  
        3. Launch `rout-olsr15.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-olsr15 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-olsr15.tst` test:  
