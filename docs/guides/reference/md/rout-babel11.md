...
=== "Topology"
    ...
    ![Alt text](../d2/rout-babel11/rout-babel11.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-babel11](../clab/rout-babel11/rout-babel11.yml) file  
        3. Launch ContainerLab `rout-babel11.yml` topology:  

        ```
           containerlab deploy --topo rout-babel11.yml  
        ```
        4. Destroy ContainerLab `rout-babel11.yml` topology:  

        ```
           containerlab destroy --topo rout-babel11.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-babel11.tst` file [here](../tst/rout-babel11.tst)  
        3. Launch `rout-babel11.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-babel11 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-babel11.tst` test:  
