...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-acl052/p4lang-acl052.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl052](../clab/p4lang-acl052/p4lang-acl052.yml) file  
        3. Launch ContainerLab `p4lang-acl052.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl052.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl052.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl052.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl052.tst` file [here](../tst/p4lang-acl052.tst)  
        3. Launch `p4lang-acl052.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl052 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl052.tst` test:  
