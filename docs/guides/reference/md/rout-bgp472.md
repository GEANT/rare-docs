...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp472/rout-bgp472.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp472](../clab/rout-bgp472/rout-bgp472.yml) file  
        3. Launch ContainerLab `rout-bgp472.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp472.yml  
        ```
        4. Destroy ContainerLab `rout-bgp472.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp472.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp472.tst` file [here](../tst/rout-bgp472.tst)  
        3. Launch `rout-bgp472.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp472 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp472.tst` test:  
