...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout117/p4lang-rout117.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout117](../clab/p4lang-rout117/p4lang-rout117.yml) file  
        3. Launch ContainerLab `p4lang-rout117.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout117.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout117.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout117.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout117.tst` file [here](../tst/p4lang-rout117.tst)  
        3. Launch `p4lang-rout117.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout117 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout117.tst` test:  
