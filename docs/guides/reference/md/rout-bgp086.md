...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp086/rout-bgp086.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp086](../clab/rout-bgp086/rout-bgp086.yml) file  
        3. Launch ContainerLab `rout-bgp086.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp086.yml  
        ```
        4. Destroy ContainerLab `rout-bgp086.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp086.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp086.tst` file [here](../tst/rout-bgp086.tst)  
        3. Launch `rout-bgp086.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp086 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp086.tst` test:  
