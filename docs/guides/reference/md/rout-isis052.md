...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis052/rout-isis052.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis052](../clab/rout-isis052/rout-isis052.yml) file  
        3. Launch ContainerLab `rout-isis052.yml` topology:  

        ```
           containerlab deploy --topo rout-isis052.yml  
        ```
        4. Destroy ContainerLab `rout-isis052.yml` topology:  

        ```
           containerlab destroy --topo rout-isis052.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis052.tst` file [here](../tst/rout-isis052.tst)  
        3. Launch `rout-isis052.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis052 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis052.tst` test:  
