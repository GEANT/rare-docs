...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp460/rout-bgp460.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp460](../clab/rout-bgp460/rout-bgp460.yml) file  
        3. Launch ContainerLab `rout-bgp460.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp460.yml  
        ```
        4. Destroy ContainerLab `rout-bgp460.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp460.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp460.tst` file [here](../tst/rout-bgp460.tst)  
        3. Launch `rout-bgp460.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp460 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp460.tst` test:  
