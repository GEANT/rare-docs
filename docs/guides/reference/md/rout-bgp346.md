...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp346/rout-bgp346.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp346](../clab/rout-bgp346/rout-bgp346.yml) file  
        3. Launch ContainerLab `rout-bgp346.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp346.yml  
        ```
        4. Destroy ContainerLab `rout-bgp346.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp346.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp346.tst` file [here](../tst/rout-bgp346.tst)  
        3. Launch `rout-bgp346.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp346 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp346.tst` test:  
