...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp423/rout-bgp423.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp423](../clab/rout-bgp423/rout-bgp423.yml) file  
        3. Launch ContainerLab `rout-bgp423.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp423.yml  
        ```
        4. Destroy ContainerLab `rout-bgp423.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp423.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp423.tst` file [here](../tst/rout-bgp423.tst)  
        3. Launch `rout-bgp423.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp423 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp423.tst` test:  
