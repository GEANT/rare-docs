...
=== "Topology"
    ...
    ![Alt text](../d2/crypt-acl46/crypt-acl46.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [crypt-acl46](../clab/crypt-acl46/crypt-acl46.yml) file  
        3. Launch ContainerLab `crypt-acl46.yml` topology:  

        ```
           containerlab deploy --topo crypt-acl46.yml  
        ```
        4. Destroy ContainerLab `crypt-acl46.yml` topology:  

        ```
           containerlab destroy --topo crypt-acl46.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `crypt-acl46.tst` file [here](../tst/crypt-acl46.tst)  
        3. Launch `crypt-acl46.tst` test:  

        ```
           java -jar ../../rtr.jar test tester crypt-acl46 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `crypt-acl46.tst` test:  
