...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp279/rout-bgp279.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp279](../clab/rout-bgp279/rout-bgp279.yml) file  
        3. Launch ContainerLab `rout-bgp279.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp279.yml  
        ```
        4. Destroy ContainerLab `rout-bgp279.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp279.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp279.tst` file [here](../tst/rout-bgp279.tst)  
        3. Launch `rout-bgp279.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp279 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp279.tst` test:  
