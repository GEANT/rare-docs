...
=== "Topology"
    ...
    ![Alt text](../d2/rout-olsr14/rout-olsr14.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-olsr14](../clab/rout-olsr14/rout-olsr14.yml) file  
        3. Launch ContainerLab `rout-olsr14.yml` topology:  

        ```
           containerlab deploy --topo rout-olsr14.yml  
        ```
        4. Destroy ContainerLab `rout-olsr14.yml` topology:  

        ```
           containerlab destroy --topo rout-olsr14.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-olsr14.tst` file [here](../tst/rout-olsr14.tst)  
        3. Launch `rout-olsr14.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-olsr14 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-olsr14.tst` test:  
