...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp320/rout-bgp320.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp320](../clab/rout-bgp320/rout-bgp320.yml) file  
        3. Launch ContainerLab `rout-bgp320.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp320.yml  
        ```
        4. Destroy ContainerLab `rout-bgp320.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp320.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp320.tst` file [here](../tst/rout-bgp320.tst)  
        3. Launch `rout-bgp320.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp320 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp320.tst` test:  
