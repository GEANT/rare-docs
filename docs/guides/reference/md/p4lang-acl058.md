...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-acl058/p4lang-acl058.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl058](../clab/p4lang-acl058/p4lang-acl058.yml) file  
        3. Launch ContainerLab `p4lang-acl058.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl058.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl058.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl058.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl058.tst` file [here](../tst/p4lang-acl058.tst)  
        3. Launch `p4lang-acl058.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl058 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl058.tst` test:  
