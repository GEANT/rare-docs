# Example: otherl3evpns with default route

=== "Topology"

    ![Alt text](../d2/rout-bgp817/rout-bgp817.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp817](../clab/rout-bgp817/rout-bgp817.yml) file  
        3. Launch ContainerLab `rout-bgp817.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp817.yml  
        ```
        4. Destroy ContainerLab `rout-bgp817.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp817.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp817.tst` file [here](../tst/rout-bgp817.tst)  
        3. Launch `rout-bgp817.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp817 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp817.tst` test:  
