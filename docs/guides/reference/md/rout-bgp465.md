...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp465/rout-bgp465.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp465](../clab/rout-bgp465/rout-bgp465.yml) file  
        3. Launch ContainerLab `rout-bgp465.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp465.yml  
        ```
        4. Destroy ContainerLab `rout-bgp465.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp465.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp465.tst` file [here](../tst/rout-bgp465.tst)  
        3. Launch `rout-bgp465.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp465 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp465.tst` test:  
