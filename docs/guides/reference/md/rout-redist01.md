...
=== "Topology"
    ...
    ![Alt text](../d2/rout-redist01/rout-redist01.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist01](../clab/rout-redist01/rout-redist01.yml) file  
        3. Launch ContainerLab `rout-redist01.yml` topology:  

        ```
           containerlab deploy --topo rout-redist01.yml  
        ```
        4. Destroy ContainerLab `rout-redist01.yml` topology:  

        ```
           containerlab destroy --topo rout-redist01.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist01.tst` file [here](../tst/rout-redist01.tst)  
        3. Launch `rout-redist01.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist01 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist01.tst` test:  
