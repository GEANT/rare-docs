...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp496/rout-bgp496.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp496](../clab/rout-bgp496/rout-bgp496.yml) file  
        3. Launch ContainerLab `rout-bgp496.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp496.yml  
        ```
        4. Destroy ContainerLab `rout-bgp496.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp496.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp496.tst` file [here](../tst/rout-bgp496.tst)  
        3. Launch `rout-bgp496.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp496 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp496.tst` test:  
