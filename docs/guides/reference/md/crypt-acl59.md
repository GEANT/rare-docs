...
=== "Topology"
    ...
    ![Alt text](../d2/crypt-acl59/crypt-acl59.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [crypt-acl59](../clab/crypt-acl59/crypt-acl59.yml) file  
        3. Launch ContainerLab `crypt-acl59.yml` topology:  

        ```
           containerlab deploy --topo crypt-acl59.yml  
        ```
        4. Destroy ContainerLab `crypt-acl59.yml` topology:  

        ```
           containerlab destroy --topo crypt-acl59.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `crypt-acl59.tst` file [here](../tst/crypt-acl59.tst)  
        3. Launch `crypt-acl59.tst` test:  

        ```
           java -jar ../../rtr.jar test tester crypt-acl59 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `crypt-acl59.tst` test:  
