# Example: other ctp colors over ibgp

=== "Topology"

    ![Alt text](../d2/rout-bgp671/rout-bgp671.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp671](../clab/rout-bgp671/rout-bgp671.yml) file  
        3. Launch ContainerLab `rout-bgp671.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp671.yml  
        ```
        4. Destroy ContainerLab `rout-bgp671.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp671.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp671.tst` file [here](../tst/rout-bgp671.tst)  
        3. Launch `rout-bgp671.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp671 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp671.tst` test:  
