...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-bier03/mpls-bier03.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-bier03](../clab/mpls-bier03/mpls-bier03.yml) file  
        3. Launch ContainerLab `mpls-bier03.yml` topology:  

        ```
           containerlab deploy --topo mpls-bier03.yml  
        ```
        4. Destroy ContainerLab `mpls-bier03.yml` topology:  

        ```
           containerlab destroy --topo mpls-bier03.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-bier03.tst` file [here](../tst/mpls-bier03.tst)  
        3. Launch `mpls-bier03.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-bier03 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-bier03.tst` test:  
