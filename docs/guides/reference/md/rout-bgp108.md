...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp108/rout-bgp108.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp108](../clab/rout-bgp108/rout-bgp108.yml) file  
        3. Launch ContainerLab `rout-bgp108.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp108.yml  
        ```
        4. Destroy ContainerLab `rout-bgp108.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp108.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp108.tst` file [here](../tst/rout-bgp108.tst)  
        3. Launch `rout-bgp108.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp108 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp108.tst` test:  
