# Example: p4lang: routing with fib compression

=== "Topology"

    ![Alt text](../d2/p4lang-rout241/p4lang-rout241.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout241](../clab/p4lang-rout241/p4lang-rout241.yml) file  
        3. Launch ContainerLab `p4lang-rout241.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout241.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout241.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout241.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout241.tst` file [here](../tst/p4lang-rout241.tst)  
        3. Launch `p4lang-rout241.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout241 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout241.tst` test:  
