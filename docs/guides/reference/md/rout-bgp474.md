...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp474/rout-bgp474.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp474](../clab/rout-bgp474/rout-bgp474.yml) file  
        3. Launch ContainerLab `rout-bgp474.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp474.yml  
        ```
        4. Destroy ContainerLab `rout-bgp474.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp474.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp474.tst` file [here](../tst/rout-bgp474.tst)  
        3. Launch `rout-bgp474.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp474 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp474.tst` test:  
