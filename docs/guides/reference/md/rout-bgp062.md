...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp062/rout-bgp062.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp062](../clab/rout-bgp062/rout-bgp062.yml) file  
        3. Launch ContainerLab `rout-bgp062.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp062.yml  
        ```
        4. Destroy ContainerLab `rout-bgp062.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp062.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp062.tst` file [here](../tst/rout-bgp062.tst)  
        3. Launch `rout-bgp062.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp062 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp062.tst` test:  
