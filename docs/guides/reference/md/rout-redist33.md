...
=== "Topology"
    ...
    ![Alt text](../d2/rout-redist33/rout-redist33.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-redist33](../clab/rout-redist33/rout-redist33.yml) file  
        3. Launch ContainerLab `rout-redist33.yml` topology:  

        ```
           containerlab deploy --topo rout-redist33.yml  
        ```
        4. Destroy ContainerLab `rout-redist33.yml` topology:  

        ```
           containerlab destroy --topo rout-redist33.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-redist33.tst` file [here](../tst/rout-redist33.tst)  
        3. Launch `rout-redist33.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-redist33 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-redist33.tst` test:  
