...
=== "Topology"
    ...
    ![Alt text](../d2/rout-eigrp09/rout-eigrp09.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-eigrp09](../clab/rout-eigrp09/rout-eigrp09.yml) file  
        3. Launch ContainerLab `rout-eigrp09.yml` topology:  

        ```
           containerlab deploy --topo rout-eigrp09.yml  
        ```
        4. Destroy ContainerLab `rout-eigrp09.yml` topology:  

        ```
           containerlab destroy --topo rout-eigrp09.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-eigrp09.tst` file [here](../tst/rout-eigrp09.tst)  
        3. Launch `rout-eigrp09.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-eigrp09 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-eigrp09.tst` test:  
