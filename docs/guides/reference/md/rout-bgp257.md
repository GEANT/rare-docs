...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp257/rout-bgp257.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp257](../clab/rout-bgp257/rout-bgp257.yml) file  
        3. Launch ContainerLab `rout-bgp257.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp257.yml  
        ```
        4. Destroy ContainerLab `rout-bgp257.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp257.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp257.tst` file [here](../tst/rout-bgp257.tst)  
        3. Launch `rout-bgp257.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp257 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp257.tst` test:  
