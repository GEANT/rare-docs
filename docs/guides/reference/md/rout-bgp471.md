...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp471/rout-bgp471.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp471](../clab/rout-bgp471/rout-bgp471.yml) file  
        3. Launch ContainerLab `rout-bgp471.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp471.yml  
        ```
        4. Destroy ContainerLab `rout-bgp471.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp471.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp471.tst` file [here](../tst/rout-bgp471.tst)  
        3. Launch `rout-bgp471.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp471 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp471.tst` test:  
