# Example: ibgp rr otherl3evpns prefix movement

=== "Topology"

    ![Alt text](../d2/rout-bgp821/rout-bgp821.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp821](../clab/rout-bgp821/rout-bgp821.yml) file  
        3. Launch ContainerLab `rout-bgp821.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp821.yml  
        ```
        4. Destroy ContainerLab `rout-bgp821.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp821.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp821.tst` file [here](../tst/rout-bgp821.tst)  
        3. Launch `rout-bgp821.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp821 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp821.tst` test:  
