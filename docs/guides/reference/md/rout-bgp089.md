...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp089/rout-bgp089.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp089](../clab/rout-bgp089/rout-bgp089.yml) file  
        3. Launch ContainerLab `rout-bgp089.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp089.yml  
        ```
        4. Destroy ContainerLab `rout-bgp089.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp089.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp089.tst` file [here](../tst/rout-bgp089.tst)  
        3. Launch `rout-bgp089.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp089 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp089.tst` test:  
