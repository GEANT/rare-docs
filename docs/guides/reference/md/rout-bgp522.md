...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp522/rout-bgp522.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp522](../clab/rout-bgp522/rout-bgp522.yml) file  
        3. Launch ContainerLab `rout-bgp522.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp522.yml  
        ```
        4. Destroy ContainerLab `rout-bgp522.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp522.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp522.tst` file [here](../tst/rout-bgp522.tst)  
        3. Launch `rout-bgp522.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp522 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp522.tst` test:  
