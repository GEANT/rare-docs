# Example: eigrp auto summarization

=== "Topology"

    ![Alt text](../d2/rout-eigrp26/rout-eigrp26.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-eigrp26](../clab/rout-eigrp26/rout-eigrp26.yml) file  
        3. Launch ContainerLab `rout-eigrp26.yml` topology:  

        ```
           containerlab deploy --topo rout-eigrp26.yml  
        ```
        4. Destroy ContainerLab `rout-eigrp26.yml` topology:  

        ```
           containerlab destroy --topo rout-eigrp26.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-eigrp26.tst` file [here](../tst/rout-eigrp26.tst)  
        3. Launch `rout-eigrp26.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-eigrp26 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-eigrp26.tst` test:  
