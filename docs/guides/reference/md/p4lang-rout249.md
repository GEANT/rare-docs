# Example: p4lang: mldp core over l2tp3

=== "Topology"

    ![Alt text](../d2/p4lang-rout249/p4lang-rout249.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout249](../clab/p4lang-rout249/p4lang-rout249.yml) file  
        3. Launch ContainerLab `p4lang-rout249.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout249.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout249.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout249.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout249.tst` file [here](../tst/p4lang-rout249.tst)  
        3. Launch `p4lang-rout249.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout249 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout249.tst` test:  
