...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp383/rout-bgp383.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp383](../clab/rout-bgp383/rout-bgp383.yml) file  
        3. Launch ContainerLab `rout-bgp383.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp383.yml  
        ```
        4. Destroy ContainerLab `rout-bgp383.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp383.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp383.tst` file [here](../tst/rout-bgp383.tst)  
        3. Launch `rout-bgp383.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp383 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp383.tst` test:  
