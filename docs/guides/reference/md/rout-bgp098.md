...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp098/rout-bgp098.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp098](../clab/rout-bgp098/rout-bgp098.yml) file  
        3. Launch ContainerLab `rout-bgp098.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp098.yml  
        ```
        4. Destroy ContainerLab `rout-bgp098.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp098.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp098.tst` file [here](../tst/rout-bgp098.tst)  
        3. Launch `rout-bgp098.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp098 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp098.tst` test:  
