...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp150/rout-bgp150.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp150](../clab/rout-bgp150/rout-bgp150.yml) file  
        3. Launch ContainerLab `rout-bgp150.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp150.yml  
        ```
        4. Destroy ContainerLab `rout-bgp150.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp150.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp150.tst` file [here](../tst/rout-bgp150.tst)  
        3. Launch `rout-bgp150.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp150 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp150.tst` test:  
