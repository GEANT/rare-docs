...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rip01/rout-rip01.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rip01](../clab/rout-rip01/rout-rip01.yml) file  
        3. Launch ContainerLab `rout-rip01.yml` topology:  

        ```
           containerlab deploy --topo rout-rip01.yml  
        ```
        4. Destroy ContainerLab `rout-rip01.yml` topology:  

        ```
           containerlab destroy --topo rout-rip01.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rip01.tst` file [here](../tst/rout-rip01.tst)  
        3. Launch `rout-rip01.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rip01 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rip01.tst` test:  
