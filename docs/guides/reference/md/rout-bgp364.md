...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp364/rout-bgp364.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp364](../clab/rout-bgp364/rout-bgp364.yml) file  
        3. Launch ContainerLab `rout-bgp364.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp364.yml  
        ```
        4. Destroy ContainerLab `rout-bgp364.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp364.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp364.tst` file [here](../tst/rout-bgp364.tst)  
        3. Launch `rout-bgp364.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp364 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp364.tst` test:  
