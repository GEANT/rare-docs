# Example: l3evpns ingress route filtering with routemap with soft-reconfig

=== "Topology"

    ![Alt text](../d2/rout-bgp834/rout-bgp834.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp834](../clab/rout-bgp834/rout-bgp834.yml) file  
        3. Launch ContainerLab `rout-bgp834.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp834.yml  
        ```
        4. Destroy ContainerLab `rout-bgp834.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp834.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp834.tst` file [here](../tst/rout-bgp834.tst)  
        3. Launch `rout-bgp834.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp834 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp834.tst` test:  
