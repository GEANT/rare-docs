...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp125/rout-bgp125.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp125](../clab/rout-bgp125/rout-bgp125.yml) file  
        3. Launch ContainerLab `rout-bgp125.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp125.yml  
        ```
        4. Destroy ContainerLab `rout-bgp125.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp125.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp125.tst` file [here](../tst/rout-bgp125.tst)  
        3. Launch `rout-bgp125.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp125 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp125.tst` test:  
