...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp130/rout-bgp130.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp130](../clab/rout-bgp130/rout-bgp130.yml) file  
        3. Launch ContainerLab `rout-bgp130.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp130.yml  
        ```
        4. Destroy ContainerLab `rout-bgp130.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp130.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp130.tst` file [here](../tst/rout-bgp130.tst)  
        3. Launch `rout-bgp130.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp130 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp130.tst` test:  
