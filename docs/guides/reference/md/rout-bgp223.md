...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp223/rout-bgp223.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp223](../clab/rout-bgp223/rout-bgp223.yml) file  
        3. Launch ContainerLab `rout-bgp223.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp223.yml  
        ```
        4. Destroy ContainerLab `rout-bgp223.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp223.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp223.tst` file [here](../tst/rout-bgp223.tst)  
        3. Launch `rout-bgp223.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp223 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp223.tst` test:  
