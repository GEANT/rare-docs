...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp473/rout-bgp473.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp473](../clab/rout-bgp473/rout-bgp473.yml) file  
        3. Launch ContainerLab `rout-bgp473.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp473.yml  
        ```
        4. Destroy ContainerLab `rout-bgp473.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp473.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp473.tst` file [here](../tst/rout-bgp473.tst)  
        3. Launch `rout-bgp473.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp473 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp473.tst` test:  
