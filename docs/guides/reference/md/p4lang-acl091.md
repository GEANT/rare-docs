# Example: p4lang: ingress tmux access list

=== "Topology"

    ![Alt text](../d2/p4lang-acl091/p4lang-acl091.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-acl091](../clab/p4lang-acl091/p4lang-acl091.yml) file  
        3. Launch ContainerLab `p4lang-acl091.yml` topology:  

        ```
           containerlab deploy --topo p4lang-acl091.yml  
        ```
        4. Destroy ContainerLab `p4lang-acl091.yml` topology:  

        ```
           containerlab destroy --topo p4lang-acl091.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-acl091.tst` file [here](../tst/p4lang-acl091.tst)  
        3. Launch `p4lang-acl091.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-acl091 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-acl091.tst` test:  
