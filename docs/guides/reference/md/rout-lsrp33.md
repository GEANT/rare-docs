...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp33/rout-lsrp33.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp33](../clab/rout-lsrp33/rout-lsrp33.yml) file  
        3. Launch ContainerLab `rout-lsrp33.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp33.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp33.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp33.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp33.tst` file [here](../tst/rout-lsrp33.tst)  
        3. Launch `rout-lsrp33.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp33 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp33.tst` test:  
