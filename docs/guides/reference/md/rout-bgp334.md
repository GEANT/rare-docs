...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp334/rout-bgp334.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp334](../clab/rout-bgp334/rout-bgp334.yml) file  
        3. Launch ContainerLab `rout-bgp334.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp334.yml  
        ```
        4. Destroy ContainerLab `rout-bgp334.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp334.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp334.tst` file [here](../tst/rout-bgp334.tst)  
        3. Launch `rout-bgp334.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp334 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp334.tst` test:  
