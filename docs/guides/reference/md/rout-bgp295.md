...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp295/rout-bgp295.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp295](../clab/rout-bgp295/rout-bgp295.yml) file  
        3. Launch ContainerLab `rout-bgp295.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp295.yml  
        ```
        4. Destroy ContainerLab `rout-bgp295.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp295.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp295.tst` file [here](../tst/rout-bgp295.tst)  
        3. Launch `rout-bgp295.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp295 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp295.tst` test:  
