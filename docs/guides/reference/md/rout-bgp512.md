...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp512/rout-bgp512.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp512](../clab/rout-bgp512/rout-bgp512.yml) file  
        3. Launch ContainerLab `rout-bgp512.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp512.yml  
        ```
        4. Destroy ContainerLab `rout-bgp512.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp512.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp512.tst` file [here](../tst/rout-bgp512.tst)  
        3. Launch `rout-bgp512.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp512 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp512.tst` test:  
