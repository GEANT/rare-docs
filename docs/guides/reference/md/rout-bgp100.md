...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp100/rout-bgp100.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp100](../clab/rout-bgp100/rout-bgp100.yml) file  
        3. Launch ContainerLab `rout-bgp100.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp100.yml  
        ```
        4. Destroy ContainerLab `rout-bgp100.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp100.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp100.tst` file [here](../tst/rout-bgp100.tst)  
        3. Launch `rout-bgp100.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp100 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp100.tst` test:  
