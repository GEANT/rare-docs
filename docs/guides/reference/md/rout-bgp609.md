# Example: ibgp with php ctp

=== "Topology"

    ![Alt text](../d2/rout-bgp609/rout-bgp609.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp609](../clab/rout-bgp609/rout-bgp609.yml) file  
        3. Launch ContainerLab `rout-bgp609.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp609.yml  
        ```
        4. Destroy ContainerLab `rout-bgp609.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp609.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp609.tst` file [here](../tst/rout-bgp609.tst)  
        3. Launch `rout-bgp609.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp609 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp609.tst` test:  
