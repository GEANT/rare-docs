...
=== "Topology"
    ...
    ![Alt text](../d2/rout-rip05/rout-rip05.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-rip05](../clab/rout-rip05/rout-rip05.yml) file  
        3. Launch ContainerLab `rout-rip05.yml` topology:  

        ```
           containerlab deploy --topo rout-rip05.yml  
        ```
        4. Destroy ContainerLab `rout-rip05.yml` topology:  

        ```
           containerlab destroy --topo rout-rip05.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-rip05.tst` file [here](../tst/rout-rip05.tst)  
        3. Launch `rout-rip05.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-rip05 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-rip05.tst` test:  
