...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-sr12/mpls-sr12.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-sr12](../clab/mpls-sr12/mpls-sr12.yml) file  
        3. Launch ContainerLab `mpls-sr12.yml` topology:  

        ```
           containerlab deploy --topo mpls-sr12.yml  
        ```
        4. Destroy ContainerLab `mpls-sr12.yml` topology:  

        ```
           containerlab destroy --topo mpls-sr12.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-sr12.tst` file [here](../tst/mpls-sr12.tst)  
        3. Launch `mpls-sr12.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-sr12 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-sr12.tst` test:  
