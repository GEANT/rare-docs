...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp259/rout-bgp259.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp259](../clab/rout-bgp259/rout-bgp259.yml) file  
        3. Launch ContainerLab `rout-bgp259.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp259.yml  
        ```
        4. Destroy ContainerLab `rout-bgp259.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp259.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp259.tst` file [here](../tst/rout-bgp259.tst)  
        3. Launch `rout-bgp259.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp259 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp259.tst` test:  
