# Example: bgp with php ctp over sr

=== "Topology"

    ![Alt text](../d2/mpls-sr15/mpls-sr15.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-sr15](../clab/mpls-sr15/mpls-sr15.yml) file  
        3. Launch ContainerLab `mpls-sr15.yml` topology:  

        ```
           containerlab deploy --topo mpls-sr15.yml  
        ```
        4. Destroy ContainerLab `mpls-sr15.yml` topology:  

        ```
           containerlab destroy --topo mpls-sr15.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-sr15.tst` file [here](../tst/mpls-sr15.tst)  
        3. Launch `mpls-sr15.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-sr15 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-sr15.tst` test:  
