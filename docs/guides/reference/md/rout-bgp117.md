...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp117/rout-bgp117.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp117](../clab/rout-bgp117/rout-bgp117.yml) file  
        3. Launch ContainerLab `rout-bgp117.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp117.yml  
        ```
        4. Destroy ContainerLab `rout-bgp117.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp117.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp117.tst` file [here](../tst/rout-bgp117.tst)  
        3. Launch `rout-bgp117.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp117 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp117.tst` test:  
