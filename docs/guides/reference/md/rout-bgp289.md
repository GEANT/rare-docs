...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp289/rout-bgp289.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp289](../clab/rout-bgp289/rout-bgp289.yml) file  
        3. Launch ContainerLab `rout-bgp289.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp289.yml  
        ```
        4. Destroy ContainerLab `rout-bgp289.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp289.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp289.tst` file [here](../tst/rout-bgp289.tst)  
        3. Launch `rout-bgp289.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp289 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp289.tst` test:  
