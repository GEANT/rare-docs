...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp422/rout-bgp422.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp422](../clab/rout-bgp422/rout-bgp422.yml) file  
        3. Launch ContainerLab `rout-bgp422.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp422.yml  
        ```
        4. Destroy ContainerLab `rout-bgp422.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp422.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp422.tst` file [here](../tst/rout-bgp422.tst)  
        3. Launch `rout-bgp422.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp422 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp422.tst` test:  
