...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp420/rout-bgp420.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp420](../clab/rout-bgp420/rout-bgp420.yml) file  
        3. Launch ContainerLab `rout-bgp420.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp420.yml  
        ```
        4. Destroy ContainerLab `rout-bgp420.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp420.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp420.tst` file [here](../tst/rout-bgp420.tst)  
        3. Launch `rout-bgp420.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp420 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp420.tst` test:  
