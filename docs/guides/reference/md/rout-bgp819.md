# Example: ibgp rr l3evpns prefix movement

=== "Topology"

    ![Alt text](../d2/rout-bgp819/rout-bgp819.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp819](../clab/rout-bgp819/rout-bgp819.yml) file  
        3. Launch ContainerLab `rout-bgp819.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp819.yml  
        ```
        4. Destroy ContainerLab `rout-bgp819.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp819.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp819.tst` file [here](../tst/rout-bgp819.tst)  
        3. Launch `rout-bgp819.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp819 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp819.tst` test:  
