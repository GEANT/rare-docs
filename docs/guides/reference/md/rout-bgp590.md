# Example: vpns with ingress rtfilter

=== "Topology"

    ![Alt text](../d2/rout-bgp590/rout-bgp590.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp590](../clab/rout-bgp590/rout-bgp590.yml) file  
        3. Launch ContainerLab `rout-bgp590.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp590.yml  
        ```
        4. Destroy ContainerLab `rout-bgp590.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp590.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp590.tst` file [here](../tst/rout-bgp590.tst)  
        3. Launch `rout-bgp590.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp590 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp590.tst` test:  
