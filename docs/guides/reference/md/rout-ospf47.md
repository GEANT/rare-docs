...
=== "Topology"
    ...
    ![Alt text](../d2/rout-ospf47/rout-ospf47.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-ospf47](../clab/rout-ospf47/rout-ospf47.yml) file  
        3. Launch ContainerLab `rout-ospf47.yml` topology:  

        ```
           containerlab deploy --topo rout-ospf47.yml  
        ```
        4. Destroy ContainerLab `rout-ospf47.yml` topology:  

        ```
           containerlab destroy --topo rout-ospf47.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-ospf47.tst` file [here](../tst/rout-ospf47.tst)  
        3. Launch `rout-ospf47.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-ospf47 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-ospf47.tst` test:  
