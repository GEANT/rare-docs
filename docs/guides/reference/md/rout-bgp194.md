...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp194/rout-bgp194.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp194](../clab/rout-bgp194/rout-bgp194.yml) file  
        3. Launch ContainerLab `rout-bgp194.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp194.yml  
        ```
        4. Destroy ContainerLab `rout-bgp194.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp194.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp194.tst` file [here](../tst/rout-bgp194.tst)  
        3. Launch `rout-bgp194.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp194 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp194.tst` test:  
