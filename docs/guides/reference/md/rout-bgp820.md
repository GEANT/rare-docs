# Example: bgp otherl3evpns change in metric

=== "Topology"

    ![Alt text](../d2/rout-bgp820/rout-bgp820.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp820](../clab/rout-bgp820/rout-bgp820.yml) file  
        3. Launch ContainerLab `rout-bgp820.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp820.yml  
        ```
        4. Destroy ContainerLab `rout-bgp820.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp820.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp820.tst` file [here](../tst/rout-bgp820.tst)  
        3. Launch `rout-bgp820.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp820 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp820.tst` test:  
