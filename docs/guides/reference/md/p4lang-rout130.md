...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout130/p4lang-rout130.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout130](../clab/p4lang-rout130/p4lang-rout130.yml) file  
        3. Launch ContainerLab `p4lang-rout130.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout130.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout130.yml` topology:  
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout130.tst` file [here](../tst/p4lang-rout130.tst)  
        3. Launch `p4lang-rout130.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout130 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout130.tst` test:  
