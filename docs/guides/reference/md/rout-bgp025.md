...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp025/rout-bgp025.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp025](../clab/rout-bgp025/rout-bgp025.yml) file  
        3. Launch ContainerLab `rout-bgp025.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp025.yml  
        ```
        4. Destroy ContainerLab `rout-bgp025.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp025.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp025.tst` file [here](../tst/rout-bgp025.tst)  
        3. Launch `rout-bgp025.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp025 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp025.tst` test:  
