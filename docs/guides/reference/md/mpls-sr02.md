...
=== "Topology"
    ...
    ![Alt text](../d2/mpls-sr02/mpls-sr02.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [mpls-sr02](../clab/mpls-sr02/mpls-sr02.yml) file  
        3. Launch ContainerLab `mpls-sr02.yml` topology:  

        ```
           containerlab deploy --topo mpls-sr02.yml  
        ```
        4. Destroy ContainerLab `mpls-sr02.yml` topology:  

        ```
           containerlab destroy --topo mpls-sr02.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `mpls-sr02.tst` file [here](../tst/mpls-sr02.tst)  
        3. Launch `mpls-sr02.tst` test:  

        ```
           java -jar ../../rtr.jar test tester mpls-sr02 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `mpls-sr02.tst` test:  
