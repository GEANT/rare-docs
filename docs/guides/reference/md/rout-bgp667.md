# Example: bgp csc vpn with ctp

=== "Topology"

    ![Alt text](../d2/rout-bgp667/rout-bgp667.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp667](../clab/rout-bgp667/rout-bgp667.yml) file  
        3. Launch ContainerLab `rout-bgp667.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp667.yml  
        ```
        4. Destroy ContainerLab `rout-bgp667.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp667.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp667.tst` file [here](../tst/rout-bgp667.tst)  
        3. Launch `rout-bgp667.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp667 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp667.tst` test:  
