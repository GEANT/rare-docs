...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp368/rout-bgp368.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp368](../clab/rout-bgp368/rout-bgp368.yml) file  
        3. Launch ContainerLab `rout-bgp368.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp368.yml  
        ```
        4. Destroy ContainerLab `rout-bgp368.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp368.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp368.tst` file [here](../tst/rout-bgp368.tst)  
        3. Launch `rout-bgp368.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp368 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp368.tst` test:  
