...
=== "Topology"
    ...
    ![Alt text](../d2/rout-pvrp04/rout-pvrp04.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-pvrp04](../clab/rout-pvrp04/rout-pvrp04.yml) file  
        3. Launch ContainerLab `rout-pvrp04.yml` topology:  

        ```
           containerlab deploy --topo rout-pvrp04.yml  
        ```
        4. Destroy ContainerLab `rout-pvrp04.yml` topology:  

        ```
           containerlab destroy --topo rout-pvrp04.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-pvrp04.tst` file [here](../tst/rout-pvrp04.tst)  
        3. Launch `rout-pvrp04.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-pvrp04 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-pvrp04.tst` test:  
