...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout160/p4lang-rout160.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout160](../clab/p4lang-rout160/p4lang-rout160.yml) file  
        3. Launch ContainerLab `p4lang-rout160.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout160.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout160.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout160.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout160.tst` file [here](../tst/p4lang-rout160.tst)  
        3. Launch `p4lang-rout160.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout160 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout160.tst` test:  
