# Example: p4lang: tmux mpls over vlan

=== "Topology"

    ![Alt text](../d2/p4lang-rout300/p4lang-rout300.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout300](../clab/p4lang-rout300/p4lang-rout300.yml) file  
        3. Launch ContainerLab `p4lang-rout300.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout300.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout300.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout300.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout300.tst` file [here](../tst/p4lang-rout300.tst)  
        3. Launch `p4lang-rout300.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout300 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout300.tst` test:  
