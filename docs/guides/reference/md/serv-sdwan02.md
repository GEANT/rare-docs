...
=== "Topology"
    ...
    ![Alt text](../d2/serv-sdwan02/serv-sdwan02.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [serv-sdwan02](../clab/serv-sdwan02/serv-sdwan02.yml) file  
        3. Launch ContainerLab `serv-sdwan02.yml` topology:  

        ```
           containerlab deploy --topo serv-sdwan02.yml  
        ```
        4. Destroy ContainerLab `serv-sdwan02.yml` topology:  

        ```
           containerlab destroy --topo serv-sdwan02.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `serv-sdwan02.tst` file [here](../tst/serv-sdwan02.tst)  
        3. Launch `serv-sdwan02.tst` test:  

        ```
           java -jar ../../rtr.jar test tester serv-sdwan02 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `serv-sdwan02.tst` test:  
