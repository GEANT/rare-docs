# Example: p4lang: sgt over tmux

=== "Topology"

    ![Alt text](../d2/p4lang-crypt112/p4lang-crypt112.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt112](../clab/p4lang-crypt112/p4lang-crypt112.yml) file  
        3. Launch ContainerLab `p4lang-crypt112.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt112.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt112.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt112.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt112.tst` file [here](../tst/p4lang-crypt112.tst)  
        3. Launch `p4lang-crypt112.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt112 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt112.tst` test:  
