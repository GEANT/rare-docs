...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-crypt061/p4lang-crypt061.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-crypt061](../clab/p4lang-crypt061/p4lang-crypt061.yml) file  
        3. Launch ContainerLab `p4lang-crypt061.yml` topology:  

        ```
           containerlab deploy --topo p4lang-crypt061.yml  
        ```
        4. Destroy ContainerLab `p4lang-crypt061.yml` topology:  

        ```
           containerlab destroy --topo p4lang-crypt061.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-crypt061.tst` file [here](../tst/p4lang-crypt061.tst)  
        3. Launch `p4lang-crypt061.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-crypt061 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-crypt061.tst` test:  
