...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout060/p4lang-rout060.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout060](../clab/p4lang-rout060/p4lang-rout060.yml) file  
        3. Launch ContainerLab `p4lang-rout060.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout060.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout060.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout060.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout060.tst` file [here](../tst/p4lang-rout060.tst)  
        3. Launch `p4lang-rout060.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout060 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout060.tst` test:  
