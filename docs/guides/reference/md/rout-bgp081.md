...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp081/rout-bgp081.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp081](../clab/rout-bgp081/rout-bgp081.yml) file  
        3. Launch ContainerLab `rout-bgp081.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp081.yml  
        ```
        4. Destroy ContainerLab `rout-bgp081.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp081.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp081.tst` file [here](../tst/rout-bgp081.tst)  
        3. Launch `rout-bgp081.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp081 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp081.tst` test:  
