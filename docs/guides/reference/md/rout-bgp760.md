# Example: car colors over ibgp

=== "Topology"

    ![Alt text](../d2/rout-bgp760/rout-bgp760.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp760](../clab/rout-bgp760/rout-bgp760.yml) file  
        3. Launch ContainerLab `rout-bgp760.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp760.yml  
        ```
        4. Destroy ContainerLab `rout-bgp760.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp760.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp760.tst` file [here](../tst/rout-bgp760.tst)  
        3. Launch `rout-bgp760.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp760 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp760.tst` test:  
