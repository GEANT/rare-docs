...
=== "Topology"
    ...
    ![Alt text](../d2/p4lang-rout066/p4lang-rout066.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout066](../clab/p4lang-rout066/p4lang-rout066.yml) file  
        3. Launch ContainerLab `p4lang-rout066.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout066.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout066.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout066.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout066.tst` file [here](../tst/p4lang-rout066.tst)  
        3. Launch `p4lang-rout066.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout066 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout066.tst` test:  
