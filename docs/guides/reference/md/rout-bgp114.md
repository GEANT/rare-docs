...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp114/rout-bgp114.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp114](../clab/rout-bgp114/rout-bgp114.yml) file  
        3. Launch ContainerLab `rout-bgp114.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp114.yml  
        ```
        4. Destroy ContainerLab `rout-bgp114.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp114.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp114.tst` file [here](../tst/rout-bgp114.tst)  
        3. Launch `rout-bgp114.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp114 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp114.tst` test:  
