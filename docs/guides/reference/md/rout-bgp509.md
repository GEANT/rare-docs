...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp509/rout-bgp509.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp509](../clab/rout-bgp509/rout-bgp509.yml) file  
        3. Launch ContainerLab `rout-bgp509.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp509.yml  
        ```
        4. Destroy ContainerLab `rout-bgp509.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp509.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp509.tst` file [here](../tst/rout-bgp509.tst)  
        3. Launch `rout-bgp509.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp509 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp509.tst` test:  
