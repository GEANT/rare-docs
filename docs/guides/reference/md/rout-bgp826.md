# Example: otherl3evpns with ingress rtfilter

=== "Topology"

    ![Alt text](../d2/rout-bgp826/rout-bgp826.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp826](../clab/rout-bgp826/rout-bgp826.yml) file  
        3. Launch ContainerLab `rout-bgp826.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp826.yml  
        ```
        4. Destroy ContainerLab `rout-bgp826.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp826.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp826.tst` file [here](../tst/rout-bgp826.tst)  
        3. Launch `rout-bgp826.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp826 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp826.tst` test:  
