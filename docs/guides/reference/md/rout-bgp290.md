...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp290/rout-bgp290.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp290](../clab/rout-bgp290/rout-bgp290.yml) file  
        3. Launch ContainerLab `rout-bgp290.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp290.yml  
        ```
        4. Destroy ContainerLab `rout-bgp290.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp290.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp290.tst` file [here](../tst/rout-bgp290.tst)  
        3. Launch `rout-bgp290.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp290 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp290.tst` test:  
