...
=== "Topology"
    ...
    ![Alt text](../d2/rout-isis049/rout-isis049.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-isis049](../clab/rout-isis049/rout-isis049.yml) file  
        3. Launch ContainerLab `rout-isis049.yml` topology:  

        ```
           containerlab deploy --topo rout-isis049.yml  
        ```
        4. Destroy ContainerLab `rout-isis049.yml` topology:  

        ```
           containerlab destroy --topo rout-isis049.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-isis049.tst` file [here](../tst/rout-isis049.tst)  
        3. Launch `rout-isis049.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-isis049 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-isis049.tst` test:  
