...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp174/rout-bgp174.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp174](../clab/rout-bgp174/rout-bgp174.yml) file  
        3. Launch ContainerLab `rout-bgp174.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp174.yml  
        ```
        4. Destroy ContainerLab `rout-bgp174.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp174.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp174.tst` file [here](../tst/rout-bgp174.tst)  
        3. Launch `rout-bgp174.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp174 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp174.tst` test:  
