...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp518/rout-bgp518.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp518](../clab/rout-bgp518/rout-bgp518.yml) file  
        3. Launch ContainerLab `rout-bgp518.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp518.yml  
        ```
        4. Destroy ContainerLab `rout-bgp518.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp518.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp518.tst` file [here](../tst/rout-bgp518.tst)  
        3. Launch `rout-bgp518.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp518 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp518.tst` test:  
