...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp461/rout-bgp461.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp461](../clab/rout-bgp461/rout-bgp461.yml) file  
        3. Launch ContainerLab `rout-bgp461.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp461.yml  
        ```
        4. Destroy ContainerLab `rout-bgp461.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp461.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp461.tst` file [here](../tst/rout-bgp461.tst)  
        3. Launch `rout-bgp461.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp461 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp461.tst` test:  
