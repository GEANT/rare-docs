...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp348/rout-bgp348.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp348](../clab/rout-bgp348/rout-bgp348.yml) file  
        3. Launch ContainerLab `rout-bgp348.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp348.yml  
        ```
        4. Destroy ContainerLab `rout-bgp348.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp348.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp348.tst` file [here](../tst/rout-bgp348.tst)  
        3. Launch `rout-bgp348.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp348 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp348.tst` test:  
