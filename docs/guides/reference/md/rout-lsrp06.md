...
=== "Topology"
    ...
    ![Alt text](../d2/rout-lsrp06/rout-lsrp06.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-lsrp06](../clab/rout-lsrp06/rout-lsrp06.yml) file  
        3. Launch ContainerLab `rout-lsrp06.yml` topology:  

        ```
           containerlab deploy --topo rout-lsrp06.yml  
        ```
        4. Destroy ContainerLab `rout-lsrp06.yml` topology:  

        ```
           containerlab destroy --topo rout-lsrp06.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-lsrp06.tst` file [here](../tst/rout-lsrp06.tst)  
        3. Launch `rout-lsrp06.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-lsrp06 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-lsrp06.tst` test:  
