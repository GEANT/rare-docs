# Example: otherl3evpns egress route filtering with routepolicy

=== "Topology"

    ![Alt text](../d2/rout-bgp845/rout-bgp845.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp845](../clab/rout-bgp845/rout-bgp845.yml) file  
        3. Launch ContainerLab `rout-bgp845.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp845.yml  
        ```
        4. Destroy ContainerLab `rout-bgp845.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp845.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp845.tst` file [here](../tst/rout-bgp845.tst)  
        3. Launch `rout-bgp845.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp845 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp845.tst` test:  
