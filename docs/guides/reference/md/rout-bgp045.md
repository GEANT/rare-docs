...
=== "Topology"
    ...
    ![Alt text](../d2/rout-bgp045/rout-bgp045.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [rout-bgp045](../clab/rout-bgp045/rout-bgp045.yml) file  
        3. Launch ContainerLab `rout-bgp045.yml` topology:  

        ```
           containerlab deploy --topo rout-bgp045.yml  
        ```
        4. Destroy ContainerLab `rout-bgp045.yml` topology:  

        ```
           containerlab destroy --topo rout-bgp045.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `rout-bgp045.tst` file [here](../tst/rout-bgp045.tst)  
        3. Launch `rout-bgp045.tst` test:  

        ```
           java -jar ../../rtr.jar test tester rout-bgp045 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `rout-bgp045.tst` test:  
