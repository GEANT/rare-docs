# Example: p4lang: tmux routing over ipv6 loopback

=== "Topology"

    ![Alt text](../d2/p4lang-rout288/p4lang-rout288.svg)
...
=== "Emulation"
    ...
    === "ContainerLab"
        ...
        2. Fetch [p4lang-rout288](../clab/p4lang-rout288/p4lang-rout288.yml) file  
        3. Launch ContainerLab `p4lang-rout288.yml` topology:  

        ```
           containerlab deploy --topo p4lang-rout288.yml  
        ```
        4. Destroy ContainerLab `p4lang-rout288.yml` topology:  

        ```
           containerlab destroy --topo p4lang-rout288.yml  
        ```
    ...
    === "freeRtr CLI"
        ...
        2. Fetch `p4lang-rout288.tst` file [here](../tst/p4lang-rout288.tst)  
        3. Launch `p4lang-rout288.tst` test:  

        ```
           java -jar ../../rtr.jar test tester p4lang-rout288 path ./ temp ./ wait
        ```
        4. Destroy freeRtr `p4lang-rout288.tst` test:  
